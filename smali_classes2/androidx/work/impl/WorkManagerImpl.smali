...
.field private final mWorkManagerScope:LZ5/C;
...
.method public constructor <init>(Landroid/content/Context;Landroidx/work/Configuration;Landroidx/work/impl/utils/taskexecutor/TaskExecutor;Landroidx/work/impl/WorkDatabase;Ljava/util/List;Landroidx/work/impl/Processor;Landroidx/work/impl/constraints/trackers/Trackers;)V
    ...
    invoke-static {p3}, Landroidx/work/impl/WorkManagerImplExtKt;->createWorkManagerScope(Landroidx/work/impl/utils/taskexecutor/TaskExecutor;)LZ5/C;

    move-result-object p6

    iput-object p6, p0, Landroidx/work/impl/WorkManagerImpl;->mWorkManagerScope:LZ5/C;
    ...
    invoke-static {p6, p0, p2, p4}, Landroidx/work/impl/UnfinishedWorkListenerKt;->maybeLaunchUnfinishedWorkListener(LZ5/C;Landroid/content/Context;Landroidx/work/Configuration;Landroidx/work/impl/WorkDatabase;)V
...
.method public static synthetic a(Landroidx/work/impl/WorkManagerImpl;)Lr4/o;
    .locals 0

    invoke-direct {p0}, Landroidx/work/impl/WorkManagerImpl;->lambda$rescheduleEligibleWork$0()Lr4/o;
...
.method private synthetic lambda$rescheduleEligibleWork$0()Lr4/o;
    .locals 2
...
.method public getLastCancelAllTimeMillis()Lcom/google/common/util/concurrent/ListenableFuture;
    ...
    invoke-direct {v1, v0, v2}, LW5/q;-><init>(Ljava/lang/Object;I)V

    const-string v0, "getLastCancelAllTimeMillis"

    invoke-static {p0, v0, v1}, Landroidx/work/ListenableFutureKt;->executeAsync(Ljava/util/concurrent/Executor;Ljava/lang/String;LF4/a;)Lcom/google/common/util/concurrent/ListenableFuture;
...
.method public getWorkInfoByIdFlow(Ljava/util/UUID;)Lc6/j;
    .locals 0
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-static {p0, p1}, Landroidx/work/impl/model/WorkSpecDaoKt;->getWorkStatusPojoFlowDataForIds(Landroidx/work/impl/model/WorkSpecDao;Ljava/util/UUID;)Lc6/j;
...
.method public getWorkInfosByTagFlow(Ljava/lang/String;)Lc6/j;
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-static {v0, p0, p1}, Landroidx/work/impl/model/WorkSpecDaoKt;->getWorkStatusPojoFlowForTag(Landroidx/work/impl/model/WorkSpecDao;LZ5/y;Ljava/lang/String;)Lc6/j;
...
.method public getWorkInfosFlow(Landroidx/work/WorkQuery;)Lc6/j;
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-static {v0, p0, p1}, Landroidx/work/impl/model/RawWorkInfoDaoKt;->getWorkInfoPojosFlow(Landroidx/work/impl/model/RawWorkInfoDao;LZ5/y;Landroidx/sqlite/db/SupportSQLiteQuery;)Lc6/j;
...
.method public getWorkInfosForUniqueWorkFlow(Ljava/lang/String;)Lc6/j;
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-static {v0, p0, p1}, Landroidx/work/impl/model/WorkSpecDaoKt;->getWorkStatusPojoFlowForName(Landroidx/work/impl/model/WorkSpecDao;LZ5/y;Ljava/lang/String;)Lc6/j;
...
.method public getWorkManagerScope()LZ5/C;
    .locals 0

    iget-object p0, p0, Landroidx/work/impl/WorkManagerImpl;->mWorkManagerScope:LZ5/C;
...
.method public rescheduleEligibleWork()V
    ...
    invoke-direct {v1, p0, v2}, Landroidx/work/impl/f;-><init>(Landroidx/work/impl/WorkManagerImpl;I)V

    const-string p0, "ReschedulingWork"

    invoke-static {v0, p0, v1}, Landroidx/work/TracerKt;->traced(Landroidx/work/Tracer;Ljava/lang/String;LF4/a;)Ljava/lang/Object;
