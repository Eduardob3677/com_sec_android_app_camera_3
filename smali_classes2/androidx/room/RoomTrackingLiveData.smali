...
.field private final launchContext:Lv4/h;
...
.method private constructor <init>(Landroidx/room/RoomDatabase;Landroidx/room/InvalidationLiveDataContainer;Z[Ljava/lang/String;)V
    ...
    invoke-virtual {p1}, Landroidx/room/RoomDatabase;->getTransactionContext$room_runtime_release()Lv4/h;
    ...
    :cond_0
    invoke-virtual {p1}, Landroidx/room/RoomDatabase;->getQueryContext()Lv4/h;
    ...
    :goto_0
    iput-object p1, p0, Landroidx/room/RoomTrackingLiveData;->launchContext:Lv4/h;
...
.method public static final synthetic access$refresh(Landroidx/room/RoomTrackingLiveData;Lv4/c;)Ljava/lang/Object;
    .locals 0

    invoke-direct {p0, p1}, Landroidx/room/RoomTrackingLiveData;->refresh(Lv4/c;)Ljava/lang/Object;
...
.method private final invalidated()V
    ...
    invoke-virtual {v0}, Landroidx/room/RoomDatabase;->getCoroutineScope()LZ5/C;

    move-result-object v0

    iget-object v1, p0, Landroidx/room/RoomTrackingLiveData;->launchContext:Lv4/h;

    new-instance v2, Landroidx/room/RoomTrackingLiveData$invalidated$1;

    const/4 v3, 0x0

    invoke-direct {v2, p0, v3}, Landroidx/room/RoomTrackingLiveData$invalidated$1;-><init>(Landroidx/room/RoomTrackingLiveData;Lv4/c;)V

    const/4 p0, 0x2

    invoke-static {v0, v1, v3, v2, p0}, LZ5/F;->y(LZ5/C;Lv4/h;LZ5/E;LF4/n;I)LZ5/B0;

    :cond_0
    return-void
.end method

.method private final refresh(Lv4/c;)Ljava/lang/Object;
    .locals 6
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-direct {v0, p0, p1}, Landroidx/room/RoomTrackingLiveData$refresh$1;-><init>(Landroidx/room/RoomTrackingLiveData;Lv4/c;)V
    ...
    invoke-virtual {v2, v0}, Landroidx/room/RoomTrackingLiveData;->compute(Lv4/c;)Ljava/lang/Object;
...
# virtual methods
.method public abstract compute(Lv4/c;)Ljava/lang/Object;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
            "Lv4/c;",
...
.method public onActive()V
    ...
    invoke-direct {v2, p0, v3}, Landroidx/room/RoomTrackingLiveData$onActive$1;-><init>(Landroidx/room/RoomTrackingLiveData;Lv4/c;)V
