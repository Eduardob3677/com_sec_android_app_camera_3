...
.method private final dropAllTables(Landroidx/sqlite/SQLiteConnection;)V
    ...
    invoke-virtual {v0, v3}, Lt4/d;->add(Ljava/lang/Object;)Z
    ...
    invoke-virtual {v0, v2}, Lt4/d;->listIterator(I)Ljava/util/ListIterator;
    ...
    invoke-virtual {v0}, Lt4/c;->hasNext()Z

    move-result v1

    if-eqz v1, :cond_4

    invoke-virtual {v0}, Lt4/c;->next()Ljava/lang/Object;
...
.method public abstract useConnection(ZLF4/n;Lv4/c;)Ljava/lang/Object;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "<R:",
            "Ljava/lang/Object;",
