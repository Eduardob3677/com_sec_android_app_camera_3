...
.annotation runtime Lkotlin/Metadata;
    ...
    d2 = {
        ...
        "Lr4/o;",
        "beginTransaction",
        "(Landroidx/room/Transactor$SQLiteTransactionType;Lv4/c;)Ljava/lang/Object;",
        "success",
        "endTransaction",
        "(ZLv4/c;)Ljava/lang/Object;",
        "Lkotlin/Function0;",
        "withStateCheck",
...
.field private final transactionStack:Ls4/p;
...
.method public constructor <init>(Landroidx/room/coroutines/ConnectionWithLock;Z)V
    ...
    invoke-direct {p1}, Ls4/p;-><init>()V

    iput-object p1, p0, Landroidx/room/coroutines/PooledConnectionImpl;->transactionStack:Ls4/p;
...
.method public static final synthetic access$beginTransaction(Landroidx/room/coroutines/PooledConnectionImpl;Landroidx/room/Transactor$SQLiteTransactionType;Lv4/c;)Ljava/lang/Object;
    .locals 0

    invoke-direct {p0, p1, p2}, Landroidx/room/coroutines/PooledConnectionImpl;->beginTransaction(Landroidx/room/Transactor$SQLiteTransactionType;Lv4/c;)Ljava/lang/Object;
...
.method public static final synthetic access$endTransaction(Landroidx/room/coroutines/PooledConnectionImpl;ZLv4/c;)Ljava/lang/Object;
    .locals 0

    invoke-direct {p0, p1, p2}, Landroidx/room/coroutines/PooledConnectionImpl;->endTransaction(ZLv4/c;)Ljava/lang/Object;
...
.method public static final synthetic access$getTransactionStack$p(Landroidx/room/coroutines/PooledConnectionImpl;)Ls4/p;
    .locals 0

    iget-object p0, p0, Landroidx/room/coroutines/PooledConnectionImpl;->transactionStack:Ls4/p;
...
.method public static final synthetic access$transaction(Landroidx/room/coroutines/PooledConnectionImpl;Landroidx/room/Transactor$SQLiteTransactionType;LF4/n;Lv4/c;)Ljava/lang/Object;
    .locals 0

    invoke-direct {p0, p1, p2, p3}, Landroidx/room/coroutines/PooledConnectionImpl;->transaction(Landroidx/room/Transactor$SQLiteTransactionType;LF4/n;Lv4/c;)Ljava/lang/Object;
...
.method private final beginTransaction(Landroidx/room/Transactor$SQLiteTransactionType;Lv4/c;)Ljava/lang/Object;
    .locals 6
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-direct {v1, p0, p2}, Landroidx/room/coroutines/PooledConnectionImpl$beginTransaction$1;-><init>(Landroidx/room/coroutines/PooledConnectionImpl;Lv4/c;)V
    ...
    invoke-interface {p2, v5, v1}, Lj6/a;->lock(Ljava/lang/Object;Lv4/c;)Ljava/lang/Object;
    ...
    :goto_1
    :try_start_0
    iget-object v1, p0, Landroidx/room/coroutines/PooledConnectionImpl;->transactionStack:Ls4/p;

    invoke-virtual {v1}, Ls4/j;->size()I

    move-result v1

    iget-object v2, p0, Landroidx/room/coroutines/PooledConnectionImpl;->transactionStack:Ls4/p;
    ...
    invoke-interface {p2, v5}, Lj6/a;->unlock(Ljava/lang/Object;)V
...
.method private final endTransaction(ZLv4/c;)Ljava/lang/Object;
    .locals 7
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(Z",
    ...
    invoke-direct {v2, p0, p2}, Landroidx/room/coroutines/PooledConnectionImpl$endTransaction$1;-><init>(Landroidx/room/coroutines/PooledConnectionImpl;Lv4/c;)V
    ...
    invoke-interface {p2, v6, v2}, Lj6/a;->lock(Ljava/lang/Object;Lv4/c;)Ljava/lang/Object;
    ...
    invoke-static {v2}, Ls4/z;->d0(Ljava/util/List;)Ljava/lang/Object;
    ...
    iget-object p1, p0, Landroidx/room/coroutines/PooledConnectionImpl;->transactionStack:Ls4/p;

    invoke-virtual {p1}, Ls4/p;->isEmpty()Z
    ...
    invoke-interface {p2, v6}, Lj6/a;->unlock(Ljava/lang/Object;)V
...
.method private final transaction(Landroidx/room/Transactor$SQLiteTransactionType;LF4/n;Lv4/c;)Ljava/lang/Object;
    ...
    invoke-direct {v0, p0, p3}, Landroidx/room/coroutines/PooledConnectionImpl$transaction$1;-><init>(Landroidx/room/coroutines/PooledConnectionImpl;Lv4/c;)V
    ...
    invoke-direct {p0, p1, v0}, Landroidx/room/coroutines/PooledConnectionImpl;->beginTransaction(Landroidx/room/Transactor$SQLiteTransactionType;Lv4/c;)Ljava/lang/Object;
    ...
    invoke-direct {p1, v7, v0}, Landroidx/room/coroutines/PooledConnectionImpl;->endTransaction(ZLv4/c;)Ljava/lang/Object;
    ...
    invoke-static {p1, p2}, LN2/b;->c(Ljava/lang/Throwable;Ljava/lang/Throwable;)V
...
.method private final withStateCheck(LF4/a;Lv4/c;)Ljava/lang/Object;
    .locals 0
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "<R:",
...
.method public inTransaction(Lv4/c;)Ljava/lang/Object;
    ...
    invoke-static {v1, p0}, Landroidx/constraintlayout/core/a;->d(ILjava/lang/String;)LK2/a;
...
.method public usePrepared(Ljava/lang/String;LF4/k;Lv4/c;)Ljava/lang/Object;
    ...
    invoke-direct {v0, p0, p3}, Landroidx/room/coroutines/PooledConnectionImpl$usePrepared$1;-><init>(Landroidx/room/coroutines/PooledConnectionImpl;Lv4/c;)V
    ...
    invoke-interface {p3, v5}, Lv4/h;->get(Lv4/g;)Lv4/f;
    ...
    invoke-interface {p3, v4, v0}, Lj6/a;->lock(Ljava/lang/Object;Lv4/c;)Ljava/lang/Object;
    ...
    invoke-interface {p3, v4}, Lj6/a;->unlock(Ljava/lang/Object;)V
    ...
    invoke-static {v2, p0}, Landroidx/constraintlayout/core/a;->d(ILjava/lang/String;)LK2/a;
