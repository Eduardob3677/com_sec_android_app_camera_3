...
.annotation runtime Lkotlin/Metadata;
    ...
    d2 = {
        ...
        "onHashMatch",
        "rabinKarpSearch",
        "(Ljava/util/List;[Ljava/lang/String;LF4/o;)V",
        "T",
        "",
        "current",
        "depth",
        ...
        "block",
        "dfs",
        "(Ljava/util/List;Ljava/util/List;ILF4/k;)V",
        "ResultColumn",
        "Match",
        "Solution",
        "room-common"
...
.method public static synthetic a(Ljava/util/ArrayList;ILjava/util/List;)Lr4/o;
    .locals 0

    invoke-static {p0, p1, p2}, Landroidx/room/AmbiguousColumnResolver;->resolve$lambda$16$lambda$15(Ljava/util/List;ILjava/util/List;)Lr4/o;
...
.method public static synthetic b([Ljava/lang/String;Ljava/util/ArrayList;IIILjava/util/List;)Lr4/o;
    .locals 0

    invoke-static/range {p0 .. p5}, Landroidx/room/AmbiguousColumnResolver;->resolve$lambda$16$lambda$7([Ljava/lang/String;Ljava/util/List;IIILjava/util/List;)Lr4/o;
...
.method public static synthetic c(Lkotlin/jvm/internal/E;Ljava/util/List;)Lr4/o;
    .locals 0

    invoke-static {p0, p1}, Landroidx/room/AmbiguousColumnResolver;->resolve$lambda$19(Lkotlin/jvm/internal/E;Ljava/util/List;)Lr4/o;
...
.method private final dfs(Ljava/util/List;Ljava/util/List;ILF4/k;)V
    .locals 2
    ...
    invoke-static {p2}, Ls4/t;->S0(Ljava/lang/Iterable;)Ljava/util/List;
    ...
    invoke-direct {v0, p1, p2, v1, p4}, Landroidx/room/AmbiguousColumnResolver;->dfs(Ljava/util/List;Ljava/util/List;ILF4/k;)V
...
.method public static synthetic dfs$default(Landroidx/room/AmbiguousColumnResolver;Ljava/util/List;Ljava/util/List;ILF4/k;ILjava/lang/Object;)V
    .locals 0
    ...
    :cond_1
    invoke-direct {p0, p1, p2, p3, p4}, Landroidx/room/AmbiguousColumnResolver;->dfs(Ljava/util/List;Ljava/util/List;ILF4/k;)V

    return-void
.end method

.method private final rabinKarpSearch(Ljava/util/List;[Ljava/lang/String;LF4/o;)V
    .locals 5
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-interface {p3, p2, v3, v4}, LF4/o;->invoke(Ljava/lang/Object;Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;
...
.method public static final resolve([Ljava/lang/String;[[Ljava/lang/String;)[[I
    ...
    invoke-static {v2, v6}, Ls4/z;->W(Ljava/util/Collection;[Ljava/lang/Object;)V
    ...
    iget-object v10, v2, Lt4/j;->a:Lt4/g;

    invoke-virtual {v10, v8}, Lt4/g;->containsKey(Ljava/lang/Object;)Z
    ...
    invoke-virtual {v4, v10}, Lt4/d;->add(Ljava/lang/Object;)Z
    ...
    :cond_6
    invoke-static {v4}, LM4/I;->c(Lt4/d;)Lt4/d;
    ...
    invoke-direct {v9, v0, v7, v10}, Landroidx/room/AmbiguousColumnResolver;->rabinKarpSearch(Ljava/util/List;[Ljava/lang/String;LF4/o;)V
    ...
    invoke-virtual {v0, v3}, Lt4/d;->listIterator(I)Ljava/util/ListIterator;
    ...
    check-cast v15, Lt4/c;

    invoke-virtual {v15}, Lt4/c;->hasNext()Z

    move-result v16

    if-eqz v16, :cond_9

    invoke-virtual {v15}, Lt4/c;->next()Ljava/lang/Object;
    ...
    invoke-virtual {v13, v3}, Lt4/d;->add(Ljava/lang/Object;)Z
    ...
    :cond_9
    invoke-static {v13}, LM4/I;->c(Lt4/d;)Lt4/d;

    move-result-object v3

    invoke-virtual {v3}, Lt4/d;->isEmpty()Z
    ...
    invoke-static/range {v10 .. v16}, Landroidx/room/AmbiguousColumnResolver;->dfs$default(Landroidx/room/AmbiguousColumnResolver;Ljava/util/List;Ljava/util/List;ILF4/k;ILjava/lang/Object;)V
    ...
    invoke-direct {v8, v0, v1}, LE2/a;-><init>(Ljava/lang/Object;I)V
    ...
    invoke-static/range {v4 .. v10}, Landroidx/room/AmbiguousColumnResolver;->dfs$default(Landroidx/room/AmbiguousColumnResolver;Ljava/util/List;Ljava/util/List;ILF4/k;ILjava/lang/Object;)V
    ...
    invoke-static {v2}, Ls4/t;->R0(Ljava/util/List;)[I
...
.method private static final resolve$lambda$16$lambda$15(Ljava/util/List;ILjava/util/List;)Lr4/o;
    .locals 4
    ...
    invoke-direct {v0, v1, v2, v3}, LL4/d;-><init>(III)V

    invoke-direct {p1, v0, p2}, Landroidx/room/AmbiguousColumnResolver$Match;-><init>(LL4/f;Ljava/util/List;)V
...
.method private static final resolve$lambda$16$lambda$7([Ljava/lang/String;Ljava/util/List;IIILjava/util/List;)Lr4/o;
    .locals 8
    ...
    invoke-direct {p2, p3, p4, p5}, LL4/d;-><init>(III)V

    invoke-direct {p1, p2, v0}, Landroidx/room/AmbiguousColumnResolver$Match;-><init>(LL4/f;Ljava/util/List;)V
...
.method private static final resolve$lambda$19(Lkotlin/jvm/internal/E;Ljava/util/List;)Lr4/o;
    .locals 1
