...
.annotation runtime Lkotlin/Metadata;
    ...
    d2 = {
        ...
        "(Landroid/content/Context;IZZLandroidx/glance/oneui/common/GridSpanInfo;Landroid/util/Size;)Lr4/h;",
        "convertSizeToDp",
        "",
        "TAG",
        "Ljava/lang/String;",
...
.method public static final convertDpToSize(Landroid/content/Context;FFZZLandroidx/glance/oneui/common/GridSpanInfo;Landroid/util/Size;)I
    ...
    invoke-static {v1}, Landroidx/glance/oneui/common/DeviceConfigUtilsKt;->isPortrait(Landroid/content/res/Configuration;)Z
    ...
    sget-object v1, Landroidx/glance/oneui/common/sizepolicy/phone/PhoneSizePolicyManager;->INSTANCE:Landroidx/glance/oneui/common/sizepolicy/phone/PhoneSizePolicyManager;
    ...
    invoke-virtual/range {v1 .. v6}, Landroidx/glance/oneui/common/sizepolicy/phone/PhoneSizePolicyManager;->convertDpToSize-h6tS73U(Landroid/content/Context;FFZLandroid/util/Size;)I
    ...
    :pswitch_0
    sget-object v1, Landroidx/glance/oneui/common/sizepolicy/flip/FlipSizePolicyManager;->INSTANCE:Landroidx/glance/oneui/common/sizepolicy/flip/FlipSizePolicyManager;
    ...
    invoke-virtual/range {v1 .. v6}, Landroidx/glance/oneui/common/sizepolicy/flip/FlipSizePolicyManager;->convertDpToSize-h6tS73U(Landroid/content/Context;FFZLandroid/util/Size;)I
    ...
    :pswitch_1
    sget-object v1, Landroidx/glance/oneui/common/sizepolicy/tablet/TabletSizePolicyManager;->INSTANCE:Landroidx/glance/oneui/common/sizepolicy/tablet/TabletSizePolicyManager;
    ...
    invoke-virtual/range {v1 .. v6}, Landroidx/glance/oneui/common/sizepolicy/tablet/TabletSizePolicyManager;->convertDpToSize-h6tS73U(Landroid/content/Context;FFLandroidx/glance/oneui/common/GridSpanInfo;Landroid/util/Size;)I
    ...
    :pswitch_2
    sget-object v1, Landroidx/glance/oneui/common/sizepolicy/foldable/FoldableSizePolicyManager;->INSTANCE:Landroidx/glance/oneui/common/sizepolicy/foldable/FoldableSizePolicyManager;
    ...
    invoke-virtual/range {v1 .. v7}, Landroidx/glance/oneui/common/sizepolicy/foldable/FoldableSizePolicyManager;->convertDpToSize-9ovGfe8(Landroid/content/Context;FFZZLandroid/util/Size;)I
    ...
    :pswitch_3
    sget-object v1, Landroidx/glance/oneui/common/sizepolicy/multifold/MultiFoldableSizePolicyManager;->INSTANCE:Landroidx/glance/oneui/common/sizepolicy/multifold/MultiFoldableSizePolicyManager;
    ...
    invoke-virtual/range {v1 .. v8}, Landroidx/glance/oneui/common/sizepolicy/multifold/MultiFoldableSizePolicyManager;->convertDpToSize-TO2Bc4c(Landroid/content/Context;FFZZLandroidx/glance/oneui/common/GridSpanInfo;Landroid/util/Size;)I
    ...
    const-string p2, "GWT:AppWidgetUtils"

    invoke-virtual {v0, p2, p1}, Landroidx/glance/oneui/common/GlanceLog$Companion;->i(Ljava/lang/String;Ljava/lang/String;)V
...
.method public static synthetic convertDpToSize$default(Landroid/content/Context;FFZZLandroidx/glance/oneui/common/GridSpanInfo;Landroid/util/Size;ILjava/lang/Object;)I
    ...
    sget-object p5, Landroidx/glance/oneui/common/GridSpanInfo;->Companion:Landroidx/glance/oneui/common/GridSpanInfo$Companion;

    invoke-virtual {p5}, Landroidx/glance/oneui/common/GridSpanInfo$Companion;->getUnspecified()Landroidx/glance/oneui/common/GridSpanInfo;
    ...
    :cond_3
    invoke-static/range {p0 .. p6}, Landroidx/glance/oneui/common/AppWidgetUtilsKt;->convertDpToSize(Landroid/content/Context;FFZZLandroidx/glance/oneui/common/GridSpanInfo;Landroid/util/Size;)I
...
.method public static final convertSizeToDp-pt7MXqQ(Landroid/content/Context;IZZLandroidx/glance/oneui/common/GridSpanInfo;Landroid/util/Size;)Lr4/h;
    .locals 7
    ...
    invoke-virtual {p3, p0, p1, p2, p5}, Landroidx/glance/oneui/common/sizepolicy/phone/PhoneSizePolicyManager;->convertSizeToDp-qK15sPk(Landroid/content/Context;IZLandroid/util/Size;)Lr4/h;
    ...
    invoke-virtual {p3, p0, p1, p2, p5}, Landroidx/glance/oneui/common/sizepolicy/flip/FlipSizePolicyManager;->convertSizeToDp-qK15sPk(Landroid/content/Context;IZLandroid/util/Size;)Lr4/h;
    ...
    invoke-virtual {p2, p0, p1, p4, p5}, Landroidx/glance/oneui/common/sizepolicy/tablet/TabletSizePolicyManager;->convertSizeToDp-qK15sPk(Landroid/content/Context;ILandroidx/glance/oneui/common/GridSpanInfo;Landroid/util/Size;)Lr4/h;
    ...
    invoke-virtual/range {v0 .. v5}, Landroidx/glance/oneui/common/sizepolicy/foldable/FoldableSizePolicyManager;->convertSizeToDp-hGL1VUE(Landroid/content/Context;IZZLandroid/util/Size;)Lr4/h;
    ...
    invoke-virtual/range {v0 .. v6}, Landroidx/glance/oneui/common/sizepolicy/multifold/MultiFoldableSizePolicyManager;->convertSizeToDp-pt7MXqQ(Landroid/content/Context;IZZLandroidx/glance/oneui/common/GridSpanInfo;Landroid/util/Size;)Lr4/h;
...
.method public static synthetic convertSizeToDp-pt7MXqQ$default(Landroid/content/Context;IZZLandroidx/glance/oneui/common/GridSpanInfo;Landroid/util/Size;ILjava/lang/Object;)Lr4/h;
    .locals 1
    ...
    sget-object p4, Landroidx/glance/oneui/common/GridSpanInfo;->Companion:Landroidx/glance/oneui/common/GridSpanInfo$Companion;

    invoke-virtual {p4}, Landroidx/glance/oneui/common/GridSpanInfo$Companion;->getUnspecified()Landroidx/glance/oneui/common/GridSpanInfo;
    ...
    :cond_3
    invoke-static/range {p0 .. p5}, Landroidx/glance/oneui/common/AppWidgetUtilsKt;->convertSizeToDp-pt7MXqQ(Landroid/content/Context;IZZLandroidx/glance/oneui/common/GridSpanInfo;Landroid/util/Size;)Lr4/h;
...
.method private static final extractDpSizeFromOptions$extractFromArraySizes(Landroid/os/Bundle;Z)Landroid/util/SizeF;
    ...
    invoke-static {v0}, Ls4/t;->B0(Ljava/util/ArrayList;)F

    move-result p1

    invoke-static {v1}, Ls4/t;->z0(Ljava/util/ArrayList;)F
    ...
    invoke-static {v0}, Ls4/t;->z0(Ljava/util/ArrayList;)F

    move-result p1

    invoke-static {v1}, Ls4/t;->B0(Ljava/util/ArrayList;)F
