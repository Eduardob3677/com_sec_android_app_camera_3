...
.method public static final ComposeAutoText-2T94tj4(Landroidx/compose/ui/Modifier;Landroidx/glance/oneui/template/TextData;Landroidx/glance/text/TextPercentData;ILandroidx/glance/unit/ColorProvider;Landroidx/compose/runtime/Composer;II)V
    ...
    const-string v4, "androidx.glance.oneui.template.component.compose.ComposeAutoText (Text.kt:53)"
    ...
    invoke-virtual {v1}, Landroidx/glance/oneui/template/TextData;->getTextResId()I
    ...
    :cond_3
    invoke-virtual {v1}, Landroidx/glance/oneui/template/TextData;->getText()Ljava/lang/String;
    ...
    invoke-virtual {v8}, Landroidx/glance/text/TextPercentData;->getWidthPercent()F
    ...
    invoke-virtual {v8}, Landroidx/glance/text/TextPercentData;->getHeightPercent()F
    ...
    sget-object v11, Landroidx/glance/appwidget/util/FontUtils;->INSTANCE:Landroidx/glance/appwidget/util/FontUtils;

    invoke-virtual {v8}, Landroidx/glance/text/TextPercentData;->getMaxSize()F
    ...
    invoke-static/range {v11 .. v23}, Landroidx/glance/appwidget/util/FontUtils;->autoTextSizeByDp-Yu-sz2Y$default(Landroidx/glance/appwidget/util/FontUtils;Landroid/content/Context;Ljava/lang/String;FFFFLandroidx/glance/text/FontFamily;IZIILjava/lang/Object;)F

    move-result v25

    new-instance v24, Landroidx/glance/oneui/template/layout/TextSize;

    sget-object v26, Landroidx/glance/text/ComplexUnit;->DP:Landroidx/glance/text/ComplexUnit;
    ...
    invoke-direct/range {v24 .. v30}, Landroidx/glance/oneui/template/layout/TextSize;-><init>(FLandroidx/glance/text/ComplexUnit;IFILkotlin/jvm/internal/h;)V
    ...
    new-instance v1, Landroidx/glance/oneui/template/component/compose/TextKt$ComposeAutoText$1;
...
.method public static final ComposeText(Landroidx/glance/oneui/template/TextData;Landroidx/glance/oneui/template/layout/TextSize;Landroidx/glance/unit/ColorProvider;Landroidx/compose/ui/Modifier;Landroidx/compose/runtime/Composer;II)V
    ...
    const-string v1, "androidx.glance.oneui.template.component.compose.ComposeText (Text.kt:172)"

    invoke-static {v0, v5, p3, v1}, Landroidx/compose/runtime/ComposerKt;->traceEventStart(IIILjava/lang/String;)V

    :cond_1
    const/16 p3, 0x8

    invoke-static {p2, v9, p3}, Landroidx/glance/oneui/template/utils/ComposeUtilsKt;->convert(Landroidx/glance/unit/ColorProvider;Landroidx/compose/runtime/Composer;I)J

    move-result-wide v0

    new-instance v6, Landroidx/glance/oneui/template/component/compose/TextKt$ComposeText$5;

    invoke-direct {v6, p0, p1, v0, v1}, Landroidx/glance/oneui/template/component/compose/TextKt$ComposeText$5;-><init>(Landroidx/glance/oneui/template/TextData;Landroidx/glance/oneui/template/layout/TextSize;J)V

    new-instance v8, Landroidx/glance/oneui/template/component/compose/TextKt$ComposeText$6;

    invoke-direct {v8, p0, p1, v0, v1}, Landroidx/glance/oneui/template/component/compose/TextKt$ComposeText$6;-><init>(Landroidx/glance/oneui/template/TextData;Landroidx/glance/oneui/template/layout/TextSize;J)V

    shr-int/lit8 p3, v5, 0x6
    ...
    invoke-static/range {v6 .. v11}, Landroidx/compose/ui/viewinterop/AndroidView_androidKt;->AndroidView(LF4/k;Landroidx/compose/ui/Modifier;LF4/k;Landroidx/compose/runtime/Composer;II)V
    ...
    invoke-direct/range {v0 .. v6}, Landroidx/glance/oneui/template/component/compose/TextKt$ComposeText$7;-><init>(Landroidx/glance/oneui/template/TextData;Landroidx/glance/oneui/template/layout/TextSize;Landroidx/glance/unit/ColorProvider;Landroidx/compose/ui/Modifier;II)V
...
.method public static final ComposeText-2T94tj4(Landroidx/compose/ui/Modifier;Landroidx/glance/oneui/template/TextData;Landroidx/glance/text/TextPercentData;ILandroidx/glance/unit/ColorProvider;Landroidx/compose/runtime/Composer;II)V
    ...
    const-string v3, "androidx.glance.oneui.template.component.compose.ComposeText (Text.kt:85)"
    ...
    invoke-virtual {v4}, Landroidx/glance/text/TextPercentData;->getWidthPercent()F
    ...
    invoke-virtual {v4}, Landroidx/glance/text/TextPercentData;->getHeightPercent()F
    ...
    invoke-virtual {v4}, Landroidx/glance/text/TextPercentData;->getMaxSize()F

    move-result v20

    invoke-virtual {v4}, Landroidx/glance/text/TextPercentData;->getAutoResize()Z
    ...
    invoke-direct/range {v2 .. v9}, Landroidx/glance/oneui/template/layout/TextSize;-><init>(FLandroidx/glance/text/ComplexUnit;IFLandroidx/glance/text/TextPercentData;ILkotlin/jvm/internal/h;)V
    ...
    new-instance v1, Landroidx/glance/oneui/template/component/compose/TextKt$ComposeText$1;
...
.method public static final ComposeText-4QGO3ko(Landroidx/glance/oneui/template/TextData;ILandroidx/glance/text/ComplexUnit;ILandroidx/glance/unit/ColorProvider;Landroidx/compose/ui/Modifier;FLandroidx/compose/runtime/Composer;II)V
    ...
    const-string v4, "androidx.glance.oneui.template.component.compose.ComposeText (Text.kt:157)"
    ...
    invoke-direct/range {v9 .. v15}, Landroidx/glance/oneui/template/layout/TextSize;-><init>(Landroid/content/Context;ILandroidx/glance/text/ComplexUnit;IFLkotlin/jvm/internal/h;)V
    ...
    new-instance v0, Landroidx/glance/oneui/template/component/compose/TextKt$ComposeText$4;
...
.method public static final ComposeText-FbLeKfk(Landroidx/glance/oneui/template/TextData;FILandroidx/glance/unit/ColorProvider;Landroidx/compose/ui/Modifier;Landroidx/compose/runtime/Composer;II)V
    ...
    const-string v3, "androidx.glance.oneui.template.component.compose.ComposeText (Text.kt:122)"
    ...
    new-instance v0, Landroidx/glance/oneui/template/component/compose/TextKt$ComposeText$2;
...
.method public static final ComposeText-KuOwvYU(Landroidx/glance/oneui/template/TextData;JILandroidx/glance/unit/ColorProvider;Landroidx/compose/ui/Modifier;FLandroidx/compose/runtime/Composer;II)V
    ...
    const-string v2, "androidx.glance.oneui.template.component.compose.ComposeText (Text.kt:139)"
    ...
    invoke-direct/range {v9 .. v14}, Landroidx/glance/oneui/template/layout/TextSize;-><init>(FLandroidx/glance/text/ComplexUnit;IFLkotlin/jvm/internal/h;)V
    ...
    new-instance v0, Landroidx/glance/oneui/template/component/compose/TextKt$ComposeText$3;
...
.method public static final ComposeTextList(Ljava/util/List;Ljava/util/List;Ljava/util/List;Ljava/util/List;ZLandroidx/compose/runtime/Composer;II)V
    ...
    const-string v3, "androidx.glance.oneui.template.component.compose.ComposeTextList (Text.kt:188)"
    ...
    invoke-static {v0, v7, v1, v11}, Landroidx/compose/foundation/layout/SizeKt;->fillMaxWidth$default(Landroidx/compose/ui/Modifier;FILjava/lang/Object;)Landroidx/compose/ui/Modifier;
    ...
    :goto_2
    new-instance v1, Landroidx/glance/oneui/template/component/compose/TextKt$ComposeTextList$1;
    ...
    new-instance v1, Landroidx/glance/oneui/template/component/compose/TextKt$ComposeTextList$2;
    ...
    new-instance v1, Landroidx/glance/oneui/template/component/compose/TextKt$ComposeTextList$3;
...
.method private static final update-g2O1Hgs(Landroid/widget/TextView;Landroidx/glance/oneui/template/TextData;Landroidx/glance/oneui/template/layout/TextSize;J)V
    ...
    invoke-static {p3, v2}, Landroidx/glance/text/FontWeight;->equals-impl0(II)Z
    ...
    sget-object v3, Landroidx/glance/text/TextDecoration;->Companion:Landroidx/glance/text/TextDecoration$Companion;

    invoke-virtual {v3}, Landroidx/glance/text/TextDecoration$Companion;->getLineThrough-ObZ5V_A()I
    ...
    invoke-static {v5, v4}, Landroidx/glance/text/TextDecoration;->equals-impl0(II)Z
    ...
    :cond_e
    invoke-virtual {v3}, Landroidx/glance/text/TextDecoration$Companion;->getUnderline-ObZ5V_A()I
    ...
    invoke-static {p3, v3}, Landroidx/glance/text/TextDecoration;->equals-impl0(II)Z
    ...
    invoke-virtual {v3}, Landroidx/glance/text/TextShadowStyle;->getDx()F
    ...
    invoke-virtual {v4}, Landroidx/glance/text/TextShadowStyle;->getDy()F
    ...
    invoke-virtual {v5}, Landroidx/glance/text/TextShadowStyle;->getColor-0d7_KjU()J
    ...
    invoke-virtual {p0, p3, v3, v4, v5}, Landroid/widget/TextView;->setShadowLayer(FFFI)V
    ...
    invoke-static {p3, p4}, Landroidx/glance/appwidget/util/FontUtilsKt;->dpToPx-3ABfNKs(Landroid/content/Context;F)I
    ...
    invoke-static {p4, v3}, Lkotlin/jvm/internal/p;->d(Ljava/lang/Object;Ljava/lang/String;)V

    invoke-static {p2}, Landroidx/compose/ui/unit/Dp;->constructor-impl(F)F

    move-result p2

    invoke-static {p4, p2}, Landroidx/glance/appwidget/util/FontUtilsKt;->dpToPx-3ABfNKs(Landroid/content/Context;F)I

    move-result p2

    invoke-virtual {p0, p3, p2, v1, v2}, Landroid/widget/TextView;->setAutoSizeTextTypeUniformWithConfiguration(IIII)V
