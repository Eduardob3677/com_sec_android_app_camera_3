...
# direct methods
.method public constructor <init>(ZLF4/n;Landroidx/glance/oneui/template/TitleBarData;LF4/n;)V
    .locals 0
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(Z",
    ...
    iput-object p2, p0, Landroidx/glance/oneui/template/component/glance/TitleBarKt$GlanceContent$2$1;->$actionContent:LF4/n;
    ...
    iput-object p4, p0, Landroidx/glance/oneui/template/component/glance/TitleBarKt$GlanceContent$2$1;->$subtitleContent:LF4/n;
...
.method public final invoke(Landroidx/glance/layout/RowScope;Landroidx/compose/runtime/Composer;I)V
    ...
    const v5, 0x4d134166    # 1.54408544E8f
    ...
    :cond_1
    invoke-static {v4, v2}, Landroidx/glance/oneui/template/component/glance/TitleBarKt;->access$isSmallTablet(Landroidx/compose/runtime/Composer;I)Z
    ...
    new-instance v3, Landroidx/glance/oneui/template/component/glance/TitleBarKt$GlanceContent$2$1$1;

    iget-object v5, v0, Landroidx/glance/oneui/template/component/glance/TitleBarKt$GlanceContent$2$1;->$this_GlanceContent:Landroidx/glance/oneui/template/TitleBarData;

    iget-object v6, v0, Landroidx/glance/oneui/template/component/glance/TitleBarKt$GlanceContent$2$1;->$subtitleContent:LF4/n;

    iget-boolean v7, v0, Landroidx/glance/oneui/template/component/glance/TitleBarKt$GlanceContent$2$1;->$isWideSmall:Z

    invoke-direct {v3, v5, v6, v7}, Landroidx/glance/oneui/template/component/glance/TitleBarKt$GlanceContent$2$1$1;-><init>(Landroidx/glance/oneui/template/TitleBarData;LF4/n;Z)V

    const v5, 0x26108630

    const/4 v13, 0x1

    invoke-static {v4, v5, v13, v3}, Landroidx/compose/runtime/internal/ComposableLambdaKt;->composableLambda(Landroidx/compose/runtime/Composer;IZLjava/lang/Object;)Landroidx/compose/runtime/internal/ComposableLambda;
    ...
    iget-object v1, v0, Landroidx/glance/oneui/template/component/glance/TitleBarKt$GlanceContent$2$1;->$actionContent:LF4/n;
    ...
    invoke-static {v8, v1}, Landroidx/glance/layout/SizeModifiersKt;->width-3ABfNKs(Landroidx/glance/GlanceModifier;F)Landroidx/glance/GlanceModifier;

    move-result-object v1

    invoke-static {v1, v4, v9, v9}, Landroidx/glance/layout/SpacerKt;->Spacer(Landroidx/glance/GlanceModifier;Landroidx/compose/runtime/Composer;II)V

    iget-object v0, v0, Landroidx/glance/oneui/template/component/glance/TitleBarKt$GlanceContent$2$1;->$actionContent:LF4/n;

    invoke-static {v0, v4, v9}, Landroidx/collection/a;->x(LF4/n;Landroidx/compose/runtime/Composer;I)V
    ...
    invoke-static/range {v6 .. v12}, Landroidx/glance/layout/PaddingKt;->padding-qDBjuR0$default(Landroidx/glance/GlanceModifier;FFFFILjava/lang/Object;)Landroidx/glance/GlanceModifier;

    move-result-object v1

    new-instance v2, Landroidx/glance/oneui/template/component/glance/TitleBarKt$GlanceContent$2$1$2;
    ...
    invoke-direct {v2, v0}, Landroidx/glance/oneui/template/component/glance/TitleBarKt$GlanceContent$2$1$2;-><init>(Landroidx/glance/oneui/template/TitleBarData;)V

    const v0, 0x76dff67e

    invoke-static {v4, v0, v13, v2}, Landroidx/compose/runtime/internal/ComposableLambdaKt;->composableLambda(Landroidx/compose/runtime/Composer;IZLjava/lang/Object;)Landroidx/compose/runtime/internal/ComposableLambda;
