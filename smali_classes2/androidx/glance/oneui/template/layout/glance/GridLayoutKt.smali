...
.annotation runtime Lkotlin/Metadata;
    ...
    d2 = {
        ...
        "map",
        "GridMap",
        "(Landroidx/glance/GlanceModifier;Ljava/util/List;Lr4/h;Landroidx/compose/runtime/Composer;II)V",
        "LL4/f;",
        "range",
        "GridRow",
        "(Landroidx/glance/GlanceModifier;Ljava/util/List;LL4/f;Landroidx/compose/runtime/Composer;II)V",
        "gridItem",
        "gridCount",
        "gridPosition",
        "GridItemContainer",
...
.method static constructor <clinit>()V
    ...
    sget v2, Landroidx/glance/oneui/template/R$drawable;->skeleton_circle:I
    ...
    sput-object v0, Landroidx/glance/oneui/template/layout/glance/GridLayoutKt;->EmptyGridItem:Landroidx/glance/oneui/template/GridItem;

    new-instance v1, Landroidx/glance/oneui/template/GridItem;

    new-instance v2, Landroidx/glance/oneui/template/ImageWithBackgroundData;

    sget v0, Landroidx/glance/oneui/template/R$drawable;->skeleton_circle:I
    ...
    sput-object v1, Landroidx/glance/oneui/template/layout/glance/GridLayoutKt;->EmptyLabelGridItem:Landroidx/glance/oneui/template/GridItem;
...
.method private static final Badge(Landroidx/glance/oneui/template/BadgeData;Landroidx/compose/runtime/Composer;I)V
    ...
    const-string v1, "androidx.glance.oneui.template.layout.glance.Badge (GridLayout.kt:420)"
    ...
    invoke-static {p1, v0}, Landroidx/glance/oneui/template/color/ColorProvidersKt;->override(Landroidx/glance/unit/ColorProvider;Landroidx/glance/unit/ColorProvider;)Landroidx/glance/unit/ColorProvider;
    ...
    invoke-direct {v3, p1, p0}, Landroidx/glance/oneui/template/layout/glance/GridLayoutKt$Badge$1;-><init>(Landroidx/glance/unit/ColorProvider;Landroidx/glance/oneui/template/BadgeData;)V

    const p1, -0x3d2eb1a9

    invoke-static {v7, p1, v0, v3}, Landroidx/compose/runtime/internal/ComposableLambdaKt;->composableLambda(Landroidx/compose/runtime/Composer;IZLjava/lang/Object;)Landroidx/compose/runtime/internal/ComposableLambda;
    ...
    invoke-static {v2}, Landroidx/glance/layout/SizeModifiersKt;->wrapContentWidth(Landroidx/glance/GlanceModifier;)Landroidx/glance/GlanceModifier;
    ...
    invoke-static {v2, p1}, Landroidx/glance/BackgroundKt;->background(Landroidx/glance/GlanceModifier;Landroidx/glance/unit/ColorProvider;)Landroidx/glance/GlanceModifier;
    ...
    invoke-static {p1, v2}, Landroidx/glance/appwidget/CornerRadiusKt;->cornerRadius-3ABfNKs(Landroidx/glance/GlanceModifier;F)Landroidx/glance/GlanceModifier;
    ...
    invoke-static {p1, v2}, Landroidx/glance/appwidget/AppWidgetModifiersKt;->keepColor(Landroidx/glance/GlanceModifier;Z)Landroidx/glance/GlanceModifier;
    ...
    new-instance p1, Landroidx/glance/oneui/template/layout/glance/GridLayoutKt$Badge$2;

    invoke-direct {p1, p0}, Landroidx/glance/oneui/template/layout/glance/GridLayoutKt$Badge$2;-><init>(Landroidx/glance/oneui/template/BadgeData;)V

    const v4, 0x721d33ae

    invoke-static {v7, v4, v0, p1}, Landroidx/compose/runtime/internal/ComposableLambdaKt;->composableLambda(Landroidx/compose/runtime/Composer;IZLjava/lang/Object;)Landroidx/compose/runtime/internal/ComposableLambda;
...
.method public static final GlanceGridLayout(Ljava/util/List;Landroidx/compose/runtime/Composer;I)V
    ...
    const-string v1, "androidx.glance.oneui.template.layout.glance.GlanceGridLayout (GridLayout.kt:121)"
    ...
    invoke-static {p1, v6, v0}, Landroidx/glance/oneui/template/layout/glance/GridLayoutKt;->getGridContainerHorizontalPadding-R2GYfMI(ILandroidx/compose/runtime/Composer;I)F

    move-result v2

    invoke-static {p1, v6, v0}, Landroidx/glance/oneui/template/layout/glance/GridLayoutKt;->getGridContainerVerticalPadding-R2GYfMI(ILandroidx/compose/runtime/Composer;I)F
    ...
    invoke-direct {v1, p0, p1}, Landroidx/glance/oneui/template/layout/glance/GridLayoutKt$GlanceGridLayout$2;-><init>(Ljava/util/List;I)V
...
.method private static final GridItemContainer(Landroidx/glance/GlanceModifier;Landroidx/glance/oneui/template/GridItem;IILandroidx/compose/runtime/Composer;II)V
    ...
    const-string v3, "androidx.glance.oneui.template.layout.glance.GridItemContainer (GridLayout.kt:193)"
    ...
    instance-of v14, v15, Landroidx/glance/oneui/template/ProgressGridItem;
    ...
    new-instance v13, Landroidx/glance/oneui/template/layout/glance/GridLayoutKt$GridItemContainer$1;

    move/from16 v18, p2

    move/from16 v16, p3

    invoke-direct/range {v13 .. v22}, Landroidx/glance/oneui/template/layout/glance/GridLayoutKt$GridItemContainer$1;-><init>(ZLandroidx/glance/oneui/template/GridItem;IIILandroidx/glance/oneui/template/ImageWithBackgroundData;Landroidx/glance/oneui/template/TextData;ZLandroidx/glance/action/Action;)V

    const v0, -0x251299e6

    const/4 v2, 0x1

    invoke-static {v12, v0, v2, v13}, Landroidx/compose/runtime/internal/ComposableLambdaKt;->composableLambda(Landroidx/compose/runtime/Composer;IZLjava/lang/Object;)Landroidx/compose/runtime/internal/ComposableLambda;
    ...
    new-instance v0, Landroidx/glance/oneui/template/layout/glance/GridLayoutKt$GridItemContainer$2;
...
.method private static final GridItemContent-hBwqbR0(IILandroidx/glance/oneui/template/ImageWithBackgroundData;Landroidx/glance/oneui/template/TextData;ZZLandroidx/glance/oneui/template/BadgeData;Landroidx/glance/action/Action;Ljava/lang/String;Landroidx/compose/runtime/Composer;I)V
    ...
    const-string v4, "androidx.glance.oneui.template.layout.glance.GridItemContent (GridLayout.kt:247)"
    ...
    invoke-virtual {v0, v10, v1, v5, v2}, Landroidx/glance/oneui/template/size/GridTemplateDp;->getMaxIconSize-xeG5q6M(Landroid/content/Context;IZI)F
    ...
    invoke-static {v12, v1}, Landroidx/glance/oneui/common/AppWidgetSize;->compareTo-L2j3NV4(II)I
    ...
    sget v3, Landroidx/glance/oneui/template/R$dimen;->sesl_glance_grid_item_text_view_height:I

    invoke-static {v10, v3}, Landroidx/glance/oneui/template/utils/ResourceUtilsKt;->getFloat(Landroid/content/Context;I)F
    ...
    :cond_3
    sget v3, Landroidx/glance/oneui/template/R$dimen;->sesl_glance_grid_item_text_view_height_over_2_line:I
    ...
    new-instance v16, Landroidx/glance/oneui/template/BadgeData;
    ...
    invoke-direct/range {v16 .. v23}, Landroidx/glance/oneui/template/BadgeData;-><init>(Ljava/lang/String;ZLandroidx/glance/unit/ColorProvider;Landroidx/glance/unit/ColorProvider;ZILkotlin/jvm/internal/h;)V
    ...
    new-instance v0, Landroidx/glance/oneui/template/layout/glance/GridLayoutKt$GridItemContent$1;
...
.method private static final GridItemContent_hBwqbR0$GridItemContent(FLandroidx/glance/oneui/template/ImageType;Landroidx/glance/oneui/template/ImageWithBackgroundData;Landroidx/glance/oneui/template/BadgeData;ZILandroidx/glance/oneui/template/TextData;FILandroidx/glance/action/Action;IFLjava/lang/String;Landroidx/compose/runtime/Composer;I)V
    ...
    const-string v6, "androidx.glance.oneui.template.layout.glance.GridItemContent.GridItemContent (GridLayout.kt:278)"
    ...
    invoke-static {v11, p0}, Landroidx/glance/layout/SizeModifiersKt;->size-3ABfNKs(Landroidx/glance/GlanceModifier;F)Landroidx/glance/GlanceModifier;

    move-result-object v4

    sget-object v12, Landroidx/glance/oneui/template/ImageType;->AppIcon:Landroidx/glance/oneui/template/ImageType;
    ...
    :goto_0
    invoke-static {v4, v6}, Landroidx/glance/appwidget/CornerRadiusKt;->cornerRadius-3ABfNKs(Landroidx/glance/GlanceModifier;F)Landroidx/glance/GlanceModifier;
    ...
    :goto_1
    invoke-static {v4, v6}, Landroidx/glance/layout/PaddingKt;->padding-3ABfNKs(Landroidx/glance/GlanceModifier;F)Landroidx/glance/GlanceModifier;
    ...
    invoke-static {v7, v6}, Landroidx/glance/oneui/common/AppWidgetSize;->compareTo-L2j3NV4(II)I
    ...
    invoke-static/range {v4 .. v10}, Landroidx/glance/oneui/template/layout/glance/GridLayoutKt;->GridItemIcon(Landroidx/glance/GlanceModifier;Landroidx/glance/oneui/template/ImageWithBackgroundData;Landroidx/glance/oneui/template/BadgeData;ZLandroidx/compose/runtime/Composer;II)V
    ...
    invoke-static {v11, p0}, Landroidx/glance/layout/SizeModifiersKt;->width-3ABfNKs(Landroidx/glance/GlanceModifier;F)Landroidx/glance/GlanceModifier;

    move-result-object p0

    move/from16 v0, p7

    invoke-static {p0, v0}, Landroidx/glance/layout/SizeModifiersKt;->height-3ABfNKs(Landroidx/glance/GlanceModifier;F)Landroidx/glance/GlanceModifier;

    move-result-object p0

    move/from16 v0, p10

    invoke-virtual {v1, v0}, Landroidx/glance/oneui/template/TextData;->setMaxLines$glance_oneui_template_release(I)V
    ...
    :cond_5
    invoke-static {v11, v3}, Landroidx/glance/layout/SizeModifiersKt;->size-3ABfNKs(Landroidx/glance/GlanceModifier;F)Landroidx/glance/GlanceModifier;
    ...
    invoke-static {p0, v0}, Landroidx/glance/oneui/template/utils/GlanceModifierUtilsKt;->contentDescription(Landroidx/glance/GlanceModifier;Ljava/lang/String;)Landroidx/glance/GlanceModifier;

    move-result-object p0

    const/16 v0, 0x40

    invoke-static {p0, v2, v8, v0}, Landroidx/glance/oneui/template/layout/glance/GridLayoutKt;->RippleContent(Landroidx/glance/GlanceModifier;Landroidx/glance/action/Action;Landroidx/compose/runtime/Composer;I)V
...
.method private static final GridItemContent_hBwqbR0$GridItemContentWithLabel(IIFFFLandroidx/glance/action/Action;Ljava/lang/String;Landroidx/glance/oneui/template/ImageType;Landroidx/glance/oneui/template/ImageWithBackgroundData;Landroidx/glance/oneui/template/BadgeData;Landroidx/glance/oneui/template/TextData;IILandroidx/compose/runtime/Composer;I)V
    ...
    invoke-static {v4, v3}, Landroidx/glance/layout/SizeModifiersKt;->height-3ABfNKs(Landroidx/glance/GlanceModifier;F)Landroidx/glance/GlanceModifier;

    move-result-object v3

    sget-object v4, Landroidx/glance/layout/Alignment;->Companion:Landroidx/glance/layout/Alignment$Companion;

    invoke-virtual {v4}, Landroidx/glance/layout/Alignment$Companion;->getTopCenter()Landroidx/glance/layout/Alignment;

    move-result-object v4

    new-instance v5, Landroidx/glance/oneui/template/layout/glance/GridLayoutKt$GridItemContent$GridItemContentWithLabel$1;

    move-object/from16 v6, p5

    move-object/from16 v7, p6

    invoke-direct {v5, v6, v0, v7}, Landroidx/glance/oneui/template/layout/glance/GridLayoutKt$GridItemContent$GridItemContentWithLabel$1;-><init>(Landroidx/glance/action/Action;FLjava/lang/String;)V

    const v0, -0x4b1c5119

    invoke-static {v8, v0, v11, v5}, Landroidx/compose/runtime/internal/ComposableLambdaKt;->composableLambda(Landroidx/compose/runtime/Composer;IZLjava/lang/Object;)Landroidx/compose/runtime/internal/ComposableLambda;
    ...
    new-instance v0, Landroidx/glance/oneui/template/layout/glance/GridLayoutKt$GridItemContent$GridItemContentWithLabel$2;
    ...
    invoke-virtual/range {p0 .. p8}, Landroidx/glance/oneui/template/utils/Debug;->debugBox(Landroidx/glance/GlanceModifier;Landroidx/glance/layout/Alignment;Ljava/lang/String;ZLF4/n;Landroidx/compose/runtime/Composer;II)V
...
.method private static final GridItemIcon(Landroidx/glance/GlanceModifier;Landroidx/glance/oneui/template/ImageWithBackgroundData;Landroidx/glance/oneui/template/BadgeData;ZLandroidx/compose/runtime/Composer;II)V
    ...
    const-string v2, "androidx.glance.oneui.template.layout.glance.GridItemIcon (GridLayout.kt:398)"
    ...
    invoke-static {v2, v1}, Landroidx/glance/BackgroundKt;->background(Landroidx/glance/GlanceModifier;Landroidx/glance/unit/ColorProvider;)Landroidx/glance/GlanceModifier;
    ...
    sget v0, Landroidx/glance/oneui/template/R$color;->sesl_glance_text_overlapped_icon_dim:I
    ...
    invoke-direct/range {v10 .. v18}, Landroidx/glance/oneui/template/ImageData;-><init>(Landroidx/glance/ImageProvider;Ljava/lang/String;Landroidx/glance/oneui/template/ImageType;Landroidx/glance/unit/ColorProvider;Landroidx/glance/appwidget/animation/RemoteAnimation;ZILkotlin/jvm/internal/h;)V
    ...
    invoke-direct {v0, v3}, Landroidx/glance/oneui/template/layout/glance/GridLayoutKt$GridItemIcon$1;-><init>(Landroidx/glance/oneui/template/BadgeData;)V
    ...
    new-instance v0, Landroidx/glance/oneui/template/layout/glance/GridLayoutKt$GridItemIcon$2;
...
.method private static final GridItemText-ium9O2g(Landroidx/glance/GlanceModifier;Landroidx/glance/oneui/template/TextData;ILandroidx/compose/runtime/Composer;II)V
    ...
    const-string p3, "androidx.glance.oneui.template.layout.glance.GridItemText (GridLayout.kt:470)"
    ...
    invoke-virtual {p0, v7, p3}, Landroidx/glance/GlanceTheme;->getColors(Landroidx/compose/runtime/Composer;I)Landroidx/glance/color/ColorProviders;
    ...
    invoke-static {p0, v0}, Landroidx/glance/oneui/template/color/ColorProvidersKt;->override(Landroidx/glance/unit/ColorProvider;Landroidx/glance/unit/ColorProvider;)Landroidx/glance/unit/ColorProvider;
    ...
    new-instance v0, Landroidx/glance/oneui/template/layout/glance/GridLayoutKt$GridItemText$1;

    invoke-direct {v0, p1, p3, p0}, Landroidx/glance/oneui/template/layout/glance/GridLayoutKt$GridItemText$1;-><init>(Landroidx/glance/oneui/template/TextData;ILandroidx/glance/unit/ColorProvider;)V

    const p0, -0x15200663

    const/4 p3, 0x1

    invoke-static {v7, p0, p3, v0}, Landroidx/compose/runtime/internal/ComposableLambdaKt;->composableLambda(Landroidx/compose/runtime/Composer;IZLjava/lang/Object;)Landroidx/compose/runtime/internal/ComposableLambda;
    ...
    new-instance v1, Landroidx/glance/oneui/template/layout/glance/GridLayoutKt$GridItemText$2;
...
.method private static final GridMap(Landroidx/glance/GlanceModifier;Ljava/util/List;Lr4/h;Landroidx/compose/runtime/Composer;II)V
    .locals 12
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    const-string p3, "androidx.glance.oneui.template.layout.glance.GridMap (GridLayout.kt:146)"

    invoke-static {v0, v4, p0, p3}, Landroidx/compose/runtime/ComposerKt;->traceEventStart(IIILjava/lang/String;)V

    :cond_1
    iget-object p0, p2, Lr4/h;->a:Ljava/lang/Object;
    ...
    iget-object p3, p2, Lr4/h;->b:Ljava/lang/Object;
    ...
    new-instance v0, Landroidx/glance/oneui/template/layout/glance/GridLayoutKt$GridMap$1;

    invoke-direct {v0, p3, p0, p1}, Landroidx/glance/oneui/template/layout/glance/GridLayoutKt$GridMap$1;-><init>(IILjava/util/List;)V

    const p0, -0xfeadb9c

    const/4 p3, 0x1

    invoke-static {v9, p0, p3, v0}, Landroidx/compose/runtime/internal/ComposableLambdaKt;->composableLambda(Landroidx/compose/runtime/Composer;IZLjava/lang/Object;)Landroidx/compose/runtime/internal/ComposableLambda;
    ...
    invoke-direct/range {v0 .. v5}, Landroidx/glance/oneui/template/layout/glance/GridLayoutKt$GridMap$2;-><init>(Landroidx/glance/GlanceModifier;Ljava/util/List;Lr4/h;II)V
...
.method private static final GridRow(Landroidx/glance/GlanceModifier;Ljava/util/List;LL4/f;Landroidx/compose/runtime/Composer;II)V
    .locals 12
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    const-string p3, "androidx.glance.oneui.template.layout.glance.GridRow (GridLayout.kt:167)"
    ...
    new-instance p3, Landroidx/glance/oneui/template/layout/glance/GridLayoutKt$GridRow$1;

    invoke-direct {p3, p2, p0, p1}, Landroidx/glance/oneui/template/layout/glance/GridLayoutKt$GridRow$1;-><init>(LL4/f;ILjava/util/List;)V

    const p0, -0x4bebfe64

    const/4 v0, 0x1

    invoke-static {v9, p0, v0, p3}, Landroidx/compose/runtime/internal/ComposableLambdaKt;->composableLambda(Landroidx/compose/runtime/Composer;IZLjava/lang/Object;)Landroidx/compose/runtime/internal/ComposableLambda;
    ...
    invoke-static/range {v5 .. v11}, Landroidx/glance/layout/RowKt;->Row-lMAjyxE(Landroidx/glance/GlanceModifier;IILF4/o;Landroidx/compose/runtime/Composer;II)V
    ...
    invoke-direct/range {v0 .. v5}, Landroidx/glance/oneui/template/layout/glance/GridLayoutKt$GridRow$2;-><init>(Landroidx/glance/GlanceModifier;Ljava/util/List;LL4/f;II)V
...
.method private static final RippleContent(Landroidx/glance/GlanceModifier;Landroidx/glance/action/Action;Landroidx/compose/runtime/Composer;I)V
    ...
    const-string v1, "androidx.glance.oneui.template.layout.glance.RippleContent (GridLayout.kt:382)"
    ...
    sget p2, Landroidx/glance/oneui/template/R$drawable;->sesl_glance_dim_effect:I
    ...
    sget-object p2, Landroidx/glance/oneui/template/layout/glance/ComposableSingletons$GridLayoutKt;->INSTANCE:Landroidx/glance/oneui/template/layout/glance/ComposableSingletons$GridLayoutKt;

    invoke-virtual {p2}, Landroidx/glance/oneui/template/layout/glance/ComposableSingletons$GridLayoutKt;->getLambda-1$glance_oneui_template_release()LF4/n;
...
.method public static final synthetic access$GridMap(Landroidx/glance/GlanceModifier;Ljava/util/List;Lr4/h;Landroidx/compose/runtime/Composer;II)V
    .locals 0

    invoke-static/range {p0 .. p5}, Landroidx/glance/oneui/template/layout/glance/GridLayoutKt;->GridMap(Landroidx/glance/GlanceModifier;Ljava/util/List;Lr4/h;Landroidx/compose/runtime/Composer;II)V

    return-void
.end method

.method public static final synthetic access$GridRow(Landroidx/glance/GlanceModifier;Ljava/util/List;LL4/f;Landroidx/compose/runtime/Composer;II)V
    .locals 0

    invoke-static/range {p0 .. p5}, Landroidx/glance/oneui/template/layout/glance/GridLayoutKt;->GridRow(Landroidx/glance/GlanceModifier;Ljava/util/List;LL4/f;Landroidx/compose/runtime/Composer;II)V
