...
.method private static final GlanceListItem-ajneRBI(Landroidx/glance/oneui/template/ListItem;IIILandroidx/glance/GlanceModifier;ZZLandroidx/glance/unit/ColorProvider;Landroidx/compose/runtime/Composer;II)V
    ...
    const-string v3, "androidx.glance.oneui.template.layout.glance.GlanceListItem (ListLayout.kt:188)"
    ...
    :goto_3
    invoke-virtual {v0}, Landroidx/glance/oneui/template/ListItem;->getOnClick()Landroidx/glance/action/Action;
    ...
    invoke-static/range {v13 .. v19}, Landroidx/glance/oneui/template/utils/GlanceModifierUtilsKt;->maybeClickable$default(Landroidx/glance/GlanceModifier;Landroidx/glance/action/Action;ZZIILjava/lang/Object;)Landroidx/glance/GlanceModifier;
    ...
    invoke-static {v2, v3}, Landroidx/glance/oneui/template/utils/GlanceModifierUtilsKt;->contentDescription(Landroidx/glance/GlanceModifier;Ljava/lang/String;)Landroidx/glance/GlanceModifier;
    ...
    instance-of v2, v0, Landroidx/glance/oneui/template/ProgressListItem;
    ...
    new-instance v0, Landroidx/glance/oneui/template/layout/glance/ListLayoutKt$GlanceListItem$1;
...
.method private static final GlanceListItem_ajneRBI$CategoryText(Landroidx/glance/oneui/template/ListItem;Landroidx/glance/GlanceModifier;ZIZLandroidx/compose/runtime/Composer;I)V
    ...
    new-instance v1, Landroidx/glance/oneui/template/layout/glance/ListLayoutKt$GlanceListItem$CategoryText$1;
    ...
    invoke-static {p5, p0, p1, v1}, Landroidx/compose/runtime/internal/ComposableLambdaKt;->composableLambda(Landroidx/compose/runtime/Composer;IZLjava/lang/Object;)Landroidx/compose/runtime/internal/ComposableLambda;
...
.method private static final GlanceListItem_ajneRBI$DefaultListItem(Landroidx/glance/oneui/template/ListItem;IZZZIILandroidx/glance/GlanceModifier;Landroidx/glance/unit/ColorProvider;Landroidx/compose/runtime/Composer;I)V
    ...
    new-instance v2, Landroidx/glance/oneui/template/layout/glance/ListLayoutKt$GlanceListItem$DefaultListItem$1$1;
    ...
    invoke-direct/range {v2 .. v14}, Landroidx/glance/oneui/template/layout/glance/ListLayoutKt$GlanceListItem$DefaultListItem$1$1;-><init>(FZZZLandroid/content/Context;ZZILandroidx/glance/GlanceModifier;Landroidx/glance/oneui/template/ListItem;Landroidx/glance/oneui/template/TypedTextData;Landroidx/glance/unit/ColorProvider;)V

    const v3, -0xbd41ca

    invoke-static {v0, v3, v15, v2}, Landroidx/compose/runtime/internal/ComposableLambdaKt;->composableLambda(Landroidx/compose/runtime/Composer;IZLjava/lang/Object;)Landroidx/compose/runtime/internal/ComposableLambda;
    ...
    invoke-static {v4, v2}, Landroidx/glance/layout/Alignment$Vertical;->equals-impl0(II)Z
    ...
    invoke-direct {v4, v3, v11, v12, v13}, Landroidx/glance/oneui/template/layout/glance/ListLayoutKt$GlanceListItem$DefaultListItem$1$2;-><init>(FLandroidx/glance/GlanceModifier;Landroidx/glance/oneui/template/ListItem;Landroidx/glance/oneui/template/TypedTextData;)V
...
.method private static final GlanceListItem_ajneRBI$ProgressListItem(Landroidx/glance/oneui/template/ListItem;IIZZLandroidx/glance/GlanceModifier;ZLandroidx/compose/runtime/Composer;I)V
    ...
    instance-of v1, v10, Landroidx/glance/oneui/template/ProgressListItem;
    ...
    invoke-static {v9, v2}, Landroidx/glance/oneui/common/AppWidgetHostType;->equals-impl0(II)Z
    ...
    invoke-static {v8, v2}, Landroidx/glance/oneui/common/AppWidgetSize;->equals-impl0(II)Z
    ...
    :goto_8
    new-instance v4, Landroidx/glance/oneui/template/layout/glance/ListLayoutKt$GlanceListItem$ProgressListItem$1;
...
.method public static final GlanceListLayout-YlGCr2M(Landroidx/glance/oneui/template/ListData;ZZFFZZLandroidx/compose/runtime/Composer;II)V
    ...
    const-string v12, "androidx.glance.oneui.template.layout.glance.GlanceListLayout (ListLayout.kt:69)"
    ...
    new-instance v1, Landroidx/glance/oneui/template/layout/glance/ListLayoutKt$GlanceListLayout$1;
    ...
    invoke-direct/range {v1 .. v10}, Landroidx/glance/oneui/template/layout/glance/ListLayoutKt$GlanceListLayout$1;-><init>(Landroidx/glance/oneui/template/ListData;ZZFFZZII)V
    ...
    invoke-static {v4, v9}, Landroidx/glance/oneui/common/AppWidgetSize;->compareTo-L2j3NV4(II)I
    ...
    invoke-static {v4}, Landroidx/glance/layout/SizeModifiersKt;->fillMaxWidth(Landroidx/glance/GlanceModifier;)Landroidx/glance/GlanceModifier;
    ...
    invoke-static {v4}, Landroidx/glance/layout/SizeModifiersKt;->fillMaxHeight(Landroidx/glance/GlanceModifier;)Landroidx/glance/GlanceModifier;
    ...
    invoke-virtual {v9}, Landroidx/glance/layout/Alignment$Companion;->getTop-mnfRV0w()I

    move-result v13

    invoke-static {v5, v13}, Landroidx/glance/layout/Alignment$Vertical;->equals-impl0(II)Z

    move-result v13

    if-eqz v13, :cond_d

    invoke-virtual {v9}, Landroidx/glance/layout/Alignment$Companion;->getTopStart()Landroidx/glance/layout/Alignment;
    ...
    :cond_d
    invoke-virtual {v9}, Landroidx/glance/layout/Alignment$Companion;->getCenterVertically-mnfRV0w()I
    ...
    invoke-virtual {v9}, Landroidx/glance/layout/Alignment$Companion;->getCenterStart()Landroidx/glance/layout/Alignment;
    ...
    :cond_e
    invoke-virtual {v9}, Landroidx/glance/layout/Alignment$Companion;->getBottomStart()Landroidx/glance/layout/Alignment;
    ...
    :goto_8
    new-instance v13, Landroidx/glance/oneui/template/layout/glance/ListLayoutKt$GlanceListLayout$2;
    ...
    invoke-static {v7, v5, v3, v2}, Landroidx/compose/runtime/internal/ComposableLambdaKt;->composableLambda(Landroidx/compose/runtime/Composer;IZLjava/lang/Object;)Landroidx/compose/runtime/internal/ComposableLambda;
    ...
    new-instance v1, Landroidx/glance/oneui/template/layout/glance/ListLayoutKt$GlanceListLayout$3;
    ...
    invoke-direct/range {v1 .. v10}, Landroidx/glance/oneui/template/layout/glance/ListLayoutKt$GlanceListLayout$3;-><init>(Landroidx/glance/oneui/template/ListData;ZZFFZZII)V

    invoke-interface {v15, v1}, Landroidx/compose/runtime/ScopeUpdateScope;->updateScope(LF4/n;)V
...
.method public static final GlanceListText-e4lg5Cc(Landroidx/glance/oneui/template/TextData;ILandroidx/glance/unit/ColorProvider;Landroidx/glance/GlanceModifier;ILandroidx/compose/runtime/Composer;II)V
    ...
    const-string v2, "androidx.glance.oneui.template.layout.glance.GlanceListText (ListLayout.kt:581)"
    ...
    new-instance v0, Landroidx/glance/oneui/template/layout/glance/ListLayoutKt$GlanceListText$1;
