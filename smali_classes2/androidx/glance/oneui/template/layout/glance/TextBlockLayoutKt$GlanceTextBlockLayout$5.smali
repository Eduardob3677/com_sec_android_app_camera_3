...
.method public constructor <init>(Landroidx/glance/oneui/template/TextBlockItem;Landroidx/glance/oneui/template/TextBlockItem;Landroidx/glance/unit/ColorProvider;LF4/n;LF4/n;)V
    ...
    iput-object p4, p0, Landroidx/glance/oneui/template/layout/glance/TextBlockLayoutKt$GlanceTextBlockLayout$5;->$mainContent:LF4/n;

    iput-object p5, p0, Landroidx/glance/oneui/template/layout/glance/TextBlockLayoutKt$GlanceTextBlockLayout$5;->$subContent:LF4/n;
...
.method public final invoke(Landroidx/glance/layout/RowScope;Landroidx/compose/runtime/Composer;I)V
    ...
    const-string v1, "androidx.glance.oneui.template.layout.glance.GlanceTextBlockLayout.<anonymous> (TextBlockLayout.kt:127)"
    ...
    iget-object v1, p0, Landroidx/glance/oneui/template/layout/glance/TextBlockLayoutKt$GlanceTextBlockLayout$5;->$mainItem:Landroidx/glance/oneui/template/TextBlockItem;

    iget-object v2, p0, Landroidx/glance/oneui/template/layout/glance/TextBlockLayoutKt$GlanceTextBlockLayout$5;->$mainContent:LF4/n;

    invoke-direct {v0, v1, v2}, Landroidx/glance/oneui/template/layout/glance/TextBlockLayoutKt$GlanceTextBlockLayout$5$1;-><init>(Landroidx/glance/oneui/template/TextBlockItem;LF4/n;)V
    ...
    iget-object p2, p0, Landroidx/glance/oneui/template/layout/glance/TextBlockLayoutKt$GlanceTextBlockLayout$5;->$mainItem:Landroidx/glance/oneui/template/TextBlockItem;

    invoke-virtual {p2}, Landroidx/glance/oneui/template/TextBlockItem;->getApplyInverseColor()Z

    move-result p2

    iget-object v0, p0, Landroidx/glance/oneui/template/layout/glance/TextBlockLayoutKt$GlanceTextBlockLayout$5;->$subItem:Landroidx/glance/oneui/template/TextBlockItem;
    ...
    :cond_1
    iget-object p2, p0, Landroidx/glance/oneui/template/layout/glance/TextBlockLayoutKt$GlanceTextBlockLayout$5;->$dividerColor:Landroidx/glance/unit/ColorProvider;

    const/16 v0, 0x46

    const/4 v1, 0x0

    invoke-static {v2, p2, v9, v0, v1}, Landroidx/glance/oneui/template/layout/glance/TextBlockLayoutKt;->GlanceDivider(ZLandroidx/glance/unit/ColorProvider;Landroidx/compose/runtime/Composer;II)V
    ...
    iget-object p2, p0, Landroidx/glance/oneui/template/layout/glance/TextBlockLayoutKt$GlanceTextBlockLayout$5;->$subItem:Landroidx/glance/oneui/template/TextBlockItem;

    iget-object p0, p0, Landroidx/glance/oneui/template/layout/glance/TextBlockLayoutKt$GlanceTextBlockLayout$5;->$subContent:LF4/n;

    invoke-direct {p1, p2, p0}, Landroidx/glance/oneui/template/layout/glance/TextBlockLayoutKt$GlanceTextBlockLayout$5$2;-><init>(Landroidx/glance/oneui/template/TextBlockItem;LF4/n;)V
