...
# direct methods
.method public constructor <init>(Lr4/h;Landroidx/glance/oneui/template/ImageType;FLandroidx/glance/oneui/template/ImageButtonData;)V
    .locals 0
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    iput-object p1, p0, Landroidx/glance/oneui/template/layout/glance/combine/CombineLayoutKt$PrimaryButtonContent$SingleButtonIcon$1$2;->$buttonSizePercent:Lr4/h;
...
.method public final invoke(Landroidx/compose/runtime/Composer;I)V
    ...
    const-string v1, "androidx.glance.oneui.template.layout.glance.combine.PrimaryButtonContent.SingleButtonIcon.<anonymous>.<anonymous> (CombineLayout.kt:259)"
    ...
    iget-object p2, p0, Landroidx/glance/oneui/template/layout/glance/combine/CombineLayoutKt$PrimaryButtonContent$SingleButtonIcon$1$2;->$buttonSizePercent:Lr4/h;

    iget-object p2, p2, Lr4/h;->a:Ljava/lang/Object;
    ...
    iget-object v0, p0, Landroidx/glance/oneui/template/layout/glance/combine/CombineLayoutKt$PrimaryButtonContent$SingleButtonIcon$1$2;->$buttonSizePercent:Lr4/h;
    ...
    invoke-static {p1, p2}, Landroidx/glance/oneui/template/utils/GlanceModifierUtilsKt;->contentDescription(Landroidx/glance/GlanceModifier;Ljava/lang/String;)Landroidx/glance/GlanceModifier;

    move-result-object p1

    iget-object p2, p0, Landroidx/glance/oneui/template/layout/glance/combine/CombineLayoutKt$PrimaryButtonContent$SingleButtonIcon$1$2;->$imageData:Landroidx/glance/oneui/template/ImageButtonData;

    invoke-virtual {p2}, Landroidx/glance/oneui/template/ImageData;->getAnimation()Landroidx/glance/appwidget/animation/RemoteAnimation;

    move-result-object p2

    invoke-static {p1, p2}, Landroidx/glance/oneui/template/utils/GlanceModifierUtilsKt;->maybeAnimation(Landroidx/glance/GlanceModifier;Landroidx/glance/appwidget/animation/RemoteAnimation;)Landroidx/glance/GlanceModifier;
    ...
    invoke-static {p1, p2}, Landroidx/glance/appwidget/AppWidgetModifiersKt;->keepColor(Landroidx/glance/GlanceModifier;Z)Landroidx/glance/GlanceModifier;

    move-result-object v2

    iget-object p1, p0, Landroidx/glance/oneui/template/layout/glance/combine/CombineLayoutKt$PrimaryButtonContent$SingleButtonIcon$1$2;->$imageData:Landroidx/glance/oneui/template/ImageButtonData;
