.class public final Landroidx/glance/oneui/template/layout/internal/VerticalLayoutKt;
...
# direct methods
.method private static final VerticalLayout-K4GKKTE(Landroidx/glance/GlanceModifier;IILF4/o;Landroidx/compose/runtime/Composer;II)V
    .locals 8
    ...
    const-string v3, "androidx.glance.oneui.template.layout.internal.VerticalLayout (VerticalLayout.kt:59)"

    invoke-static {v0, v2, v1, v3}, Landroidx/compose/runtime/ComposerKt;->traceEventStart(IIILjava/lang/String;)V

    :cond_13
    sget-object v0, Landroidx/glance/oneui/template/layout/internal/VerticalLayoutKt$VerticalLayout$1;->INSTANCE:Landroidx/glance/oneui/template/layout/internal/VerticalLayoutKt$VerticalLayout$1;
    ...
    sget-object v1, Landroidx/glance/oneui/template/layout/internal/VerticalLayoutKt$VerticalLayout$2$1;->INSTANCE:Landroidx/glance/oneui/template/layout/internal/VerticalLayoutKt$VerticalLayout$2$1;
    ...
    sget-object v3, Landroidx/glance/oneui/template/layout/internal/VerticalLayoutKt$VerticalLayout$2$2;->INSTANCE:Landroidx/glance/oneui/template/layout/internal/VerticalLayoutKt$VerticalLayout$2$2;
    ...
    sget-object v3, Landroidx/glance/oneui/template/layout/internal/VerticalLayoutKt$VerticalLayout$2$3;->INSTANCE:Landroidx/glance/oneui/template/layout/internal/VerticalLayoutKt$VerticalLayout$2$3;

    invoke-static {v0, v1, v3}, Landroidx/compose/runtime/Updater;->set-impl(Landroidx/compose/runtime/Composer;Ljava/lang/Object;LF4/n;)V

    sget-object v0, Landroidx/glance/oneui/template/layout/internal/VerticalScopeImplInstance;->INSTANCE:Landroidx/glance/oneui/template/layout/internal/VerticalScopeImplInstance;
    ...
    new-instance v1, Landroidx/glance/oneui/template/layout/internal/VerticalLayoutKt$VerticalLayout$4;
    ...
    invoke-direct/range {v1 .. v7}, Landroidx/glance/oneui/template/layout/internal/VerticalLayoutKt$VerticalLayout$4;-><init>(Landroidx/glance/GlanceModifier;IILF4/o;II)V
...
.method public static final VerticalRatioLayout(Landroidx/glance/oneui/template/component/padding/Padding;Landroidx/glance/unit/ColorProvider;Ljava/util/List;Landroidx/compose/runtime/Composer;II)V
    .locals 11
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    const-string p1, "androidx.glance.oneui.template.layout.internal.VerticalRatioLayout (VerticalLayout.kt:86)"
    ...
    new-instance p1, Landroidx/glance/oneui/template/layout/internal/VerticalLayoutKt$VerticalRatioLayout$1;

    invoke-direct {p1, v7, v1, p2}, Landroidx/glance/oneui/template/layout/internal/VerticalLayoutKt$VerticalRatioLayout$1;-><init>(Landroidx/glance/unit/ColorProvider;Landroidx/glance/oneui/template/component/padding/Padding;Ljava/util/List;)V

    const p3, 0x19615d74    # 1.16511E-23f
    ...
    new-instance v5, Landroidx/glance/oneui/template/layout/internal/VerticalLayoutKt$VerticalRatioLayout$2;
    ...
    invoke-direct/range {v5 .. v10}, Landroidx/glance/oneui/template/layout/internal/VerticalLayoutKt$VerticalRatioLayout$2;-><init>(Landroidx/glance/oneui/template/component/padding/Padding;Landroidx/glance/unit/ColorProvider;Ljava/util/List;II)V
...
.method public static final synthetic access$VerticalLayout-K4GKKTE(Landroidx/glance/GlanceModifier;IILF4/o;Landroidx/compose/runtime/Composer;II)V
    .locals 0

    invoke-static/range {p0 .. p6}, Landroidx/glance/oneui/template/layout/internal/VerticalLayoutKt;->VerticalLayout-K4GKKTE(Landroidx/glance/GlanceModifier;IILF4/o;Landroidx/compose/runtime/Composer;II)V
