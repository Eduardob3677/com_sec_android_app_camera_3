...
.annotation runtime Lkotlin/Metadata;
    ...
    d2 = {
        ...
        "(Landroid/content/Context;Ljava/lang/Class;Landroidx/glance/oneui/template/preview/CachedPreviewAttributes;Lv4/c;)Ljava/lang/Object;",
        "updatePreview",
        "glanceId",
        "Lkotlin/Function2;",
...
.method public static synthetic updateStateAndWidget$default(Landroidx/glance/oneui/template/GlanceTemplateAppWidget;Landroid/content/Context;Landroidx/glance/GlanceId;LF4/n;Lv4/c;ILjava/lang/Object;)Ljava/lang/Object;
    .locals 0
    ...
    invoke-direct {p3, p5}, Landroidx/glance/oneui/template/GlanceTemplateAppWidget$updateStateAndWidget$2;-><init>(Lv4/c;)V

    :cond_0
    invoke-virtual {p0, p1, p2, p3, p4}, Landroidx/glance/oneui/template/GlanceTemplateAppWidget;->updateStateAndWidget(Landroid/content/Context;Landroidx/glance/GlanceId;LF4/n;Lv4/c;)Ljava/lang/Object;
...
.method public final provideGlance(Landroid/content/Context;Landroidx/glance/GlanceId;Lv4/c;)Ljava/lang/Object;
    .locals 3
    ...
    invoke-direct {p2, p0, p3}, Landroidx/glance/oneui/template/GlanceTemplateAppWidget$provideGlance$1;-><init>(Landroidx/glance/oneui/template/GlanceTemplateAppWidget;Lv4/c;)V
    ...
    invoke-static {p0, p1, p2}, Landroidx/glance/appwidget/GlanceAppWidgetKt;->provideContent(Landroidx/glance/appwidget/GlanceAppWidget;LF4/n;Lv4/c;)Ljava/lang/Object;
...
.method public final providePreview$glance_oneui_template_release(Landroid/content/Context;Lv4/c;)Ljava/lang/Object;
    .locals 4
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-direct {v0, p0, p2}, Landroidx/glance/oneui/template/GlanceTemplateAppWidget$providePreview$1;-><init>(Landroidx/glance/oneui/template/GlanceTemplateAppWidget;Lv4/c;)V
    ...
    invoke-static {p0, p1, v0}, Landroidx/glance/oneui/template/preview/PreviewContentReceiverKt;->providePreviewContent(Landroidx/glance/oneui/template/GlanceTemplateAppWidget;LF4/n;Lv4/c;)Ljava/lang/Object;
...
.method public final updatePreview$glance_oneui_template_release(Landroid/content/Context;Ljava/lang/Class;Landroidx/glance/oneui/template/preview/CachedPreviewAttributes;Lv4/c;)Ljava/lang/Object;
    .locals 7
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    new-instance v1, Landroidx/glance/oneui/template/GlanceTemplateAppWidget$updatePreview$2;
    ...
    invoke-direct/range {v1 .. v6}, Landroidx/glance/oneui/template/GlanceTemplateAppWidget$updatePreview$2;-><init>(Landroid/content/Context;Landroidx/glance/oneui/template/GlanceTemplateAppWidget;Ljava/lang/Class;Landroidx/glance/oneui/template/preview/CachedPreviewAttributes;Lv4/c;)V

    invoke-virtual {v0, v1, p4}, Landroidx/glance/oneui/template/preview/PreviewSessionManager;->runWithLock(LF4/n;Lv4/c;)Ljava/lang/Object;
...
.method public final updateStateAndWidget(Landroid/content/Context;Landroidx/glance/GlanceId;LF4/n;Lv4/c;)Ljava/lang/Object;
    .locals 5
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-direct {v0, p0, p4}, Landroidx/glance/oneui/template/GlanceTemplateAppWidget$updateStateAndWidget$1;-><init>(Landroidx/glance/oneui/template/GlanceTemplateAppWidget;Lv4/c;)V
    ...
    invoke-static {p1, p2, p3, v0}, Landroidx/glance/appwidget/state/GlanceAppWidgetStateKt;->updateAppWidgetState(Landroid/content/Context;Landroidx/glance/GlanceId;LF4/n;Lv4/c;)Ljava/lang/Object;
    ...
    invoke-virtual {p0, p1, p2, v0}, Landroidx/glance/appwidget/GlanceAppWidget;->update(Landroid/content/Context;Landroidx/glance/GlanceId;Lv4/c;)Ljava/lang/Object;
