...
.method public static final setChildren(Landroid/widget/RemoteViews;Landroidx/glance/appwidget/TranslationContext;Landroidx/glance/appwidget/InsertedViewInfo;Ljava/util/List;)V
    ...
    invoke-static {v0, p3}, Ls4/t;->P0(ILjava/util/List;)Ljava/util/List;
...
.method public static final toSizeString-EaSLcWc(J)Ljava/lang/String;
    ...
    invoke-static {v0, p1, p0}, Landroidx/compose/material/a;->o(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;
...
.method public static final translateChild(Landroid/widget/RemoteViews;Landroidx/glance/appwidget/TranslationContext;Landroidx/glance/Emittable;)V
    ...
    invoke-static {p2, p1}, Landroidx/compose/material/a;->D(Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;
...
.method public static final translateComposition(Landroidx/glance/appwidget/TranslationContext;Ljava/util/List;I)Landroid/widget/RemoteViews;
    ...
    invoke-direct {v4, v3, v7}, Lr4/h;-><init>(Ljava/lang/Object;Ljava/lang/Object;)V
...
.method public static final translateComposition-_rDzMTw(Landroid/content/Context;ILandroidx/glance/appwidget/RemoteViewsRoot;Landroidx/glance/appwidget/LayoutConfiguration;IJLandroid/content/ComponentName;Z)Landroid/widget/RemoteViews;
    ...
    invoke-static {v2}, Landroidx/glance/appwidget/RemoteViewsTranslatorKt;->isRtl(Landroid/content/Context;)Z
    ...
    invoke-direct/range {v1 .. v21}, Landroidx/glance/appwidget/TranslationContext;-><init>(Landroid/content/Context;IZLandroidx/glance/appwidget/LayoutConfiguration;IZLjava/util/concurrent/atomic/AtomicInteger;Landroidx/glance/appwidget/InsertedViewInfo;Ljava/util/concurrent/atomic/AtomicBoolean;JIIZLjava/lang/Integer;Landroid/content/ComponentName;ZZILkotlin/jvm/internal/h;)V
    ...
    invoke-static {v1, v0, v2}, Landroidx/glance/appwidget/RemoteViewsTranslatorKt;->translateComposition(Landroidx/glance/appwidget/TranslationContext;Ljava/util/List;I)Landroid/widget/RemoteViews;
...
.method private static final translateEmittableAndroidRemoteViews(Landroid/widget/RemoteViews;Landroidx/glance/appwidget/TranslationContext;Landroidx/glance/appwidget/EmittableAndroidRemoteViews;)V
    ...
    invoke-virtual {v5, p0}, Landroid/widget/RemoteViews;->removeAllViews(I)V

    invoke-virtual {v7}, Landroidx/glance/appwidget/InsertedViewInfo;->getMainViewId()I

    move-result p0

    invoke-static {v5, p0, v0, v1}, Landroidx/glance/appwidget/RemoteViewsTranslatorKt;->addChildView(Landroid/widget/RemoteViews;ILandroid/widget/RemoteViews;I)V
...
.method private static final translateEmittableBox(Landroid/widget/RemoteViews;Landroidx/glance/appwidget/TranslationContext;Landroidx/glance/layout/EmittableBox;)V
    ...
    new-instance v5, Landroidx/glance/appwidget/AlignmentModifier;

    invoke-virtual/range {p2 .. p2}, Landroidx/glance/layout/EmittableBox;->getContentAlignment()Landroidx/glance/layout/Alignment;

    move-result-object v6

    invoke-direct {v5, v6}, Landroidx/glance/appwidget/AlignmentModifier;-><init>(Landroidx/glance/layout/Alignment;)V

    invoke-interface {v4, v5}, Landroidx/glance/GlanceModifier;->then(Landroidx/glance/GlanceModifier;)Landroidx/glance/GlanceModifier;

    move-result-object v4

    invoke-interface {v3, v4}, Landroidx/glance/Emittable;->setModifier(Landroidx/glance/GlanceModifier;)V
    ...
    invoke-static {p0, p1, v10, v2}, Landroidx/glance/appwidget/RemoteViewsTranslatorKt;->setChildren(Landroid/widget/RemoteViews;Landroidx/glance/appwidget/TranslationContext;Landroidx/glance/appwidget/InsertedViewInfo;Ljava/util/List;)V
...
.method private static final translateEmittableButton(Landroid/widget/RemoteViews;Landroidx/glance/appwidget/TranslationContext;Landroidx/glance/EmittableButton;)V
    ...
    invoke-virtual {v0}, Landroidx/glance/EmittableButton;->getModifier()Landroidx/glance/GlanceModifier;

    move-result-object v2

    invoke-static {p0, p1, v1, v2}, Landroidx/glance/appwidget/LayoutSelectionKt;->insertView(Landroid/widget/RemoteViews;Landroidx/glance/appwidget/TranslationContext;Landroidx/glance/appwidget/LayoutType;Landroidx/glance/GlanceModifier;)Landroidx/glance/appwidget/InsertedViewInfo;
    ...
    invoke-virtual {v0}, Landroidx/glance/EmittableWithText;->getText()Ljava/lang/String;

    move-result-object v6

    invoke-virtual {v0}, Landroidx/glance/EmittableWithText;->getStyle()Landroidx/glance/text/TextStyle;

    move-result-object v7

    invoke-virtual {v0}, Landroidx/glance/EmittableWithText;->getMaxLines()I
    ...
    invoke-virtual {v0}, Landroidx/glance/EmittableButton;->getEnabled()Z
    ...
    invoke-interface {v2, v4, v5}, Landroidx/glance/GlanceModifier;->foldIn(Ljava/lang/Object;LF4/n;)Ljava/lang/Object;
...
.method private static final translateEmittableColumn(Landroid/widget/RemoteViews;Landroidx/glance/appwidget/TranslationContext;Landroidx/glance/layout/EmittableColumn;)V
    ...
    invoke-virtual {v3}, Landroidx/glance/appwidget/InsertedViewInfo;->getMainViewId()I
    ...
    invoke-direct {v2, v4, v5, v6}, Landroidx/glance/layout/Alignment;-><init>(IILkotlin/jvm/internal/h;)V

    invoke-static {v2}, Landroidx/glance/appwidget/RemoteViewsTranslatorKt;->toGravity(Landroidx/glance/layout/Alignment;)I

    move-result v2

    invoke-static {p0, v1, v2}, Landroidx/core/widget/RemoteViewsCompat;->setLinearLayoutGravity(Landroid/widget/RemoteViews;II)V
    ...
    invoke-static {p0, p1, v3, v1}, Landroidx/glance/appwidget/RemoteViewsTranslatorKt;->setChildren(Landroid/widget/RemoteViews;Landroidx/glance/appwidget/TranslationContext;Landroidx/glance/appwidget/InsertedViewInfo;Ljava/util/List;)V
...
.method public static final translateEmittableSizeBox(Landroid/widget/RemoteViews;Landroidx/glance/appwidget/TranslationContext;Landroidx/glance/appwidget/EmittableSizeBox;)V
    ...
    invoke-static {p2}, Ls4/t;->q0(Ljava/util/List;)Ljava/lang/Object;
    ...
    invoke-static {p0, p1, p2}, Landroidx/collection/a;->q(ILjava/lang/String;Ljava/lang/String;)Ljava/lang/String;
