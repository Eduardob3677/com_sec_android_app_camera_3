...
.annotation runtime Lkotlin/Metadata;
    ...
    d2 = {
        ...
        "Lr4/o;",
        "emit",
        "(Landroidx/compose/runtime/Recomposer$State;Lv4/c;)Ljava/lang/Object;",
        "<anonymous>"
    }
    k = 0x3
    mv = {
...
# direct methods
.method public constructor <init>(Landroidx/compose/runtime/Recomposer;Lkotlin/jvm/internal/D;Lc6/T;Landroidx/glance/appwidget/AppWidgetSession;Landroid/content/Context;Landroidx/glance/appwidget/RemoteViewsRoot;LZ5/C;)V
    .locals 0
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    iput-object p3, p0, Landroidx/glance/appwidget/util/OneTimeUpdateKt$updateForOneTime$2$1$2$1;->$uiReady:Lc6/T;
    ...
    iput-object p7, p0, Landroidx/glance/appwidget/util/OneTimeUpdateKt$updateForOneTime$2$1$2$1;->$$this$launch:LZ5/C;
...
# virtual methods
.method public final emit(Landroidx/compose/runtime/Recomposer$State;Lv4/c;)Ljava/lang/Object;
    .locals 8
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-direct {v0, p0, p2}, Landroidx/glance/appwidget/util/OneTimeUpdateKt$updateForOneTime$2$1$2$1$emit$1;-><init>(Landroidx/glance/appwidget/util/OneTimeUpdateKt$updateForOneTime$2$1$2$1;Lv4/c;)V
    ...
    :cond_4
    iget-object p0, p0, Landroidx/glance/appwidget/util/OneTimeUpdateKt$updateForOneTime$2$1$2$1;->$$this$launch:LZ5/C;
    ...
    iget-object p1, p0, Landroidx/glance/appwidget/util/OneTimeUpdateKt$updateForOneTime$2$1$2$1;->$uiReady:Lc6/T;
    ...
    invoke-virtual {p1, p2, v2, v0}, Landroidx/glance/appwidget/AppWidgetSession;->processEmittableTree(Landroid/content/Context;Landroidx/glance/EmittableWithChildren;Lv4/c;)Ljava/lang/Object;
    ...
    iget-object p2, p0, Landroidx/glance/appwidget/util/OneTimeUpdateKt$updateForOneTime$2$1$2$1;->$uiReady:Lc6/T;

    check-cast p2, Lc6/j0;

    invoke-virtual {p2}, Lc6/j0;->getValue()Ljava/lang/Object;
    ...
    invoke-virtual {p1, p2, v0}, Lc6/j0;->emit(Ljava/lang/Object;Lv4/c;)Ljava/lang/Object;
...
.method public bridge synthetic emit(Ljava/lang/Object;Lv4/c;)Ljava/lang/Object;
    ...
    invoke-virtual {p0, p1, p2}, Landroidx/glance/appwidget/util/OneTimeUpdateKt$updateForOneTime$2$1$2$1;->emit(Landroidx/compose/runtime/Recomposer$State;Lv4/c;)Ljava/lang/Object;
