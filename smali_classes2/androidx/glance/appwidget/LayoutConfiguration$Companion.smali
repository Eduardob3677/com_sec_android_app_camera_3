...
.method public final create$glance_appwidget_release(Landroid/content/Context;IILjava/util/Collection;)Landroidx/glance/appwidget/LayoutConfiguration;
    ...
    invoke-static {p4}, Ls4/t;->W0(Ljava/lang/Iterable;)Ljava/util/Set;
...
.method public final load$glance_appwidget_release(Landroid/content/Context;ILv4/c;)Ljava/lang/Object;
    .locals 9
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-direct {v0, p0, p3}, Landroidx/glance/appwidget/LayoutConfiguration$Companion$load$1;-><init>(Landroidx/glance/appwidget/LayoutConfiguration$Companion;Lv4/c;)V
    ...
    invoke-virtual {p0, p1, v1, v4, v0}, Landroidx/glance/state/GlanceState;->getValue(Landroid/content/Context;Landroidx/glance/state/GlanceStateDefinition;Ljava/lang/String;Lv4/c;)Ljava/lang/Object;
    ...
    :cond_5
    invoke-static {p3}, Ls4/I;->J(Ljava/util/Map;)Ljava/util/LinkedHashMap;
