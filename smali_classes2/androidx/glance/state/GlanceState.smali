...
.annotation runtime Lkotlin/Metadata;
    ...
    d2 = {
        ...
        "getDataStore",
        "(Landroid/content/Context;Landroidx/glance/state/GlanceStateDefinition;Ljava/lang/String;Lv4/c;)Ljava/lang/Object;",
        "getValue",
        "Lkotlin/Function2;",
        "Lv4/c;",
        "",
        "updateBlock",
        "updateValue",
        "(Landroid/content/Context;Landroidx/glance/state/GlanceStateDefinition;Ljava/lang/String;LF4/n;Lv4/c;)Ljava/lang/Object;",
        "Lr4/o;",
        "deleteStore",
        "Lj6/a;",
        "mutex",
...
.method static constructor <clinit>()V
    ...
    sput-object v0, Landroidx/glance/state/GlanceState;->mutex:Lj6/a;
...
.method public static final synthetic access$getDataStore(Landroidx/glance/state/GlanceState;Landroid/content/Context;Landroidx/glance/state/GlanceStateDefinition;Ljava/lang/String;Lv4/c;)Ljava/lang/Object;
    .locals 0

    invoke-direct {p0, p1, p2, p3, p4}, Landroidx/glance/state/GlanceState;->getDataStore(Landroid/content/Context;Landroidx/glance/state/GlanceStateDefinition;Ljava/lang/String;Lv4/c;)Ljava/lang/Object;
...
.method private final getDataStore(Landroid/content/Context;Landroidx/glance/state/GlanceStateDefinition;Ljava/lang/String;Lv4/c;)Ljava/lang/Object;
    .locals 11
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "<T:",
    ...
    invoke-direct {v1, p0, p4}, Landroidx/glance/state/GlanceState$getDataStore$1;-><init>(Landroidx/glance/state/GlanceState;Lv4/c;)V
    ...
    sget-object p0, Landroidx/glance/state/GlanceState;->mutex:Lj6/a;
    ...
    invoke-interface {p0, v6, v1}, Lj6/a;->lock(Ljava/lang/Object;Lv4/c;)Ljava/lang/Object;
    ...
    invoke-virtual {p2, p1, p3, v1}, Landroidx/glance/state/PreferencesGlanceStateDefinition;->getOrPutDataStore$glance_release(Landroid/content/Context;Ljava/lang/String;Lv4/c;)Ljava/lang/Object;
    ...
    invoke-interface {p2, p1, p3, v1}, Landroidx/glance/state/GlanceStateDefinition;->getDataStore(Landroid/content/Context;Ljava/lang/String;Lv4/c;)Ljava/lang/Object;
...
# virtual methods
.method public deleteStore(Landroid/content/Context;Landroidx/glance/state/GlanceStateDefinition;Ljava/lang/String;Lv4/c;)Ljava/lang/Object;
    .locals 8
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-direct {v0, p0, p4}, Landroidx/glance/state/GlanceState$deleteStore$1;-><init>(Landroidx/glance/state/GlanceState;Lv4/c;)V
    ...
    invoke-interface {p0, v5, v0}, Lj6/a;->lock(Ljava/lang/Object;Lv4/c;)Ljava/lang/Object;
    ...
    invoke-direct {v1, v4, v0}, LZ5/m;-><init>(ILv4/c;)V
    ...
    invoke-direct {v3, v1}, Landroidx/glance/state/GlanceState$deleteStore$2$1$1;-><init>(LZ5/k;)V

    invoke-virtual {v1, v3}, LZ5/m;->n(LF4/k;)V
    ...
    :cond_5
    :goto_2
    invoke-virtual {v1, v2}, LZ5/m;->resumeWith(Ljava/lang/Object;)V
    ...
    :goto_4
    invoke-interface {p1, v5}, Lj6/a;->unlock(Ljava/lang/Object;)V
...
.method public getValue(Landroid/content/Context;Landroidx/glance/state/GlanceStateDefinition;Ljava/lang/String;Lv4/c;)Ljava/lang/Object;
    .locals 5
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "<T:",
    ...
    invoke-direct {v0, p0, p4}, Landroidx/glance/state/GlanceState$getValue$1;-><init>(Landroidx/glance/state/GlanceState;Lv4/c;)V
    ...
    invoke-direct {p0, p1, p2, p3, v0}, Landroidx/glance/state/GlanceState;->getDataStore(Landroid/content/Context;Landroidx/glance/state/GlanceStateDefinition;Ljava/lang/String;Lv4/c;)Ljava/lang/Object;
    ...
    invoke-interface {p4}, Landroidx/datastore/core/DataStore;->getData()Lc6/j;
...
.method public updateValue(Landroid/content/Context;Landroidx/glance/state/GlanceStateDefinition;Ljava/lang/String;LF4/n;Lv4/c;)Ljava/lang/Object;
    .locals 7
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "<T:",
    ...
    invoke-direct {v1, p0, p5}, Landroidx/glance/state/GlanceState$updateValue$1;-><init>(Landroidx/glance/state/GlanceState;Lv4/c;)V
    ...
    invoke-direct {p0, p1, p2, p3, v1}, Landroidx/glance/state/GlanceState;->getDataStore(Landroid/content/Context;Landroidx/glance/state/GlanceStateDefinition;Ljava/lang/String;Lv4/c;)Ljava/lang/Object;
    ...
    invoke-interface {p5, p4, v1}, Landroidx/datastore/core/DataStore;->updateData(LF4/n;Lv4/c;)Ljava/lang/Object;
