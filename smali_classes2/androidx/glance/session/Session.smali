...
.field private final eventChannel:Lb6/i;
...
.method public constructor <init>(Ljava/lang/String;)V
    ...
    invoke-static {v1, v0, p1}, Ll6/k;->a(IILb6/a;)Lb6/e;

    move-result-object p1

    iput-object p1, p0, Landroidx/glance/session/Session;->eventChannel:Lb6/i;

    return-void
.end method

.method public static synthetic onCompositionError$suspendImpl(Landroidx/glance/session/Session;Landroid/content/Context;Ljava/lang/Throwable;Lv4/c;)Ljava/lang/Object;
    .locals 0
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
...
.method public final close()V
    ...
    iget-object v0, p0, Landroidx/glance/session/Session;->eventChannel:Lb6/i;

    const/4 v1, 0x0

    invoke-interface {v0, v1}, Lb6/v;->r(Ljava/lang/Throwable;)Z
...
.method public onCompositionError(Landroid/content/Context;Ljava/lang/Throwable;Lv4/c;)Ljava/lang/Object;
    ...
    invoke-static {p0, p1, p2, p3}, Landroidx/glance/session/Session;->onCompositionError$suspendImpl(Landroidx/glance/session/Session;Landroid/content/Context;Ljava/lang/Throwable;Lv4/c;)Ljava/lang/Object;
...
.method public abstract processEmittableTree(Landroid/content/Context;Landroidx/glance/EmittableWithChildren;Lv4/c;)Ljava/lang/Object;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
            "Landroid/content/Context;",
...
.method public abstract processEvent(Landroid/content/Context;Ljava/lang/Object;Lv4/c;)Ljava/lang/Object;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
            "Landroid/content/Context;",
...
.method public abstract provideGlance(Landroid/content/Context;)LF4/n;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
            "Landroid/content/Context;",
...
.method public final receiveEvents(Landroid/content/Context;LF4/k;Lv4/c;)Ljava/lang/Object;
    .locals 10
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-direct {v1, p0, p3}, Landroidx/glance/session/Session$receiveEvents$1;-><init>(Landroidx/glance/session/Session;Lv4/c;)V
    ...
    :try_end_0
    .catch Lb6/n; {:try_start_0 .. :try_end_0} :catch_0
    ...
    invoke-static {p3}, Lcom/bumptech/glide/c;->X(Ljava/lang/Object;)V
    :try_end_1
    .catch Lb6/n; {:try_start_1 .. :try_end_1} :catch_0
    ...
    iget-object v3, p0, Landroidx/glance/session/Session;->eventChannel:Lb6/i;
    ...
    iget-object p3, p0, Landroidx/glance/session/Session;->eventChannel:Lb6/i;

    invoke-interface {p3}, Lb6/u;->iterator()Lb6/b;
    ...
    invoke-virtual {p3, v1}, Lb6/b;->b(Lx4/c;)Ljava/lang/Object;

    move-result-object v0
    :try_end_2
    .catch Lb6/n; {:try_start_2 .. :try_end_2} :catch_1
    ...
    invoke-interface {p1, p3}, LF4/k;->invoke(Ljava/lang/Object;)Ljava/lang/Object;
    ...
    invoke-virtual {v0, p2, p3, v1}, Landroidx/glance/session/Session;->processEvent(Landroid/content/Context;Ljava/lang/Object;Lv4/c;)Ljava/lang/Object;

    move-result-object p3
    :try_end_3
    .catch Lb6/n; {:try_start_3 .. :try_end_3} :catch_0
...
.method public final sendEvent(Ljava/lang/Object;Lv4/c;)Ljava/lang/Object;
    .locals 8
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-direct {v1, p0, p2}, Landroidx/glance/session/Session$sendEvent$1;-><init>(Landroidx/glance/session/Session;Lv4/c;)V
    ...
    :try_end_0
    .catch Lb6/o; {:try_start_0 .. :try_end_0} :catch_0
    ...
    invoke-interface {v3}, Lb6/v;->isClosedForSend()Z

    move-result v3

    iget-object v6, p0, Landroidx/glance/session/Session;->eventChannel:Lb6/i;

    invoke-interface {v6}, Lb6/u;->isClosedForReceive()Z
    ...
    iget-object p2, p0, Landroidx/glance/session/Session;->eventChannel:Lb6/i;
    ...
    invoke-interface {p2, p1, v1}, Lb6/v;->p(Ljava/lang/Object;Lv4/c;)Ljava/lang/Object;

    move-result-object p0
    :try_end_1
    .catch Lb6/o; {:try_start_1 .. :try_end_1} :catch_0
