...
.field private interactiveCoroutine:LZ5/k;
...
.field private final nanoTime:LF4/a;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "LF4/a;"
        }
...
.method public constructor <init>(LZ5/C;IIJLF4/a;)V
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    iput-object p1, p0, Landroidx/glance/session/InteractiveFrameClock;->scope:LZ5/C;
    ...
    iput-object p6, p0, Landroidx/glance/session/InteractiveFrameClock;->nanoTime:LF4/a;
    ...
    invoke-direct {p1, p3}, Landroidx/compose/runtime/BroadcastFrameClock;-><init>(LF4/a;)V
...
.method public synthetic constructor <init>(LZ5/C;IIJLF4/a;ILkotlin/jvm/internal/h;)V
    .locals 7
    ...
    invoke-direct/range {v0 .. v6}, Landroidx/glance/session/InteractiveFrameClock;-><init>(LZ5/C;IIJLF4/a;)V
...
.method public static final synthetic access$getNanoTime$p(Landroidx/glance/session/InteractiveFrameClock;)LF4/a;
    .locals 0

    iget-object p0, p0, Landroidx/glance/session/InteractiveFrameClock;->nanoTime:LF4/a;
...
.method public static final synthetic access$setInteractiveCoroutine$p(Landroidx/glance/session/InteractiveFrameClock;LZ5/k;)V
    .locals 0

    iput-object p1, p0, Landroidx/glance/session/InteractiveFrameClock;->interactiveCoroutine:LZ5/k;
...
.method private final onNewAwaiters()V
    ...
    iget-object v0, p0, Landroidx/glance/session/InteractiveFrameClock;->nanoTime:LF4/a;
    ...
    iget-object v1, p0, Landroidx/glance/session/InteractiveFrameClock;->lock:Ljava/lang/Object;
    ...
    iget v0, p0, Landroidx/glance/session/InteractiveFrameClock;->currentHz:I
    ...
    iget-object v0, p0, Landroidx/glance/session/InteractiveFrameClock;->scope:LZ5/C;

    new-instance v1, Landroidx/glance/session/InteractiveFrameClock$onNewAwaiters$2;

    const/4 v7, 0x0

    move-object v4, p0

    invoke-direct/range {v1 .. v7}, Landroidx/glance/session/InteractiveFrameClock$onNewAwaiters$2;-><init>(Lkotlin/jvm/internal/D;Lkotlin/jvm/internal/D;Landroidx/glance/session/InteractiveFrameClock;JLv4/c;)V
...
.method public final startInteractive(Lv4/c;)Ljava/lang/Object;
    .locals 4
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-direct {v2, p0, v3}, Landroidx/glance/session/InteractiveFrameClock$startInteractive$2;-><init>(Landroidx/glance/session/InteractiveFrameClock;Lv4/c;)V

    invoke-static {v0, v1, v2, p1}, LZ5/F;->L(JLF4/n;Lv4/c;)Ljava/lang/Object;
...
.method public final stopInteractive()V
    ...
    :try_start_0
    iget-object p0, p0, Landroidx/glance/session/InteractiveFrameClock;->interactiveCoroutine:LZ5/k;
...
.method public withFrameNanos(LF4/k;Lv4/c;)Ljava/lang/Object;
    ...
    invoke-virtual {p0, p1, p2}, Landroidx/compose/runtime/BroadcastFrameClock;->withFrameNanos(LF4/k;Lv4/c;)Ljava/lang/Object;
