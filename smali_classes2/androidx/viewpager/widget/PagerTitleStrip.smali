...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;)V
    ...
    invoke-virtual {v5, p0, p0}, Landroid/content/res/TypedArray;->getResourceId(II)I

    move-result p1

    if-eqz p1, :cond_0

    iget-object p2, v1, Landroidx/viewpager/widget/PagerTitleStrip;->mPrevText:Landroid/widget/TextView;

    invoke-static {p2, p1}, Landroidx/core/widget/TextViewCompat;->setTextAppearance(Landroid/widget/TextView;I)V

    iget-object p2, v1, Landroidx/viewpager/widget/PagerTitleStrip;->mCurrText:Landroid/widget/TextView;

    invoke-static {p2, p1}, Landroidx/core/widget/TextViewCompat;->setTextAppearance(Landroid/widget/TextView;I)V

    iget-object p2, v1, Landroidx/viewpager/widget/PagerTitleStrip;->mNextText:Landroid/widget/TextView;
    ...
    invoke-virtual {v5, p2, p0}, Landroid/content/res/TypedArray;->getDimensionPixelSize(II)I
    ...
    invoke-virtual {v1, p0, p2}, Landroidx/viewpager/widget/PagerTitleStrip;->setTextSize(IF)V
    ...
    invoke-virtual {v5, p2, p0}, Landroid/content/res/TypedArray;->getColor(II)I
    ...
    invoke-virtual {v5, p2, v0}, Landroid/content/res/TypedArray;->getInteger(II)I

    move-result p2

    iput p2, v1, Landroidx/viewpager/widget/PagerTitleStrip;->mGravity:I
    ...
    iput p2, v1, Landroidx/viewpager/widget/PagerTitleStrip;->mTextColor:I

    const p2, 0x3f19999a    # 0.6f

    invoke-virtual {v1, p2}, Landroidx/viewpager/widget/PagerTitleStrip;->setNonPrimaryAlpha(F)V
    ...
    invoke-virtual {p1, p0, p0}, Landroid/content/res/TypedArray;->getBoolean(IZ)Z
    ...
    iget-object p0, v1, Landroidx/viewpager/widget/PagerTitleStrip;->mPrevText:Landroid/widget/TextView;

    invoke-static {p0}, Landroidx/viewpager/widget/PagerTitleStrip;->setSingleLineAllCaps(Landroid/widget/TextView;)V

    iget-object p0, v1, Landroidx/viewpager/widget/PagerTitleStrip;->mCurrText:Landroid/widget/TextView;

    invoke-static {p0}, Landroidx/viewpager/widget/PagerTitleStrip;->setSingleLineAllCaps(Landroid/widget/TextView;)V

    iget-object p0, v1, Landroidx/viewpager/widget/PagerTitleStrip;->mNextText:Landroid/widget/TextView;
    ...
    iput p0, v1, Landroidx/viewpager/widget/PagerTitleStrip;->mScaledTextSpacing:I
