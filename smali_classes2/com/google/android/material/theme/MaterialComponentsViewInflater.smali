...
.method public final createAutoCompleteTextView(Landroid/content/Context;Landroid/util/AttributeSet;)Landroidx/appcompat/widget/AppCompatAutoCompleteTextView;
    ...
    invoke-direct {p0, p1, p2}, Lh1/u;-><init>(Landroid/content/Context;Landroid/util/AttributeSet;)V
...
.method public final createCheckBox(Landroid/content/Context;Landroid/util/AttributeSet;)Landroidx/appcompat/widget/AppCompatCheckBox;
    ...
    invoke-direct {p0, p1, p2}, LG0/c;-><init>(Landroid/content/Context;Landroid/util/AttributeSet;)V
...
.method public final createRadioButton(Landroid/content/Context;Landroid/util/AttributeSet;)Landroidx/appcompat/widget/AppCompatRadioButton;
    ...
    invoke-static {v0, p2, p1}, LZ0/c;->a(Landroid/content/Context;Landroid/content/res/TypedArray;I)Landroid/content/res/ColorStateList;
...
.method public final createTextView(Landroid/content/Context;Landroid/util/AttributeSet;)Landroidx/appcompat/widget/AppCompatTextView;
    ...
    invoke-static {p1, p2, v0, v1}, Lj1/a;->a(Landroid/content/Context;Landroid/util/AttributeSet;II)Landroid/content/Context;
    ...
    invoke-static {p1, v2, v3}, LZ0/b;->b(Landroid/content/Context;IZ)Z
    ...
    invoke-static {p1, v5, v7}, Li1/a;->a(Landroid/content/Context;Landroid/content/res/TypedArray;[I)I
