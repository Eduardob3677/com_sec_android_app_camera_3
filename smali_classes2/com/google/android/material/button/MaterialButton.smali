...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;)V
    ...
    invoke-static {p1, p2, v3, v6}, Lj1/a;->a(Landroid/content/Context;Landroid/util/AttributeSet;II)Landroid/content/Context;
    ...
    sget-object v2, Lw0/a;->v:[I

    move-object v1, p2

    invoke-static/range {v0 .. v5}, LM0/s;->d(Landroid/content/Context;Landroid/util/AttributeSet;[III[I)Landroid/content/res/TypedArray;
    ...
    invoke-static {v2, v5}, LM0/x;->b(ILandroid/graphics/PorterDuff$Mode;)Landroid/graphics/PorterDuff$Mode;
    ...
    invoke-static {v2, p2, v7}, LZ0/c;->a(Landroid/content/Context;Landroid/content/res/TypedArray;I)Landroid/content/res/ColorStateList;
    ...
    invoke-static {v2, p2, v7}, LZ0/c;->c(Landroid/content/Context;Landroid/content/res/TypedArray;I)Landroid/graphics/drawable/Drawable;
    ...
    invoke-static {v0, v1, v3, v6}, Lc1/l;->b(Landroid/content/Context;Landroid/util/AttributeSet;II)Lc1/k;
    ...
    invoke-direct {v1, p0, v0}, LE0/c;-><init>(Lcom/google/android/material/button/MaterialButton;Lc1/l;)V

    iput-object v1, p0, Lcom/google/android/material/button/MaterialButton;->a:LE0/c;

    invoke-virtual {p2, v7, p1}, Landroid/content/res/TypedArray;->getDimensionPixelOffset(II)I

    move-result v0

    iput v0, v1, LE0/c;->c:I
    ...
    iput v0, v1, LE0/c;->g:I

    iget-object v2, v1, LE0/c;->b:Lc1/l;
    ...
    invoke-virtual {v1, v0}, LE0/c;->c(Lc1/l;)V

    iput-boolean v7, v1, LE0/c;->p:Z
    ...
    invoke-static {v0, v5}, LM0/x;->b(ILandroid/graphics/PorterDuff$Mode;)Landroid/graphics/PorterDuff$Mode;

    move-result-object v0

    iput-object v0, v1, LE0/c;->i:Landroid/graphics/PorterDuff$Mode;
    ...
    invoke-static {v0, p2, v2}, LZ0/c;->a(Landroid/content/Context;Landroid/content/res/TypedArray;I)Landroid/content/res/ColorStateList;

    move-result-object v0

    iput-object v0, v1, LE0/c;->j:Landroid/content/res/ColorStateList;
    ...
    iput-object v0, v1, LE0/c;->k:Landroid/content/res/ColorStateList;
    ...
    iput-object v0, v1, LE0/c;->l:Landroid/content/res/ColorStateList;
    ...
    iput-boolean v7, v1, LE0/c;->o:Z

    iget-object v5, v1, LE0/c;->j:Landroid/content/res/ColorStateList;
    ...
    iget-object v5, v1, LE0/c;->i:Landroid/graphics/PorterDuff$Mode;
    ...
    :goto_0
    iget v5, v1, LE0/c;->c:I

    add-int/2addr v0, v5

    iget v5, v1, LE0/c;->e:I

    add-int/2addr v2, v5

    iget v5, v1, LE0/c;->d:I

    add-int/2addr v3, v5

    iget v1, v1, LE0/c;->f:I
...
.method public final a()Z
    ...
    iget-object p0, p0, Lcom/google/android/material/button/MaterialButton;->a:LE0/c;

    if-eqz p0, :cond_0

    iget-boolean p0, p0, LE0/c;->o:Z
...
.method public final d(II)V
    ...
    iput v5, p0, Lcom/google/android/material/button/MaterialButton;->j:I
...
.method public getRippleColor()Landroid/content/res/ColorStateList;
    ...
    iget-object p0, p0, LE0/c;->l:Landroid/content/res/ColorStateList;
...
.method public getShapeAppearanceModel()Lc1/l;
    ...
    iget-object p0, p0, LE0/c;->b:Lc1/l;
...
.method public getStrokeColor()Landroid/content/res/ColorStateList;
    ...
    iget-object p0, p0, LE0/c;->k:Landroid/content/res/ColorStateList;
...
.method public getSupportBackgroundTintList()Landroid/content/res/ColorStateList;
    ...
    iget-object p0, p0, LE0/c;->j:Landroid/content/res/ColorStateList;
...
.method public getSupportBackgroundTintMode()Landroid/graphics/PorterDuff$Mode;
    ...
    iget-object p0, p0, LE0/c;->i:Landroid/graphics/PorterDuff$Mode;
...
.method public final onAttachedToWindow()V
    ...
    iget-object v0, p0, Lcom/google/android/material/button/MaterialButton;->a:LE0/c;

    const/4 v1, 0x0

    invoke-virtual {v0, v1}, LE0/c;->b(Z)Lc1/h;
...
.method public setBackgroundColor(I)V
    ...
    invoke-virtual {p0, v0}, LE0/c;->b(Z)Lc1/h;
    ...
    invoke-virtual {p0, p1}, Lc1/h;->setTint(I)V
...
.method public setBackgroundDrawable(Landroid/graphics/drawable/Drawable;)V
    ...
    iget-object v1, p0, Lcom/google/android/material/button/MaterialButton;->a:LE0/c;

    iput-boolean v0, v1, LE0/c;->o:Z

    iget-object v0, v1, LE0/c;->a:Lcom/google/android/material/button/MaterialButton;

    iget-object v2, v1, LE0/c;->j:Landroid/content/res/ColorStateList;
    ...
    iget-object v1, v1, LE0/c;->i:Landroid/graphics/PorterDuff$Mode;
...
.method public setCornerRadius(I)V
    ...
    iput-boolean v0, p0, LE0/c;->p:Z

    iget-object v0, p0, LE0/c;->b:Lc1/l;
    ...
    invoke-virtual {p0, p1}, LE0/c;->c(Lc1/l;)V
...
.method public setInsetBottom(I)V
    ...
    invoke-virtual {p0, v0, p1}, LE0/c;->d(II)V
...
.method public setInsetTop(I)V
    ...
    invoke-virtual {p0, p1, v0}, LE0/c;->d(II)V
...
.method public setOnPressedChangeListenerInternal(LE0/a;)V
    .locals 0

    iput-object p1, p0, Lcom/google/android/material/button/MaterialButton;->c:LE0/a;
...
.method public setPressed(Z)V
    ...
    iget-object v0, p0, Lcom/google/android/material/button/MaterialButton;->c:LE0/a;
...
.method public setRippleColor(Landroid/content/res/ColorStateList;)V
    ...
    iget-object v0, p0, LE0/c;->a:Lcom/google/android/material/button/MaterialButton;

    iget-object v1, p0, LE0/c;->l:Landroid/content/res/ColorStateList;

    if-eq v1, p1, :cond_0

    iput-object p1, p0, LE0/c;->l:Landroid/content/res/ColorStateList;
...
.method public setShouldDrawSurfaceColorStroke(Z)V
    ...
    iput-boolean p1, p0, LE0/c;->n:Z

    invoke-virtual {p0}, LE0/c;->f()V
...
.method public setSupportBackgroundTintList(Landroid/content/res/ColorStateList;)V
    ...
    invoke-virtual {p0, p1}, LE0/c;->b(Z)Lc1/h;
...
.method public setSupportBackgroundTintMode(Landroid/graphics/PorterDuff$Mode;)V
    ...
    iget-object v0, p0, LE0/c;->i:Landroid/graphics/PorterDuff$Mode;

    if-eq v0, p1, :cond_0

    iput-object p1, p0, LE0/c;->i:Landroid/graphics/PorterDuff$Mode;
