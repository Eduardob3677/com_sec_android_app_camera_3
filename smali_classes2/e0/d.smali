...
.method static constructor <clinit>()V
    ...
    sput-object v0, Le0/d;->b:Ljava/lang/Object;

    new-instance v0, Le0/d;

    invoke-direct {v0}, Ljava/lang/Object;-><init>()V

    sput-object v0, Le0/d;->c:Le0/d;

    return-void
.end method

.method public static d(Landroid/app/Activity;ILh0/m;Landroid/content/DialogInterface$OnCancelListener;)Landroid/app/AlertDialog;
    .locals 5
    ...
    :cond_2
    invoke-static {p0, p1}, Lh0/l;->b(Landroid/content/Context;I)Ljava/lang/String;
    ...
    :cond_7
    invoke-static {p0, p1}, Lh0/l;->c(Landroid/content/Context;I)Ljava/lang/String;
...
.method public static e(Landroid/app/Activity;Landroid/app/AlertDialog;Ljava/lang/String;Landroid/content/DialogInterface$OnCancelListener;)V
    ...
    iput-object p1, v2, Le0/h;->a:Landroid/app/Dialog;

    if-eqz p3, :cond_0

    iput-object p3, v2, Le0/h;->b:Landroid/content/DialogInterface$OnCancelListener;
    ...
    iput-object p1, v2, Le0/b;->a:Landroid/app/Dialog;

    if-eqz p3, :cond_2

    iput-object p3, v2, Le0/b;->b:Landroid/content/DialogInterface$OnCancelListener;
...
.method public final c(Lcom/google/android/gms/common/api/GoogleApiActivity;ILcom/google/android/gms/common/api/GoogleApiActivity;)V
    ...
    invoke-super {p0, p1, p2, v0}, Le0/e;->a(Landroid/content/Context;ILjava/lang/String;)Landroid/content/Intent;
    ...
    invoke-direct {v0, p0, p1, v1}, Lh0/m;-><init>(Landroid/content/Intent;Ljava/lang/Object;I)V

    invoke-static {p1, p2, v0, p3}, Le0/d;->d(Landroid/app/Activity;ILh0/m;Landroid/content/DialogInterface$OnCancelListener;)Landroid/app/AlertDialog;
    ...
    invoke-static {p1, p0, p2, p3}, Le0/d;->e(Landroid/app/Activity;Landroid/app/AlertDialog;Ljava/lang/String;Landroid/content/DialogInterface$OnCancelListener;)V
...
.method public final f(Landroid/content/Context;ILandroid/app/PendingIntent;)V
    ...
    invoke-static {p2, v0, v1}, Landroidx/collection/a;->q(ILjava/lang/String;Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-direct {p2, p0, p1}, Le0/i;-><init>(Le0/d;Landroid/content/Context;)V
    ...
    invoke-static {p1, v0}, Lh0/l;->e(Landroid/content/Context;Ljava/lang/String;)Ljava/lang/String;
    ...
    :cond_3
    invoke-static {p1, p2}, Lh0/l;->c(Landroid/content/Context;I)Ljava/lang/String;
    ...
    :cond_5
    invoke-static {p1, p2}, Lh0/l;->b(Landroid/content/Context;I)Ljava/lang/String;
    ...
    :cond_6
    :goto_1
    invoke-static {p1}, Lh0/l;->a(Landroid/content/Context;)Ljava/lang/String;

    move-result-object p0

    const-string v3, "common_google_play_services_resolution_required_text"

    invoke-static {p1, v3, p0}, Lh0/l;->d(Landroid/content/Context;Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;
    ...
    sget-object v6, Ll6/k;->c:Ljava/lang/Boolean;
    ...
    sput-object v5, Ll6/k;->c:Ljava/lang/Boolean;

    :cond_7
    sget-object v5, Ll6/k;->c:Ljava/lang/Boolean;
    ...
    invoke-static {p1}, Ll6/k;->v(Landroid/content/Context;)Z
    ...
    :goto_3
    sget-object p0, Le0/d;->b:Ljava/lang/Object;
    ...
    :cond_c
    sget-object p1, Le0/f;->a:Ljava/util/concurrent/atomic/AtomicBoolean;
...
.method public final g(Landroid/app/Activity;Lg0/e;ILandroid/content/DialogInterface$OnCancelListener;)V
    .locals 2

    const-string v0, "d"

    invoke-super {p0, p1, p3, v0}, Le0/e;->a(Landroid/content/Context;ILjava/lang/String;)Landroid/content/Intent;
    ...
    invoke-direct {v0, p0, p2, v1}, Lh0/m;-><init>(Landroid/content/Intent;Ljava/lang/Object;I)V

    invoke-static {p1, p3, v0, p4}, Le0/d;->d(Landroid/app/Activity;ILh0/m;Landroid/content/DialogInterface$OnCancelListener;)Landroid/app/AlertDialog;
    ...
    invoke-static {p1, p0, p2, p4}, Le0/d;->e(Landroid/app/Activity;Landroid/app/AlertDialog;Ljava/lang/String;Landroid/content/DialogInterface$OnCancelListener;)V
