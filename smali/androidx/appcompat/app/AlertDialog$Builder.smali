...
.method public setSingleChoiceOption(Ljava/lang/CharSequence;ZLandroid/widget/CompoundButton$OnCheckedChangeListener;)Landroidx/appcompat/app/AlertDialog$Builder;
    .locals 2

    iget-object v0, p0, Landroidx/appcompat/app/AlertDialog$Builder;->P:Landroidx/appcompat/app/AlertController$AlertParams;

    iget-object v1, v0, Landroidx/appcompat/app/AlertController$AlertParams;->mMessage:Ljava/lang/CharSequence;

    if-eqz v1, :cond_0

    iput-object p1, v0, Landroidx/appcompat/app/AlertController$AlertParams;->mSingleChoiceOptionLabel:Ljava/lang/CharSequence;

    iput-boolean p2, v0, Landroidx/appcompat/app/AlertController$AlertParams;->mSingleChoiceChecked:Z

    const/4 p1, 0x1

    iput-boolean p1, v0, Landroidx/appcompat/app/AlertController$AlertParams;->isSingleChoiceOption:Z

    iput-object p3, v0, Landroidx/appcompat/app/AlertController$AlertParams;->mSingleChoiceListener:Landroid/widget/CompoundButton$OnCheckedChangeListener;
    ...
    const-string/jumbo p1, "setSingleChoiceOption() requires setMessage()."
