...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;II)V
    ...
    iput-boolean p0, v2, Landroidx/appcompat/widget/SeslProgressBar;->mNoInvalidate:Z
    ...
    invoke-virtual {v2, p1}, Landroidx/appcompat/widget/SeslProgressBar;->setProgressDrawableTiled(Landroid/graphics/drawable/Drawable;)V
    ...
    :cond_0
    invoke-virtual {v2, p1}, Landroidx/appcompat/widget/SeslProgressBar;->setProgressDrawable(Landroid/graphics/drawable/Drawable;)V

    :cond_1
    :goto_0
    sget p1, Landroidx/appcompat/R$styleable;->ProgressBar_android_indeterminateDuration:I

    iget p2, v2, Landroidx/appcompat/widget/SeslProgressBar;->mDuration:I

    invoke-virtual {v6, p1, p2}, Landroid/content/res/TypedArray;->getInt(II)I

    move-result p1

    iput p1, v2, Landroidx/appcompat/widget/SeslProgressBar;->mDuration:I

    sget p1, Landroidx/appcompat/R$styleable;->ProgressBar_sesl_progressCircleGradientStyle:I

    iget p2, v2, Landroidx/appcompat/widget/SeslProgressBar;->mCircleGradientStyle:I

    invoke-virtual {v6, p1, p2}, Landroid/content/res/TypedArray;->getInt(II)I

    move-result p1

    iput p1, v2, Landroidx/appcompat/widget/SeslProgressBar;->mCircleGradientStyle:I

    sget p1, Landroidx/appcompat/R$styleable;->ProgressBar_android_minWidth:I

    iget p2, v2, Landroidx/appcompat/widget/SeslProgressBar;->mMinWidth:I

    invoke-virtual {v6, p1, p2}, Landroid/content/res/TypedArray;->getDimensionPixelSize(II)I

    move-result p1

    iput p1, v2, Landroidx/appcompat/widget/SeslProgressBar;->mMinWidth:I

    sget p1, Landroidx/appcompat/R$styleable;->ProgressBar_android_maxWidth:I

    iget p2, v2, Landroidx/appcompat/widget/SeslProgressBar;->mMaxWidth:I

    invoke-virtual {v6, p1, p2}, Landroid/content/res/TypedArray;->getDimensionPixelSize(II)I

    move-result p1

    iput p1, v2, Landroidx/appcompat/widget/SeslProgressBar;->mMaxWidth:I

    sget p1, Landroidx/appcompat/R$styleable;->ProgressBar_android_minHeight:I

    iget p2, v2, Landroidx/appcompat/widget/SeslProgressBar;->mMinHeight:I

    invoke-virtual {v6, p1, p2}, Landroid/content/res/TypedArray;->getDimensionPixelSize(II)I

    move-result p1

    iput p1, v2, Landroidx/appcompat/widget/SeslProgressBar;->mMinHeight:I

    sget p1, Landroidx/appcompat/R$styleable;->ProgressBar_android_maxHeight:I

    iget p2, v2, Landroidx/appcompat/widget/SeslProgressBar;->mMaxHeight:I

    invoke-virtual {v6, p1, p2}, Landroid/content/res/TypedArray;->getDimensionPixelSize(II)I

    move-result p1

    iput p1, v2, Landroidx/appcompat/widget/SeslProgressBar;->mMaxHeight:I

    sget p1, Landroidx/appcompat/R$styleable;->ProgressBar_android_indeterminateBehavior:I

    iget p2, v2, Landroidx/appcompat/widget/SeslProgressBar;->mBehavior:I

    invoke-virtual {v6, p1, p2}, Landroid/content/res/TypedArray;->getInt(II)I

    move-result p1

    iput p1, v2, Landroidx/appcompat/widget/SeslProgressBar;->mBehavior:I
    ...
    invoke-virtual {v2, v3, p1}, Landroidx/appcompat/widget/SeslProgressBar;->setInterpolator(Landroid/content/Context;I)V

    :cond_2
    sget p1, Landroidx/appcompat/R$styleable;->ProgressBar_android_min:I

    iget p2, v2, Landroidx/appcompat/widget/SeslProgressBar;->mMin:I

    invoke-virtual {v6, p1, p2}, Landroid/content/res/TypedArray;->getInt(II)I

    move-result p1

    invoke-virtual {v2, p1}, Landroidx/appcompat/widget/SeslProgressBar;->setMin(I)V

    sget p1, Landroidx/appcompat/R$styleable;->ProgressBar_android_max:I

    iget p2, v2, Landroidx/appcompat/widget/SeslProgressBar;->mMax:I

    invoke-virtual {v6, p1, p2}, Landroid/content/res/TypedArray;->getInt(II)I

    move-result p1

    invoke-virtual {v2, p1}, Landroidx/appcompat/widget/SeslProgressBar;->setMax(I)V

    sget p1, Landroidx/appcompat/R$styleable;->ProgressBar_android_progress:I

    iget p2, v2, Landroidx/appcompat/widget/SeslProgressBar;->mProgress:I

    invoke-virtual {v6, p1, p2}, Landroid/content/res/TypedArray;->getInt(II)I

    move-result p1

    invoke-virtual {v2, p1}, Landroidx/appcompat/widget/SeslProgressBar;->setProgress(I)V

    sget p1, Landroidx/appcompat/R$styleable;->ProgressBar_android_secondaryProgress:I

    iget p2, v2, Landroidx/appcompat/widget/SeslProgressBar;->mSecondaryProgress:I

    invoke-virtual {v6, p1, p2}, Landroid/content/res/TypedArray;->getInt(II)I

    move-result p1

    invoke-virtual {v2, p1}, Landroidx/appcompat/widget/SeslProgressBar;->setSecondaryProgress(I)V
    ...
    invoke-virtual {v2, p1}, Landroidx/appcompat/widget/SeslProgressBar;->setIndeterminateDrawableTiled(Landroid/graphics/drawable/Drawable;)V

    goto :goto_1

    :cond_3
    invoke-virtual {v2, p1}, Landroidx/appcompat/widget/SeslProgressBar;->setIndeterminateDrawable(Landroid/graphics/drawable/Drawable;)V

    :cond_4
    :goto_1
    sget p1, Landroidx/appcompat/R$styleable;->ProgressBar_android_indeterminateOnly:I

    iget-boolean p2, v2, Landroidx/appcompat/widget/SeslProgressBar;->mOnlyIndeterminate:Z

    invoke-virtual {v6, p1, p2}, Landroid/content/res/TypedArray;->getBoolean(IZ)Z

    move-result p1

    iput-boolean p1, v2, Landroidx/appcompat/widget/SeslProgressBar;->mOnlyIndeterminate:Z

    iput-boolean v0, v2, Landroidx/appcompat/widget/SeslProgressBar;->mNoInvalidate:Z

    if-nez p1, :cond_5

    sget p1, Landroidx/appcompat/R$styleable;->ProgressBar_android_indeterminate:I

    iget-boolean p2, v2, Landroidx/appcompat/widget/SeslProgressBar;->mIndeterminate:Z
    ...
    :cond_6
    invoke-virtual {v2, v0}, Landroidx/appcompat/widget/SeslProgressBar;->setIndeterminate(Z)V

    sget p1, Landroidx/appcompat/R$styleable;->ProgressBar_android_mirrorForRtl:I

    iget-boolean p2, v2, Landroidx/appcompat/widget/SeslProgressBar;->mMirrorForRtl:Z

    invoke-virtual {v6, p1, p2}, Landroid/content/res/TypedArray;->getBoolean(IZ)Z

    move-result p1

    iput-boolean p1, v2, Landroidx/appcompat/widget/SeslProgressBar;->mMirrorForRtl:Z
    ...
    iget-object p1, v2, Landroidx/appcompat/widget/SeslProgressBar;->mProgressTintInfo:Landroidx/appcompat/widget/SeslProgressBar$ProgressTintInfo;

    if-nez p1, :cond_7

    new-instance p1, Landroidx/appcompat/widget/SeslProgressBar$ProgressTintInfo;

    invoke-direct {p1, p3}, Landroidx/appcompat/widget/SeslProgressBar$ProgressTintInfo;-><init>(Landroidx/appcompat/widget/SeslProgressBar$1;)V

    iput-object p1, v2, Landroidx/appcompat/widget/SeslProgressBar;->mProgressTintInfo:Landroidx/appcompat/widget/SeslProgressBar$ProgressTintInfo;
    ...
    invoke-static {p4, p3}, Landroidx/appcompat/widget/DrawableUtils;->parseTintMode(ILandroid/graphics/PorterDuff$Mode;)Landroid/graphics/PorterDuff$Mode;

    move-result-object p4

    iput-object p4, p1, Landroidx/appcompat/widget/SeslProgressBar$ProgressTintInfo;->mProgressTintMode:Landroid/graphics/PorterDuff$Mode;
    ...
    invoke-virtual {v6, p4}, Landroid/content/res/TypedArray;->getColorStateList(I)Landroid/content/res/ColorStateList;

    move-result-object p4

    iput-object p4, p1, Landroidx/appcompat/widget/SeslProgressBar$ProgressTintInfo;->mProgressTintList:Landroid/content/res/ColorStateList;
    ...
    iput-object p4, p1, Landroidx/appcompat/widget/SeslProgressBar$ProgressTintInfo;->mProgressBackgroundTintMode:Landroid/graphics/PorterDuff$Mode;
    ...
    iput-object p4, p1, Landroidx/appcompat/widget/SeslProgressBar$ProgressTintInfo;->mProgressBackgroundTintList:Landroid/content/res/ColorStateList;
    ...
    iput-object p4, p1, Landroidx/appcompat/widget/SeslProgressBar$ProgressTintInfo;->mSecondaryProgressTintMode:Landroid/graphics/PorterDuff$Mode;
    ...
    iput-object p4, p1, Landroidx/appcompat/widget/SeslProgressBar$ProgressTintInfo;->mSecondaryProgressTintList:Landroid/content/res/ColorStateList;
    ...
    iput-object p2, p1, Landroidx/appcompat/widget/SeslProgressBar$ProgressTintInfo;->mIndeterminateTintMode:Landroid/graphics/PorterDuff$Mode;
    ...
    sget p2, Landroidx/appcompat/R$styleable;->ProgressBar_android_indeterminateTint:I

    invoke-virtual {v6, p2}, Landroid/content/res/TypedArray;->getColorStateList(I)Landroid/content/res/ColorStateList;

    move-result-object p2

    iput-object p2, p1, Landroidx/appcompat/widget/SeslProgressBar$ProgressTintInfo;->mIndeterminateTintList:Landroid/content/res/ColorStateList;
    ...
    iget-boolean p2, v2, Landroidx/appcompat/widget/SeslProgressBar;->mUseCustomWidthForCircleMode:Z

    invoke-virtual {v6, p1, p2}, Landroid/content/res/TypedArray;->getBoolean(IZ)Z

    move-result p1

    iput-boolean p1, v2, Landroidx/appcompat/widget/SeslProgressBar;->mUseCustomWidthForCircleMode:Z
    ...
    iput p1, v2, Landroidx/appcompat/widget/SeslProgressBar;->mRoundStrokeWidth:I
    ...
    iput p1, v2, Landroidx/appcompat/widget/SeslProgressBar;->mCirclePadding:I

    :cond_17
    sget p1, Landroidx/appcompat/R$styleable;->ProgressBar_useHorizontalProgress:I

    iget-boolean p2, v2, Landroidx/appcompat/widget/SeslProgressBar;->mUseHorizontalProgress:Z

    invoke-virtual {v6, p1, p2}, Landroid/content/res/TypedArray;->getBoolean(IZ)Z

    move-result p1

    iput-boolean p1, v2, Landroidx/appcompat/widget/SeslProgressBar;->mUseHorizontalProgress:Z
    ...
    invoke-direct {p1, v3, p2}, Landroidx/appcompat/view/ContextThemeWrapper;-><init>(Landroid/content/Context;I)V
    ...
    iput-object p2, v2, Landroidx/appcompat/widget/SeslProgressBar;->mIndeterminateHorizontalXsmall:Landroid/graphics/drawable/Drawable;
    ...
    iput-object p2, v2, Landroidx/appcompat/widget/SeslProgressBar;->mIndeterminateHorizontalSmall:Landroid/graphics/drawable/Drawable;
    ...
    iput-object p2, v2, Landroidx/appcompat/widget/SeslProgressBar;->mIndeterminateHorizontalMedium:Landroid/graphics/drawable/Drawable;
    ...
    iput-object p2, v2, Landroidx/appcompat/widget/SeslProgressBar;->mIndeterminateHorizontalLarge:Landroid/graphics/drawable/Drawable;
    ...
    iput-object p1, v2, Landroidx/appcompat/widget/SeslProgressBar;->mIndeterminateHorizontalXlarge:Landroid/graphics/drawable/Drawable;
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0

    invoke-virtual {v6}, Landroid/content/res/TypedArray;->recycle()V

    invoke-direct {v2}, Landroidx/appcompat/widget/SeslProgressBar;->applyProgressTints()V

    invoke-direct {v2}, Landroidx/appcompat/widget/SeslProgressBar;->applyIndeterminateTint()V
    ...
    iput p0, v2, Landroidx/appcompat/widget/SeslProgressBar;->mDensity:F

    new-instance p0, Landroidx/appcompat/widget/SeslProgressBar$CircleAnimationCallback;

    invoke-direct {p0, v2}, Landroidx/appcompat/widget/SeslProgressBar$CircleAnimationCallback;-><init>(Landroidx/appcompat/widget/SeslProgressBar;)V

    iput-object p0, v2, Landroidx/appcompat/widget/SeslProgressBar;->mCircleAnimationCallback:Landroidx/appcompat/widget/SeslProgressBar$CircleAnimationCallback;
...
.method private setGradientColorsForCircle()V
    ...
    iget v0, p0, Landroidx/appcompat/widget/SeslProgressBar;->mCircleGradientStyle:I
    ...
    iput-object v0, p0, Landroidx/appcompat/widget/SeslProgressBar;->mCircleGradientColors:[I
