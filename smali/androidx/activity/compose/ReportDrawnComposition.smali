...
.annotation runtime Lkotlin/Metadata;
    ...
    d2 = {
        ...
        "predicate",
        "<init>",
        "(Landroidx/activity/FullyDrawnReporter;LF4/a;)V",
        "observeReporter",
        "(LF4/a;)V",
        "invoke",
        "()V",
...
# instance fields
.field private final checkReporter:LF4/k;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "LF4/k;"
        }
...
.field private final predicate:LF4/a;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "LF4/a;"
        }
...
# direct methods
.method public constructor <init>(Landroidx/activity/FullyDrawnReporter;LF4/a;)V
    .locals 2
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    iput-object p2, p0, Landroidx/activity/compose/ReportDrawnComposition;->predicate:LF4/a;
    ...
    invoke-direct {v0, v1}, Landroidx/compose/runtime/snapshots/SnapshotStateObserver;-><init>(LF4/k;)V
    ...
    iput-object v0, p0, Landroidx/activity/compose/ReportDrawnComposition;->checkReporter:LF4/k;

    invoke-virtual {p1, p0}, Landroidx/activity/FullyDrawnReporter;->addOnReportDrawnListener(LF4/a;)V
    ...
    invoke-direct {p0, p2}, Landroidx/activity/compose/ReportDrawnComposition;->observeReporter(LF4/a;)V

    :cond_0
    return-void
.end method

.method public static final synthetic access$observeReporter(Landroidx/activity/compose/ReportDrawnComposition;LF4/a;)V
    .locals 0

    invoke-direct {p0, p1}, Landroidx/activity/compose/ReportDrawnComposition;->observeReporter(LF4/a;)V

    return-void
.end method

.method private final observeReporter(LF4/a;)V
    .locals 4
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    iget-object v2, p0, Landroidx/activity/compose/ReportDrawnComposition;->checkReporter:LF4/k;

    new-instance v3, Landroidx/activity/compose/ReportDrawnComposition$observeReporter$1;

    invoke-direct {v3, v0, p1}, Landroidx/activity/compose/ReportDrawnComposition$observeReporter$1;-><init>(Lkotlin/jvm/internal/A;LF4/a;)V

    invoke-virtual {v1, p1, v2, v3}, Landroidx/compose/runtime/snapshots/SnapshotStateObserver;->observeReads(Ljava/lang/Object;LF4/k;LF4/a;)V
...
.method public final removeReporter()V
    ...
    iget-object v1, p0, Landroidx/activity/compose/ReportDrawnComposition;->predicate:LF4/a;
