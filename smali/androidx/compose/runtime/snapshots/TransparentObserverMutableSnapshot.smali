...
.annotation runtime Lkotlin/Metadata;
    ...
    d2 = {
        ...
        "ownsParentSnapshot",
        "<init>",
        "(Landroidx/compose/runtime/snapshots/MutableSnapshot;LF4/k;LF4/k;ZZ)V",
        "dispose",
        "()V",
        "hasPendingChanges",
        "()Z",
...
# direct methods
.method public constructor <init>(Landroidx/compose/runtime/snapshots/MutableSnapshot;LF4/k;LF4/k;ZZ)V
    .locals 2
    ...
    invoke-virtual {p1}, Landroidx/compose/runtime/snapshots/MutableSnapshot;->getReadObserver$runtime_release()LF4/k;
    ...
    invoke-virtual {v1}, Landroidx/compose/runtime/snapshots/MutableSnapshot;->getReadObserver$runtime_release()LF4/k;

    move-result-object v1

    :cond_1
    invoke-static {p2, v1, p4}, Landroidx/compose/runtime/snapshots/SnapshotKt;->access$mergedReadObserver(LF4/k;LF4/k;Z)LF4/k;

    move-result-object p2

    if-eqz p1, :cond_2

    invoke-virtual {p1}, Landroidx/compose/runtime/snapshots/MutableSnapshot;->getWriteObserver$runtime_release()LF4/k;
    ...
    invoke-virtual {v1}, Landroidx/compose/runtime/snapshots/MutableSnapshot;->getWriteObserver$runtime_release()LF4/k;

    move-result-object v1

    :cond_3
    invoke-static {p3, v1}, Landroidx/compose/runtime/snapshots/SnapshotKt;->access$mergedWriteObserver(LF4/k;LF4/k;)LF4/k;

    move-result-object p3

    const/4 v1, 0x0

    invoke-direct {p0, v1, v0, p2, p3}, Landroidx/compose/runtime/snapshots/MutableSnapshot;-><init>(ILandroidx/compose/runtime/snapshots/SnapshotIdSet;LF4/k;LF4/k;)V
...
.method public nestedActivated$runtime_release(Landroidx/compose/runtime/snapshots/Snapshot;)Ljava/lang/Void;
    ...
    invoke-static {}, Landroidx/compose/material/a;->f()LK2/a;
...
.method public takeNestedMutableSnapshot(LF4/k;LF4/k;)Landroidx/compose/runtime/snapshots/MutableSnapshot;
    ...
    invoke-static {p1, v0, v1, v2, v3}, Landroidx/compose/runtime/snapshots/SnapshotKt;->mergedReadObserver$default(LF4/k;LF4/k;ZILjava/lang/Object;)LF4/k;
    ...
    invoke-virtual {p0, v3, v7}, Landroidx/compose/runtime/snapshots/MutableSnapshot;->takeNestedMutableSnapshot(LF4/k;LF4/k;)Landroidx/compose/runtime/snapshots/MutableSnapshot;
    ...
    invoke-direct/range {v4 .. v9}, Landroidx/compose/runtime/snapshots/TransparentObserverMutableSnapshot;-><init>(Landroidx/compose/runtime/snapshots/MutableSnapshot;LF4/k;LF4/k;ZZ)V
    ...
    invoke-virtual {p0, v6, v7}, Landroidx/compose/runtime/snapshots/MutableSnapshot;->takeNestedMutableSnapshot(LF4/k;LF4/k;)Landroidx/compose/runtime/snapshots/MutableSnapshot;
...
.method public takeNestedSnapshot(LF4/k;)Landroidx/compose/runtime/snapshots/Snapshot;
    ...
    invoke-virtual {p0, v3}, Landroidx/compose/runtime/snapshots/MutableSnapshot;->takeNestedSnapshot(LF4/k;)Landroidx/compose/runtime/snapshots/Snapshot;

    move-result-object p0

    const/4 v0, 0x1

    invoke-static {p0, p1, v0}, Landroidx/compose/runtime/snapshots/SnapshotKt;->access$createTransparentSnapshotWithNoParentReadObserver(Landroidx/compose/runtime/snapshots/Snapshot;LF4/k;Z)Landroidx/compose/runtime/snapshots/Snapshot;
    ...
    invoke-virtual {p0, p1}, Landroidx/compose/runtime/snapshots/MutableSnapshot;->takeNestedSnapshot(LF4/k;)Landroidx/compose/runtime/snapshots/Snapshot;
