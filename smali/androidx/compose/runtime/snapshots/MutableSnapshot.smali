...
.annotation runtime Lkotlin/Metadata;
    ...
    d2 = {
        ...
        "writeObserver",
        "<init>",
        "(ILandroidx/compose/runtime/snapshots/SnapshotIdSet;LF4/k;LF4/k;)V",
        "",
        "hasPendingChanges",
        "()Z",
        "takeNestedMutableSnapshot",
        "(LF4/k;LF4/k;)Landroidx/compose/runtime/snapshots/MutableSnapshot;",
...
.field private final writeObserver:LF4/k;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "LF4/k;"
        }
...
.method public constructor <init>(ILandroidx/compose/runtime/snapshots/SnapshotIdSet;LF4/k;LF4/k;)V
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(I",
    ...
    iput-object p3, p0, Landroidx/compose/runtime/snapshots/MutableSnapshot;->readObserver:LF4/k;

    iput-object p4, p0, Landroidx/compose/runtime/snapshots/MutableSnapshot;->writeObserver:LF4/k;
...
.method private final abandon()V
    ...
    invoke-static {v6, v7}, Ls4/t;->h0(Ljava/lang/Iterable;Ljava/lang/Object;)Z
...
.method public static synthetic takeNestedMutableSnapshot$default(Landroidx/compose/runtime/snapshots/MutableSnapshot;LF4/k;LF4/k;ILjava/lang/Object;)Landroidx/compose/runtime/snapshots/MutableSnapshot;
    .locals 1
    ...
    :cond_1
    invoke-virtual {p0, p1, p2}, Landroidx/compose/runtime/snapshots/MutableSnapshot;->takeNestedMutableSnapshot(LF4/k;LF4/k;)Landroidx/compose/runtime/snapshots/MutableSnapshot;
...
# virtual methods
.method public final advance$runtime_release(LF4/a;)Ljava/lang/Object;
    .locals 4
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "<T:",
...
.method public apply()Landroidx/compose/runtime/snapshots/SnapshotApplyResult;
    ...
    invoke-static {}, Landroidx/compose/runtime/snapshots/SnapshotKt;->access$getEmptyLambda$p()LF4/k;

    move-result-object v2

    invoke-static {v3, v2}, Landroidx/compose/runtime/snapshots/SnapshotKt;->access$takeNewGlobalSnapshot(Landroidx/compose/runtime/snapshots/Snapshot;LF4/k;)Ljava/lang/Object;
    ...
    invoke-static {v2, v5}, Landroidx/compose/runtime/snapshots/SnapshotKt;->access$takeNewGlobalSnapshot(Landroidx/compose/runtime/snapshots/Snapshot;LF4/k;)Ljava/lang/Object;
    ...
    invoke-interface {v7, v2, p0}, LF4/n;->invoke(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;
    ...
    invoke-interface {v7, v0, p0}, LF4/n;->invoke(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;
...
.method public getReadObserver$runtime_release()LF4/k;
    .locals 0
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "()",
    ...
    iget-object p0, p0, Landroidx/compose/runtime/snapshots/MutableSnapshot;->readObserver:LF4/k;
...
.method public getWriteObserver$runtime_release()LF4/k;
    .locals 0
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "()",
    ...
    iget-object p0, p0, Landroidx/compose/runtime/snapshots/MutableSnapshot;->writeObserver:LF4/k;
...
.method public final innerApplyLocked$runtime_release(ILjava/util/Map;Landroidx/compose/runtime/snapshots/SnapshotIdSet;)Landroidx/compose/runtime/snapshots/SnapshotApplyResult;
    ...
    invoke-direct {v7, v10, v2}, Lr4/h;-><init>(Ljava/lang/Object;Ljava/lang/Object;)V
    ...
    invoke-direct {v2, v10, v7}, Lr4/h;-><init>(Ljava/lang/Object;Ljava/lang/Object;)V
    ...
    :cond_10
    invoke-static {v1, v8}, Ls4/t;->F0(Ljava/util/Collection;Ljava/lang/Iterable;)Ljava/util/ArrayList;
...
.method public takeNestedMutableSnapshot(LF4/k;LF4/k;)Landroidx/compose/runtime/snapshots/MutableSnapshot;
    .locals 8
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-static {v0}, Landroidx/compose/runtime/snapshots/SnapshotKt;->access$setNextSnapshotId$p(I)V
    ...
    invoke-static {v0, v4, v3}, Landroidx/compose/runtime/snapshots/SnapshotKt;->addRange(Landroidx/compose/runtime/snapshots/SnapshotIdSet;II)Landroidx/compose/runtime/snapshots/SnapshotIdSet;

    move-result-object v4

    invoke-virtual {p0}, Landroidx/compose/runtime/snapshots/MutableSnapshot;->getReadObserver$runtime_release()LF4/k;
    ...
    invoke-static {p1, v0, v7, v5, v6}, Landroidx/compose/runtime/snapshots/SnapshotKt;->mergedReadObserver$default(LF4/k;LF4/k;ZILjava/lang/Object;)LF4/k;

    move-result-object v5

    invoke-virtual {p0}, Landroidx/compose/runtime/snapshots/MutableSnapshot;->getWriteObserver$runtime_release()LF4/k;

    move-result-object p1

    invoke-static {p2, p1}, Landroidx/compose/runtime/snapshots/SnapshotKt;->access$mergedWriteObserver(LF4/k;LF4/k;)LF4/k;

    move-result-object v6

    move-object v7, p0

    invoke-direct/range {v2 .. v7}, Landroidx/compose/runtime/snapshots/NestedMutableSnapshot;-><init>(ILandroidx/compose/runtime/snapshots/SnapshotIdSet;LF4/k;LF4/k;Landroidx/compose/runtime/snapshots/MutableSnapshot;)V
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_1

    monitor-exit v1

    invoke-virtual {v7}, Landroidx/compose/runtime/snapshots/MutableSnapshot;->getApplied$runtime_release()Z

    move-result p0

    if-nez p0, :cond_0

    invoke-virtual {v7}, Landroidx/compose/runtime/snapshots/Snapshot;->getDisposed$runtime_release()Z
    ...
    invoke-virtual {v7, p2}, Landroidx/compose/runtime/snapshots/Snapshot;->setId$runtime_release(I)V
    ...
    invoke-virtual {p2, v0}, Landroidx/compose/runtime/snapshots/SnapshotIdSet;->set(I)Landroidx/compose/runtime/snapshots/SnapshotIdSet;

    move-result-object p2

    invoke-static {p2}, Landroidx/compose/runtime/snapshots/SnapshotKt;->access$setOpenSnapshots$p(Landroidx/compose/runtime/snapshots/SnapshotIdSet;)V
    :try_end_1
    .catchall {:try_start_1 .. :try_end_1} :catchall_0
    ...
    invoke-static {p1, p0, p2}, Landroidx/compose/runtime/snapshots/SnapshotKt;->addRange(Landroidx/compose/runtime/snapshots/SnapshotIdSet;II)Landroidx/compose/runtime/snapshots/SnapshotIdSet;

    move-result-object p0

    invoke-virtual {v7, p0}, Landroidx/compose/runtime/snapshots/Snapshot;->setInvalid$runtime_release(Landroidx/compose/runtime/snapshots/SnapshotIdSet;)V
...
.method public takeNestedSnapshot(LF4/k;)Landroidx/compose/runtime/snapshots/Snapshot;
    .locals 5
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-direct {v3, v2, v0, p1, p0}, Landroidx/compose/runtime/snapshots/NestedReadonlySnapshot;-><init>(ILandroidx/compose/runtime/snapshots/SnapshotIdSet;LF4/k;Landroidx/compose/runtime/snapshots/Snapshot;)V
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_1
