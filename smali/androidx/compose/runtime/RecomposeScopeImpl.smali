...
.method public final compose(Landroidx/compose/runtime/Composer;)V
    ...
    iget-object v1, p0, Landroidx/compose/runtime/RecomposeScopeImpl;->block:LF4/n;

    iget-object v2, p0, Landroidx/compose/runtime/RecomposeScopeImpl;->observer:Landroidx/compose/runtime/tooling/RecomposeScopeObserver;

    if-eqz v2, :cond_0

    if-eqz v1, :cond_0

    invoke-interface {v2, p0}, Landroidx/compose/runtime/tooling/RecomposeScopeObserver;->onBeginScopeComposition(Landroidx/compose/runtime/RecomposeScope;)V

    :try_start_0
    invoke-interface {v1, p1, v0}, LF4/n;->invoke(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0

    invoke-interface {v2, p0}, Landroidx/compose/runtime/tooling/RecomposeScopeObserver;->onEndScopeComposition(Landroidx/compose/runtime/RecomposeScope;)V
...
.method public final end(I)LF4/k;
    .locals 19
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(I)",
...
.method public final getCanRecompose()Z
    ...
    iget-object p0, p0, Landroidx/compose/runtime/RecomposeScopeImpl;->block:LF4/n;
...
.method public updateScope(LF4/n;)V
    .locals 0
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    iput-object p1, p0, Landroidx/compose/runtime/RecomposeScopeImpl;->block:LF4/n;
