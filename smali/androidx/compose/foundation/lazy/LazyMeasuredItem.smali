...
.method public final position(III)Landroidx/compose/foundation/lazy/LazyListPositionedItem;
    ...
    :goto_0
    iget-object v0, p0, Landroidx/compose/foundation/lazy/LazyMeasuredItem;->placeables:Ljava/util/List;
    ...
    iget-boolean v5, p0, Landroidx/compose/foundation/lazy/LazyMeasuredItem;->isVertical:Z

    const-string v6, "Required value was null."

    if-eqz v5, :cond_2

    iget-object v5, p0, Landroidx/compose/foundation/lazy/LazyMeasuredItem;->horizontalAlignment:Landroidx/compose/ui/Alignment$Horizontal;
    ...
    iget-object v7, p0, Landroidx/compose/foundation/lazy/LazyMeasuredItem;->layoutDirection:Landroidx/compose/ui/unit/LayoutDirection;

    move/from16 v9, p2

    invoke-interface {v5, v6, v9, v7}, Landroidx/compose/ui/Alignment$Horizontal;->align(IILandroidx/compose/ui/unit/LayoutDirection;)I
    ...
    iget-object v5, p0, Landroidx/compose/foundation/lazy/LazyMeasuredItem;->verticalAlignment:Landroidx/compose/ui/Alignment$Vertical;
    ...
    invoke-interface {v5, v6, v7}, Landroidx/compose/ui/Alignment$Vertical;->align(II)I
    ...
    :goto_2
    iget-boolean v10, p0, Landroidx/compose/foundation/lazy/LazyMeasuredItem;->isVertical:Z
    ...
    new-instance v10, Landroidx/compose/foundation/lazy/LazyListPlaceableWrapper;

    const/4 v11, 0x0

    invoke-direct {v10, v5, v6, v4, v11}, Landroidx/compose/foundation/lazy/LazyListPlaceableWrapper;-><init>(JLandroidx/compose/ui/layout/Placeable;Lkotlin/jvm/internal/h;)V
    ...
    :cond_5
    new-instance v0, Landroidx/compose/foundation/lazy/LazyListPositionedItem;

    iget v2, p0, Landroidx/compose/foundation/lazy/LazyMeasuredItem;->index:I

    iget-object v3, p0, Landroidx/compose/foundation/lazy/LazyMeasuredItem;->key:Ljava/lang/Object;

    iget v4, p0, Landroidx/compose/foundation/lazy/LazyMeasuredItem;->size:I

    iget v1, p0, Landroidx/compose/foundation/lazy/LazyMeasuredItem;->beforeContentPadding:I

    neg-int v5, v1

    iget v1, p0, Landroidx/compose/foundation/lazy/LazyMeasuredItem;->afterContentPadding:I

    add-int v6, v13, v1

    iget-boolean v7, p0, Landroidx/compose/foundation/lazy/LazyMeasuredItem;->isVertical:Z

    iget-object v9, p0, Landroidx/compose/foundation/lazy/LazyMeasuredItem;->placementAnimator:Landroidx/compose/foundation/lazy/LazyListItemPlacementAnimator;

    iget-wide v10, p0, Landroidx/compose/foundation/lazy/LazyMeasuredItem;->visualOffset:J

    iget-boolean v12, p0, Landroidx/compose/foundation/lazy/LazyMeasuredItem;->reverseLayout:Z
