...
.method public final position(III)Ljava/util/List;
    ...
    invoke-static {v9, v10}, Landroidx/compose/foundation/lazy/grid/GridItemSpan;->getCurrentLineSpan-impl(J)I

    move-result v4

    iget-object v7, p0, Landroidx/compose/foundation/lazy/grid/LazyGridMeasuredLine;->layoutDirection:Landroidx/compose/ui/unit/LayoutDirection;

    sget-object v9, Landroidx/compose/ui/unit/LayoutDirection;->Rtl:Landroidx/compose/ui/unit/LayoutDirection;

    if-ne v7, v9, :cond_0

    iget v7, p0, Landroidx/compose/foundation/lazy/grid/LazyGridMeasuredLine;->slotsPerLine:I
    ...
    :goto_1
    iget-boolean v9, p0, Landroidx/compose/foundation/lazy/grid/LazyGridMeasuredLine;->isVertical:Z

    if-eqz v9, :cond_1

    iget v10, p0, Landroidx/compose/foundation/lazy/grid/LazyGridMeasuredLine;->index:I
    ...
    :cond_2
    iget v7, p0, Landroidx/compose/foundation/lazy/grid/LazyGridMeasuredLine;->index:I

    goto :goto_3

    :goto_4
    invoke-virtual/range {v6 .. v12}, Landroidx/compose/foundation/lazy/grid/LazyGridMeasuredItem;->position(IIIIII)Landroidx/compose/foundation/lazy/grid/LazyGridPositionedItem;

    move-result-object v11

    invoke-virtual {v6}, Landroidx/compose/foundation/lazy/grid/LazyGridMeasuredItem;->getCrossAxisSize()I

    move-result v6

    iget v7, p0, Landroidx/compose/foundation/lazy/grid/LazyGridMeasuredLine;->crossAxisSpacing:I
