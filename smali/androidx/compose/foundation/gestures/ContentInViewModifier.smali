...
.annotation runtime Lkotlin/Metadata;
    ...
    d2 = {
        ...
        "reverseDirection",
        "<init>",
        "(LZ5/C;Landroidx/compose/foundation/gestures/Orientation;Landroidx/compose/foundation/gestures/ScrollableState;Z)V",
...
# direct methods
.method public constructor <init>(LZ5/C;Landroidx/compose/foundation/gestures/Orientation;Landroidx/compose/foundation/gestures/ScrollableState;Z)V
    .locals 1
    ...
    iput-object p1, p0, Landroidx/compose/foundation/gestures/ContentInViewModifier;->scope:LZ5/C;
    ...
    invoke-static {p0, p1}, Landroidx/compose/foundation/FocusedBoundsKt;->onFocusedBoundsChanged(Landroidx/compose/ui/Modifier;LF4/k;)Landroidx/compose/ui/Modifier;
...
.method private final launchAnimation()V
    ...
    iget-object v0, p0, Landroidx/compose/foundation/gestures/ContentInViewModifier;->scope:LZ5/C;
    ...
    invoke-direct {v2, p0, v3}, Landroidx/compose/foundation/gestures/ContentInViewModifier$launchAnimation$1;-><init>(Landroidx/compose/foundation/gestures/ContentInViewModifier;Lv4/c;)V

    const/4 p0, 0x1

    invoke-static {v0, v3, v1, v2, p0}, LZ5/F;->y(LZ5/C;Lv4/h;LZ5/E;LF4/n;I)LZ5/B0;
...
# virtual methods
.method public bringChildIntoView(LF4/a;Lv4/c;)Ljava/lang/Object;
    .locals 7
    ...
    invoke-direct {p0, v2, p2}, LZ5/m;-><init>(ILv4/c;)V

    invoke-virtual {p0}, LZ5/m;->u()V

    new-instance p2, Landroidx/compose/foundation/gestures/ContentInViewModifier$Request;

    invoke-direct {p2, p1, p0}, Landroidx/compose/foundation/gestures/ContentInViewModifier$Request;-><init>(LF4/a;LZ5/k;)V

    invoke-static {v1}, Landroidx/compose/foundation/gestures/ContentInViewModifier;->access$getBringIntoViewRequests$p(Landroidx/compose/foundation/gestures/ContentInViewModifier;)Landroidx/compose/foundation/gestures/BringIntoViewRequestPriorityQueue;
    ...
    invoke-static {v1}, Landroidx/compose/foundation/gestures/ContentInViewModifier;->access$isAnimationRunning$p(Landroidx/compose/foundation/gestures/ContentInViewModifier;)Z

    move-result p1

    if-nez p1, :cond_0

    invoke-static {v1}, Landroidx/compose/foundation/gestures/ContentInViewModifier;->access$launchAnimation(Landroidx/compose/foundation/gestures/ContentInViewModifier;)V
