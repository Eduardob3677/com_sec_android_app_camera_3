...
.method public constructor <init>(ILandroidx/compose/ui/Modifier;Landroidx/compose/foundation/pager/PagerState;Landroidx/compose/foundation/layout/PaddingValues;Landroidx/compose/foundation/pager/PageSize;IFLandroidx/compose/ui/Alignment$Horizontal;Landroidx/compose/foundation/gestures/snapping/SnapFlingBehavior;ZZLF4/k;Landroidx/compose/ui/input/nestedscroll/NestedScrollConnection;LF4/o;III)V
    ...
    iput p1, p0, Landroidx/compose/foundation/pager/PagerKt$VerticalPager$1;->$pageCount:I

    iput-object p2, p0, Landroidx/compose/foundation/pager/PagerKt$VerticalPager$1;->$modifier:Landroidx/compose/ui/Modifier;

    iput-object p3, p0, Landroidx/compose/foundation/pager/PagerKt$VerticalPager$1;->$state:Landroidx/compose/foundation/pager/PagerState;

    iput-object p4, p0, Landroidx/compose/foundation/pager/PagerKt$VerticalPager$1;->$contentPadding:Landroidx/compose/foundation/layout/PaddingValues;

    iput-object p5, p0, Landroidx/compose/foundation/pager/PagerKt$VerticalPager$1;->$pageSize:Landroidx/compose/foundation/pager/PageSize;

    iput p6, p0, Landroidx/compose/foundation/pager/PagerKt$VerticalPager$1;->$beyondBoundsPageCount:I

    iput p7, p0, Landroidx/compose/foundation/pager/PagerKt$VerticalPager$1;->$pageSpacing:F

    iput-object p8, p0, Landroidx/compose/foundation/pager/PagerKt$VerticalPager$1;->$horizontalAlignment:Landroidx/compose/ui/Alignment$Horizontal;

    iput-object p9, p0, Landroidx/compose/foundation/pager/PagerKt$VerticalPager$1;->$flingBehavior:Landroidx/compose/foundation/gestures/snapping/SnapFlingBehavior;

    iput-boolean p10, p0, Landroidx/compose/foundation/pager/PagerKt$VerticalPager$1;->$userScrollEnabled:Z

    iput-boolean p11, p0, Landroidx/compose/foundation/pager/PagerKt$VerticalPager$1;->$reverseLayout:Z

    iput-object p12, p0, Landroidx/compose/foundation/pager/PagerKt$VerticalPager$1;->$key:LF4/k;

    iput-object p13, p0, Landroidx/compose/foundation/pager/PagerKt$VerticalPager$1;->$pageNestedScrollConnection:Landroidx/compose/ui/input/nestedscroll/NestedScrollConnection;

    iput-object p14, p0, Landroidx/compose/foundation/pager/PagerKt$VerticalPager$1;->$pageContent:LF4/o;
...
.method public final invoke(Landroidx/compose/runtime/Composer;I)V
    ...
    iget-object v1, v0, Landroidx/compose/foundation/pager/PagerKt$VerticalPager$1;->$modifier:Landroidx/compose/ui/Modifier;

    move v3, v2

    iget-object v2, v0, Landroidx/compose/foundation/pager/PagerKt$VerticalPager$1;->$state:Landroidx/compose/foundation/pager/PagerState;
    ...
    iget-object v11, v0, Landroidx/compose/foundation/pager/PagerKt$VerticalPager$1;->$key:LF4/k;
    ...
    iget-object v13, v0, Landroidx/compose/foundation/pager/PagerKt$VerticalPager$1;->$pageContent:LF4/o;
