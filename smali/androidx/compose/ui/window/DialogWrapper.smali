...
.annotation runtime Lkotlin/Metadata;
    ...
    d2 = {
        ...
        "dialogId",
        "<init>",
        "(LF4/a;Landroidx/compose/ui/window/DialogProperties;Landroid/view/View;Landroidx/compose/ui/unit/LayoutDirection;Landroidx/compose/ui/unit/Density;Ljava/util/UUID;)V",
        "setLayoutDirection",
        ...
        "updateParameters",
        "(LF4/a;Landroidx/compose/ui/window/DialogProperties;Landroidx/compose/ui/unit/LayoutDirection;)V",
        "disposeComposition",
        "()V",
...
# direct methods
.method public constructor <init>(LF4/a;Landroidx/compose/ui/window/DialogProperties;Landroid/view/View;Landroidx/compose/ui/unit/LayoutDirection;Landroidx/compose/ui/unit/Density;Ljava/util/UUID;)V
    .locals 6
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-direct {p0, v0, v1, v2, v3}, Landroidx/activity/ComponentDialog;-><init>(Landroid/content/Context;IILkotlin/jvm/internal/h;)V

    iput-object p1, p0, Landroidx/compose/ui/window/DialogWrapper;->onDismissRequest:LF4/a;
    ...
    iget-object p1, p0, Landroidx/compose/ui/window/DialogWrapper;->onDismissRequest:LF4/a;

    iget-object p2, p0, Landroidx/compose/ui/window/DialogWrapper;->properties:Landroidx/compose/ui/window/DialogProperties;

    invoke-virtual {p0, p1, p2, p4}, Landroidx/compose/ui/window/DialogWrapper;->updateParameters(LF4/a;Landroidx/compose/ui/window/DialogProperties;Landroidx/compose/ui/unit/LayoutDirection;)V
    ...
    invoke-static/range {v0 .. v5}, Landroidx/activity/OnBackPressedDispatcherKt;->addCallback$default(Landroidx/activity/OnBackPressedDispatcher;Landroidx/lifecycle/LifecycleOwner;ZLF4/k;ILjava/lang/Object;)Landroidx/activity/OnBackPressedCallback;
...
.method public static final synthetic access$getOnDismissRequest$p(Landroidx/compose/ui/window/DialogWrapper;)LF4/a;
    .locals 0

    iget-object p0, p0, Landroidx/compose/ui/window/DialogWrapper;->onDismissRequest:LF4/a;
...
.method public final setContent(Landroidx/compose/runtime/CompositionContext;LF4/n;)V
    ...
    invoke-virtual {p0, p1, p2}, Landroidx/compose/ui/window/DialogLayout;->setContent(Landroidx/compose/runtime/CompositionContext;LF4/n;)V

    return-void
.end method

.method public final updateParameters(LF4/a;Landroidx/compose/ui/window/DialogProperties;Landroidx/compose/ui/unit/LayoutDirection;)V
    .locals 0
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
