...
.field private final wordBoundary$delegate:Lr4/d;
...
.method private constructor <init>(Landroidx/compose/ui/text/platform/AndroidParagraphIntrinsics;IZJ)V
    ...
    invoke-direct {v7, v8, v10, v9, v3}, Landroidx/compose/ui/geometry/Rect;-><init>(FFFF)V
    ...
    new-instance v2, Landroidx/compose/ui/text/AndroidParagraph$wordBoundary$2;

    invoke-direct {v2, v0}, Landroidx/compose/ui/text/AndroidParagraph$wordBoundary$2;-><init>(Landroidx/compose/ui/text/AndroidParagraph;)V

    invoke-static {v1, v2}, La/a;->N(Lr4/f;LF4/a;)Lr4/d;

    move-result-object v1

    iput-object v1, v0, Landroidx/compose/ui/text/AndroidParagraph;->wordBoundary$delegate:Lr4/d;
...
.method private final constructTextLayout(IILandroid/text/TextUtils$TruncateAt;IIIII)Landroidx/compose/ui/text/android/TextLayout;
    ...
    invoke-direct/range {v0 .. v21}, Landroidx/compose/ui/text/android/TextLayout;-><init>(Ljava/lang/CharSequence;FLandroid/text/TextPaint;ILandroid/text/TextUtils$TruncateAt;IFFZZIIIIII[I[ILandroidx/compose/ui/text/android/LayoutIntrinsics;ILkotlin/jvm/internal/h;)V
...
.method private final getWordBoundary()Landroidx/compose/ui/text/android/selection/WordBoundary;
    ...
    iget-object p0, p0, Landroidx/compose/ui/text/AndroidParagraph;->wordBoundary$delegate:Lr4/d;
