...
.annotation runtime Lkotlin/Metadata;
    ...
    d2 = {
        ...
        "",
        "transform",
        "(Landroidx/compose/ui/text/AnnotatedString;LF4/o;)Landroidx/compose/ui/text/AnnotatedString;",
        "",
...
.method public static final transform(Landroidx/compose/ui/text/AnnotatedString;LF4/o;)Landroidx/compose/ui/text/AnnotatedString;
    .locals 12
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-static {v2, v3}, Ls4/q;->B0([Ljava/lang/Object;Ljava/util/AbstractSet;)V
    ...
    invoke-direct {v4, v1, v1}, Lr4/h;-><init>(Ljava/lang/Object;Ljava/lang/Object;)V

    filled-new-array {v4}, [Lr4/h;

    move-result-object v1

    invoke-static {v1}, Ls4/I;->D([Lr4/h;)Ljava/util/LinkedHashMap;

    move-result-object v1

    new-instance v4, Landroidx/compose/ui/text/JvmAnnotatedString_jvmKt$transform$1;

    invoke-direct {v4, v2, p1, p0, v1}, Landroidx/compose/ui/text/JvmAnnotatedString_jvmKt$transform$1;-><init>(Lkotlin/jvm/internal/E;LF4/o;Landroidx/compose/ui/text/AnnotatedString;Ljava/util/Map;)V

    const/4 p1, 0x2

    const/4 v5, 0x1

    invoke-static {p1, v5}, Lcom/bumptech/glide/c;->f(II)V
    ...
    invoke-direct {v5, v3}, Ls4/e;-><init>(Ljava/util/List;)V
    ...
    sget-object v10, Ls4/f;->Companion:Ls4/c;

    iget-object v11, v5, Ls4/e;->d:Ljava/util/List;
    ...
    invoke-static {v3, v9, v11}, Ls4/c;->c(III)V

    iput v3, v5, Ls4/e;->b:I

    sub-int/2addr v9, v3

    iput v9, v5, Ls4/e;->c:I
    ...
    :cond_3
    new-instance v5, Ls4/P;

    invoke-direct {v5, v3, v7}, Ls4/P;-><init>(Ljava/util/Iterator;Lv4/c;)V

    invoke-static {v5}, LN2/b;->r(LF4/n;)LW5/l;
    ...
    invoke-direct {v6, v8, v9, v5}, Landroidx/compose/ui/text/AnnotatedString$Range;-><init>(Ljava/lang/Object;II)V
    ...
    invoke-direct {p0, p1, v3, v4, v7}, Landroidx/compose/ui/text/AnnotatedString;-><init>(Ljava/lang/String;Ljava/util/List;Ljava/util/List;Ljava/util/List;)V
