...
.annotation runtime Lkotlin/Metadata;
    ...
    d2 = {
        ...
        "(FFFFLjava/lang/String;JILF4/p;Landroidx/compose/runtime/Composer;II)Landroidx/compose/ui/graphics/vector/VectorPainter;",
        "rememberVectorPainter",
        "",
        "autoMirror",
        "rememberVectorPainter-vIP8VLU",
        "(FFFFLjava/lang/String;JIZLF4/p;Landroidx/compose/runtime/Composer;II)Landroidx/compose/ui/graphics/vector/VectorPainter;",
        ...
        "block",
        "mirror",
        "(Landroidx/compose/ui/graphics/drawscope/DrawScope;LF4/k;)V",
...
.method public static final RenderVectorGroup(Landroidx/compose/ui/graphics/vector/VectorGroup;Ljava/util/Map;Landroidx/compose/runtime/Composer;II)V
    ...
    const-string v7, "androidx.compose.ui.graphics.vector.RenderVectorGroup (VectorPainter.kt:426)"
    ...
    invoke-static/range {v4 .. v16}, Landroidx/compose/ui/graphics/vector/VectorComposeKt;->Group(Ljava/lang/String;FFFFFFFLjava/util/List;LF4/n;Landroidx/compose/runtime/Composer;II)V
...
.method private static final mirror(Landroidx/compose/ui/graphics/drawscope/DrawScope;LF4/k;)V
    .locals 8
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
...
.method public static final rememberVectorPainter-mlNsNFs(FFFFLjava/lang/String;JILF4/p;Landroidx/compose/runtime/Composer;II)Landroidx/compose/ui/graphics/vector/VectorPainter;
    .locals 15
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(FFFF",
    ...
    invoke-static/range {v2 .. v14}, Landroidx/compose/ui/graphics/vector/VectorPainterKt;->rememberVectorPainter-vIP8VLU(FFFFLjava/lang/String;JIZLF4/p;Landroidx/compose/runtime/Composer;II)Landroidx/compose/ui/graphics/vector/VectorPainter;
...
.method public static final rememberVectorPainter-vIP8VLU(FFFFLjava/lang/String;JIZLF4/p;Landroidx/compose/runtime/Composer;II)Landroidx/compose/ui/graphics/vector/VectorPainter;
    .locals 16
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(FFFF",
    ...
    :cond_a
    invoke-virtual {v6}, Landroidx/compose/ui/graphics/vector/VectorPainter;->getComposition$ui_release()Landroidx/compose/runtime/Composition;

    move-result-object v4

    if-eqz v4, :cond_c

    invoke-interface {v4}, Landroidx/compose/runtime/Composition;->isDisposed()Z
    ...
    :cond_c
    :goto_7
    new-instance v4, Landroidx/compose/ui/graphics/vector/VectorApplier;

    invoke-virtual {v6}, Landroidx/compose/ui/graphics/vector/VectorPainter;->getVector$ui_release()Landroidx/compose/ui/graphics/vector/VectorComponent;

    move-result-object v5

    invoke-virtual {v5}, Landroidx/compose/ui/graphics/vector/VectorComponent;->getRoot()Landroidx/compose/ui/graphics/vector/GroupComponent;

    move-result-object v5

    invoke-direct {v4, v5}, Landroidx/compose/ui/graphics/vector/VectorApplier;-><init>(Landroidx/compose/ui/graphics/vector/VNode;)V

    invoke-static {v4, v8}, Landroidx/compose/runtime/CompositionKt;->Composition(Landroidx/compose/runtime/Applier;Landroidx/compose/runtime/CompositionContext;)Landroidx/compose/runtime/Composition;
    ...
    :goto_8
    new-instance v4, Landroidx/compose/ui/graphics/vector/VectorPainterKt$rememberVectorPainter$2$1$1;

    invoke-direct {v4, v0, v2, v3}, Landroidx/compose/ui/graphics/vector/VectorPainterKt$rememberVectorPainter$2$1$1;-><init>(LF4/p;J)V
    ...
    invoke-interface {v5, v0}, Landroidx/compose/runtime/Composition;->setContent(LF4/n;)V
    ...
    invoke-virtual {v6, v5}, Landroidx/compose/ui/graphics/vector/VectorPainter;->setComposition$ui_release(Landroidx/compose/runtime/Composition;)V
