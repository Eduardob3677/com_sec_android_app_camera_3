...
.method private final adjustSelectableEntityDrawInfo()V
    ...
    invoke-static {v1, v0}, Ls4/t;->Z0(Ljava/lang/Iterable;Ljava/lang/Iterable;)Ljava/util/ArrayList;
...
.method private final adjustSelectableRegionOfWordsAndChars()V
    ...
    invoke-virtual {v11, v15, v7}, Lcom/samsung/android/app/sdk/deepsky/textextraction/util/VectorUtil;->calcMinAreaPoly([Landroid/graphics/Point;[Landroid/graphics/Point;)[Landroid/graphics/Point;
    ...
    invoke-static {v5, v11}, Lkotlin/jvm/internal/p;->a(Ljava/lang/Object;Ljava/lang/Object;)Z
    ...
    invoke-virtual {v10, v7}, Lcom/samsung/android/app/sdk/deepsky/textextraction/selectionui/data/SelectableCharacter;->setPoly([Landroid/graphics/Point;)V
...
.method private final createEmptySpaceBetweenWords(Lcom/samsung/android/app/sdk/deepsky/textextraction/result/OcrData$WordInfo;Lcom/samsung/android/app/sdk/deepsky/textextraction/result/OcrData$WordInfo;FLandroid/graphics/Point;Z)Lcom/samsung/android/app/sdk/deepsky/textextraction/selectionui/data/SelectableWord;
    ...
    invoke-virtual {p0, p1, p3, p4}, Lcom/samsung/android/app/sdk/deepsky/textextraction/util/PointUtil;->getTransformedPoly([Landroid/graphics/Point;FLandroid/graphics/Point;)[Landroid/graphics/Point;
    ...
    invoke-virtual {p0, p2, p3, p4}, Lcom/samsung/android/app/sdk/deepsky/textextraction/util/PointUtil;->getTransformedPoly([Landroid/graphics/Point;FLandroid/graphics/Point;)[Landroid/graphics/Point;
...
.method private final createSelectableBlocks(Lcom/samsung/android/app/sdk/deepsky/textextraction/result/OcrData;FLandroid/graphics/Point;)Ljava/util/List;
    ...
    invoke-virtual {v1, v2, v3, v4}, Lcom/samsung/android/app/sdk/deepsky/textextraction/util/PointUtil;->getTransformedPoly([Landroid/graphics/Point;FLandroid/graphics/Point;)[Landroid/graphics/Point;

    move-result-object v1

    new-instance v8, Lcom/samsung/android/app/sdk/deepsky/textextraction/selectionui/data/SelectableBlock;
    ...
    invoke-direct {v8, v2, v1}, Lcom/samsung/android/app/sdk/deepsky/textextraction/selectionui/data/SelectableBlock;-><init>(Ljava/lang/String;[Landroid/graphics/Point;)V
    ...
    check-cast v10, Lcom/samsung/android/app/sdk/deepsky/textextraction/result/OcrData$LineInfo;
    ...
    invoke-virtual {v10}, Lcom/samsung/android/app/sdk/deepsky/textextraction/result/OcrData$LineInfo;->getPoly()[Landroid/graphics/Point;

    move-result-object v1

    invoke-virtual {v0, v1, v3, v4}, Lcom/samsung/android/app/sdk/deepsky/textextraction/util/PointUtil;->getTransformedPoly([Landroid/graphics/Point;FLandroid/graphics/Point;)[Landroid/graphics/Point;

    move-result-object v1

    invoke-virtual {v0, v1}, Lcom/samsung/android/app/sdk/deepsky/textextraction/util/PointUtil;->isVertical([Landroid/graphics/Point;)Z

    move-result v5

    new-instance v11, Lcom/samsung/android/app/sdk/deepsky/textextraction/selectionui/data/SelectableLine;

    invoke-virtual {v10}, Lcom/samsung/android/app/sdk/deepsky/textextraction/result/OcrData$LineInfo;->toString()Ljava/lang/String;

    move-result-object v0

    invoke-direct {v11, v0, v1, v5}, Lcom/samsung/android/app/sdk/deepsky/textextraction/selectionui/data/SelectableLine;-><init>(Ljava/lang/String;[Landroid/graphics/Point;Z)V

    invoke-virtual {v8}, Lcom/samsung/android/app/sdk/deepsky/textextraction/selectionui/data/SelectableBlock;->getSelectableLines()Ljava/util/List;

    move-result-object v0

    invoke-interface {v0, v11}, Ljava/util/List;->add(Ljava/lang/Object;)Z

    invoke-virtual {v10}, Lcom/samsung/android/app/sdk/deepsky/textextraction/result/OcrData$LineInfo;->getWordList()Ljava/util/List;
    ...
    invoke-virtual {v2, v14, v3, v4}, Lcom/samsung/android/app/sdk/deepsky/textextraction/util/PointUtil;->getTransformedPoly([Landroid/graphics/Point;FLandroid/graphics/Point;)[Landroid/graphics/Point;

    move-result-object v2

    new-instance v14, Lcom/samsung/android/app/sdk/deepsky/textextraction/selectionui/data/SelectableWord;

    invoke-virtual {v1}, Lcom/samsung/android/app/sdk/deepsky/textextraction/result/OcrData$WordInfo;->toString()Ljava/lang/String;

    move-result-object v15

    invoke-direct {v14, v15, v2}, Lcom/samsung/android/app/sdk/deepsky/textextraction/selectionui/data/SelectableWord;-><init>(Ljava/lang/String;[Landroid/graphics/Point;)V

    invoke-virtual {v11}, Lcom/samsung/android/app/sdk/deepsky/textextraction/selectionui/data/SelectableLine;->getSelectableWords()Ljava/util/List;
    ...
    check-cast v15, Lcom/samsung/android/app/sdk/deepsky/textextraction/result/OcrData$CharInfo;
    ...
    invoke-virtual {v15}, Lcom/samsung/android/app/sdk/deepsky/textextraction/result/OcrData$CharInfo;->getPoly()[Landroid/graphics/Point;
    ...
    new-instance v2, Lcom/samsung/android/app/sdk/deepsky/textextraction/selectionui/data/SelectableCharacter;

    invoke-virtual {v15}, Lcom/samsung/android/app/sdk/deepsky/textextraction/result/OcrData$CharInfo;->getText()Ljava/lang/String;

    move-result-object v15

    invoke-direct {v2, v15, v1, v5}, Lcom/samsung/android/app/sdk/deepsky/textextraction/selectionui/data/SelectableCharacter;-><init>(Ljava/lang/String;[Landroid/graphics/Point;Z)V

    invoke-virtual {v14}, Lcom/samsung/android/app/sdk/deepsky/textextraction/selectionui/data/SelectableWord;->getSelectableCharacters()Ljava/util/List;
...
.method private final createSelectableEntities(Lcom/samsung/android/app/sdk/deepsky/textextraction/result/EntityData;FLandroid/graphics/Point;Ljava/util/List;)Ljava/util/List;
    ...
    invoke-virtual {v6, v5, v7, v8}, Lcom/samsung/android/app/sdk/deepsky/textextraction/util/PointUtil;->getTransformedPoly([Landroid/graphics/Point;FLandroid/graphics/Point;)[Landroid/graphics/Point;
    ...
    invoke-virtual {v6, v5}, Lcom/samsung/android/app/sdk/deepsky/textextraction/selectionui/data/SelectableOcrResult;->getLineContainingCharacter(Lcom/samsung/android/app/sdk/deepsky/textextraction/selectionui/data/SelectableCharacter;)Lcom/samsung/android/app/sdk/deepsky/textextraction/selectionui/data/SelectableLine;
    ...
    const-string v9, "Selectable characters not detected, entity "
    ...
    const-string v10, ") and overlappingLines("

    const-string v11, ") does not match, entity "

    const-string v12, "size of polyList("

    invoke-static {v3, v9, v12, v10, v11}, LI1/b;->n(IILjava/lang/String;Ljava/lang/String;Ljava/lang/String;)Ljava/lang/StringBuilder;
