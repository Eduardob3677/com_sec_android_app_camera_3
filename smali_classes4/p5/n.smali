...
# static fields
.field public static final e:Lp5/n;
...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lp5/n;->f:Lp5/a;

    new-instance v0, Lp5/n;

    invoke-direct {v0}, Lp5/n;-><init>()V

    sput-object v0, Lp5/n;->e:Lp5/n;

    sget-object v1, Ljava/util/Collections;->EMPTY_LIST:Ljava/util/List;

    iput-object v1, v0, Lp5/n;->b:Ljava/util/List;
...
.method public constructor <init>()V
    ...
    iput-byte v0, p0, Lp5/n;->c:B

    iput v0, p0, Lp5/n;->d:I

    sget-object v0, Lv5/d;->a:Lv5/x;

    iput-object v0, p0, Lp5/n;->a:Lv5/d;
...
.method public constructor <init>(Lp5/m;)V
    ...
    iput-object p1, p0, Lp5/n;->a:Lv5/d;
...
.method public constructor <init>(Lv5/e;Lv5/g;)V
    ...
    iput-object v0, p0, Lp5/n;->b:Ljava/util/List;
    ...
    iput-object v5, p0, Lp5/n;->b:Ljava/util/List;

    move v4, v1

    :cond_3
    iget-object v5, p0, Lp5/n;->b:Ljava/util/List;

    sget-object v6, Lp5/r;->j:Lp5/a;
    ...
    iget-object p2, p0, Lp5/n;->b:Ljava/util/List;

    invoke-static {p2}, Ljava/util/Collections;->unmodifiableList(Ljava/util/List;)Ljava/util/List;

    move-result-object p2

    iput-object p2, p0, Lp5/n;->b:Ljava/util/List;
    ...
    iput-object p2, p0, Lp5/n;->a:Lv5/d;
    ...
    iget-object p1, p0, Lp5/n;->b:Ljava/util/List;

    invoke-static {p1}, Ljava/util/Collections;->unmodifiableList(Ljava/util/List;)Ljava/util/List;

    move-result-object p1

    iput-object p1, p0, Lp5/n;->b:Ljava/util/List;
...
.method public final a()I
    ...
    :goto_0
    iget-object v2, p0, Lp5/n;->b:Ljava/util/List;
    ...
    :cond_1
    iget-object v0, p0, Lp5/n;->a:Lv5/d;
...
.method public final d(Lh1/m;)V
    ...
    invoke-virtual {p0}, Lp5/n;->a()I

    const/4 v0, 0x0

    :goto_0
    iget-object v1, p0, Lp5/n;->b:Ljava/util/List;
    ...
    :cond_0
    iget-object p0, p0, Lp5/n;->a:Lv5/d;
...
.method public final isInitialized()Z
    ...
    :goto_0
    iget-object v3, p0, Lp5/n;->b:Ljava/util/List;
    ...
    invoke-virtual {v3}, Lp5/r;->isInitialized()Z

    move-result v3

    if-nez v3, :cond_2

    iput-byte v2, p0, Lp5/n;->c:B
