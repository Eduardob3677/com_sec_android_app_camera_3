.class public Lcom/sec/android/app/camera/setting/CustomFilterActivity;
.super Lcom/sec/android/app/camera/setting/BaseSystemUiActivity;
.source "r8-map-id-5474ffd14539c415065aa2a9f295d092949679b6f307d2b053e45bec25b95b73"


# static fields
.field private static final TAG:Ljava/lang/String; = "CustomFilterActivity"
...
.method public constructor <init>()V
    ...
    new-instance v0, Lcom/sec/android/app/camera/setting/CustomFilterActivity$1;

    invoke-direct {v0, p0}, Lcom/sec/android/app/camera/setting/CustomFilterActivity$1;-><init>(Lcom/sec/android/app/camera/setting/CustomFilterActivity;)V

    iput-object v0, p0, Lcom/sec/android/app/camera/setting/CustomFilterActivity;->mGlobalBroadcastReceiver:Landroid/content/BroadcastReceiver;

    new-instance v0, Lcom/sec/android/app/camera/setting/CustomFilterActivity$2;

    invoke-direct {v0, p0}, Lcom/sec/android/app/camera/setting/CustomFilterActivity$2;-><init>(Lcom/sec/android/app/camera/setting/CustomFilterActivity;)V

    iput-object v0, p0, Lcom/sec/android/app/camera/setting/CustomFilterActivity;->mLocalBroadcastReceiver:Landroid/content/BroadcastReceiver;
    ...
    iput-object v0, p0, Lcom/sec/android/app/camera/setting/CustomFilterActivity;->mOnBackInvokedCallback:Landroid/window/OnBackInvokedCallback;
...
.method private initScreen()V
    ...
    const-string v0, "CustomFilterActivity"
    ...
    :cond_0
    sget v0, Lcom/sec/android/app/camera/R$string;->Title_Custom_Filter:I
    ...
    sget v0, Lcom/sec/android/app/camera/R$layout;->custom_filter_layout:I
    ...
    sget v2, Lcom/sec/android/app/camera/R$string;->Title_Custom_Filter:I
    ...
    iput-object v0, p0, Lcom/sec/android/app/camera/setting/CustomFilterActivity;->mCollapsingToolbarLayout:Lcom/google/android/material/appbar/CollapsingToolbarLayout;
    ...
    iput-object v0, p0, Lcom/sec/android/app/camera/setting/CustomFilterActivity;->mToolbar:Landroidx/appcompat/widget/Toolbar;

    invoke-direct {p0}, Lcom/sec/android/app/camera/setting/CustomFilterActivity;->setupFloatingToolbar()V

    invoke-direct {p0}, Lcom/sec/android/app/camera/setting/CustomFilterActivity;->initRoundedCorners()V

    sget-object p0, Lcom/sec/android/app/camera/interfaces/SaLogScreenId;->SETTING_CUSTOM_FILTER:Lcom/sec/android/app/camera/interfaces/SaLogScreenId;
...
.method public static synthetic k(Lcom/sec/android/app/camera/setting/CustomFilterActivity;Landroid/view/View;Landroidx/core/view/WindowInsetsCompat;)Landroidx/core/view/WindowInsetsCompat;
    .locals 0

    invoke-direct {p0, p1, p2}, Lcom/sec/android/app/camera/setting/CustomFilterActivity;->lambda$updateLayout$0(Landroid/view/View;Landroidx/core/view/WindowInsetsCompat;)Landroidx/core/view/WindowInsetsCompat;
...
.method public getCameraSettings()Lcom/sec/android/app/camera/interfaces/CameraSettings;
    ...
    invoke-direct {p0}, Lcom/sec/android/app/camera/setting/CustomFilterActivity;->getCameraParcelBundle()Landroid/os/Bundle;
...
.method public onConfigurationChanged(Landroid/content/res/Configuration;)V
    ...
    invoke-direct {p0}, Lcom/sec/android/app/camera/setting/CustomFilterActivity;->initScreen()V

    invoke-direct {p0}, Lcom/sec/android/app/camera/setting/CustomFilterActivity;->updateLayout()V
...
.method public onCreate(Landroid/os/Bundle;)V
    ...
    iput-object p1, p0, Lcom/sec/android/app/camera/setting/CustomFilterActivity;->mCameraSettings:Lcom/sec/android/app/camera/interfaces/CameraSettings;
    ...
    iget-object v1, p0, Lcom/sec/android/app/camera/setting/CustomFilterActivity;->mOnBackInvokedCallback:Landroid/window/OnBackInvokedCallback;
    ...
    iget-object p1, p0, Lcom/sec/android/app/camera/setting/CustomFilterActivity;->mCameraSettings:Lcom/sec/android/app/camera/interfaces/CameraSettings;
    ...
    iget-object v0, p0, Lcom/sec/android/app/camera/setting/CustomFilterActivity;->mGlobalBroadcastReceiver:Landroid/content/BroadcastReceiver;
    ...
    iget-object v1, p0, Lcom/sec/android/app/camera/setting/CustomFilterActivity;->mLocalBroadcastReceiver:Landroid/content/BroadcastReceiver;
...
.method public onDestroy()V
    ...
    const-string v1, "CustomFilterActivity"
    ...
    iget-object v2, p0, Lcom/sec/android/app/camera/setting/CustomFilterActivity;->mOnBackInvokedCallback:Landroid/window/OnBackInvokedCallback;
    ...
    iget-object v2, p0, Lcom/sec/android/app/camera/setting/CustomFilterActivity;->mLocalBroadcastReceiver:Landroid/content/BroadcastReceiver;
...
.method public setSubCameraSettingTitle(Ljava/lang/String;)V
    ...
    iget-object v0, p0, Lcom/sec/android/app/camera/setting/CustomFilterActivity;->mCollapsingToolbarLayout:Lcom/google/android/material/appbar/CollapsingToolbarLayout;

    invoke-virtual {v0, p1}, Lcom/google/android/material/appbar/CollapsingToolbarLayout;->setTitle(Ljava/lang/CharSequence;)V

    iget-object v0, p0, Lcom/sec/android/app/camera/setting/CustomFilterActivity;->mToolbar:Landroidx/appcompat/widget/Toolbar;

    invoke-virtual {v0, p1}, Landroidx/appcompat/widget/Toolbar;->setTitle(Ljava/lang/CharSequence;)V

    iget-object p1, p0, Lcom/sec/android/app/camera/setting/CustomFilterActivity;->mToolbar:Landroidx/appcompat/widget/Toolbar;
