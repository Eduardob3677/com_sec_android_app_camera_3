...
.method public static getString(Landroid/content/Context;Ljava/util/List;)Ljava/lang/CharSequence;
    ...
    sget v5, Lcom/sec/android/app/camera/R$string;->null_string:I
    ...
    invoke-direct {v3, v1, v4}, Lcom/sec/android/app/camera/setting/G;-><init>(Ljava/lang/Object;I)V
    ...
    sget p1, Lcom/sec/android/app/camera/R$string;->setting_dimmed_reason_menu_not_available:I
...
.method private static initExclusiveFormatStringMap()V
    ...
    sget v3, Lcom/sec/android/app/camera/R$string;->quick_setting_dimmed_reason_format_arg:I

    invoke-static {v3}, Ljava/lang/Integer;->valueOf(I)Ljava/lang/Integer;

    move-result-object v3

    sget v4, Lcom/sec/android/app/camera/R$string;->Title_camcorder_hlg:I
    ...
    sget v4, Lcom/sec/android/app/camera/R$string;->Title_video_format_h264:I
    ...
    sget v4, Lcom/sec/android/app/camera/R$string;->Title_Apv:I
...
.method private static initExclusiveStringMap()V
    ...
    sget v2, Lcom/sec/android/app/camera/R$string;->setting_dimmed_reason_mode_or_camera:I
    ...
    sget v2, Lcom/sec/android/app/camera/R$string;->setting_dimmed_reason_picture_size:I
    ...
    sget v2, Lcom/sec/android/app/camera/R$string;->setting_dimmed_reason_video_size:I
    ...
    sget v2, Lcom/sec/android/app/camera/R$string;->setting_dimmed_reason_super_steady:I
    ...
    sget v2, Lcom/sec/android/app/camera/R$string;->setting_dimmed_reason_hdr_10plus_video:I
    ...
    sget v2, Lcom/sec/android/app/camera/R$string;->setting_dimmed_reason_directors_view_type:I
    ...
    sget v2, Lcom/sec/android/app/camera/R$string;->setting_dimmed_reason_body_beauty_type:I
    ...
    sget v2, Lcom/sec/android/app/camera/R$string;->setting_dimmed_reason_filter_type:I
    ...
    sget v2, Lcom/sec/android/app/camera/R$string;->setting_dimmed_reason_ultra_wide_lens:I
    ...
    sget v2, Lcom/sec/android/app/camera/R$string;->setting_dimmed_reason_focus_length:I
    ...
    sget v2, Lcom/sec/android/app/camera/R$string;->setting_dimmed_reason_attach_camera:I
    ...
    sget v2, Lcom/sec/android/app/camera/R$string;->setting_dimmed_reason_secure_camera:I
    ...
    sget v2, Lcom/sec/android/app/camera/R$string;->setting_dimmed_reason_knox_mode:I
    ...
    sget v2, Lcom/sec/android/app/camera/R$string;->setting_dimmed_reason_during_calls:I
    ...
    sget v2, Lcom/sec/android/app/camera/R$string;->setting_dimmed_reason_while_tracking_auto_focus:I
    ...
    sget v2, Lcom/sec/android/app/camera/R$string;->setting_dimmed_reason_auto_framing:I
    ...
    sget-object v2, LO1/d;->SUPPORT_DETAIL_ENHANCER_BUTTON:LO1/d;
    ...
    sget v2, Lcom/sec/android/app/camera/R$string;->setting_dimmed_reason_detail_enhancer:I
    ...
    sget v2, Lcom/sec/android/app/camera/R$string;->setting_dimmed_reason_high_bitrate_video:I
    ...
    sget v2, Lcom/sec/android/app/camera/R$string;->setting_dimmed_reason_360_bt_mic:I
    ...
    sget v2, Lcom/sec/android/app/camera/R$string;->setting_dimmed_reason_quality_optimization:I
    ...
    sget v2, Lcom/sec/android/app/camera/R$string;->setting_dimmed_reason_high_efficiency_video_priority:I
    ...
    sget v2, Lcom/sec/android/app/camera/R$string;->widget_watermark_dim_description:I
