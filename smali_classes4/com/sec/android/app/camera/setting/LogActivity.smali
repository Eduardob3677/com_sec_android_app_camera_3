.class public Lcom/sec/android/app/camera/setting/LogActivity;
.super Lcom/sec/android/app/camera/setting/BaseSystemUiActivity;
.source "r8-map-id-5474ffd14539c415065aa2a9f295d092949679b6f307d2b053e45bec25b95b73"


# static fields
.field private static final TAG:Ljava/lang/String; = "LogActivity"
...
.field private mLogSwitch:Landroidx/appcompat/widget/SeslSwitchBar;
...
.method public constructor <init>()V
    ...
    new-instance v0, Lcom/sec/android/app/camera/setting/LogActivity$1;

    invoke-direct {v0, p0}, Lcom/sec/android/app/camera/setting/LogActivity$1;-><init>(Lcom/sec/android/app/camera/setting/LogActivity;)V

    iput-object v0, p0, Lcom/sec/android/app/camera/setting/LogActivity;->mGlobalBroadcastReceiver:Landroid/content/BroadcastReceiver;

    new-instance v0, Lcom/sec/android/app/camera/setting/LogActivity$2;

    invoke-direct {v0, p0}, Lcom/sec/android/app/camera/setting/LogActivity$2;-><init>(Lcom/sec/android/app/camera/setting/LogActivity;)V

    iput-object v0, p0, Lcom/sec/android/app/camera/setting/LogActivity;->mLocalBroadcastReceiver:Landroid/content/BroadcastReceiver;
    ...
    iput-object v0, p0, Lcom/sec/android/app/camera/setting/LogActivity;->mOnBackInvokedCallback:Landroid/window/OnBackInvokedCallback;
...
.method private getSummaryString()Ljava/lang/String;
    ...
    sget v1, Lcom/sec/android/app/camera/R$string;->log_video_activity_summary:I
    ...
    sget v2, Lcom/sec/android/app/camera/R$string;->log_video_activity_summary_gallery:I
    ...
    sget v1, Lcom/sec/android/app/camera/R$string;->log_video_activity_summary_mode:I
...
.method private initDescription()V
    ...
    invoke-direct {p0}, Lcom/sec/android/app/camera/setting/LogActivity;->getSummaryString()Ljava/lang/String;
...
.method private initMainSwitchLayout()V
    ...
    iput-object v0, p0, Lcom/sec/android/app/camera/setting/LogActivity;->mLogSwitch:Landroidx/appcompat/widget/SeslSwitchBar;

    iget-object v1, p0, Lcom/sec/android/app/camera/setting/LogActivity;->mCameraSettings:Lcom/sec/android/app/camera/interfaces/CameraSettings;
    ...
    iget-object v0, p0, Lcom/sec/android/app/camera/setting/LogActivity;->mLogSwitch:Landroidx/appcompat/widget/SeslSwitchBar;
...
.method private initScreen()V
    ...
    sget v1, Lcom/sec/android/app/camera/R$layout;->log_layout:I
    ...
    sget v3, Lcom/sec/android/app/camera/R$string;->Title_log_video:I
    ...
    iput-object v1, p0, Lcom/sec/android/app/camera/setting/LogActivity;->mCollapsingToolbarLayout:Lcom/google/android/material/appbar/CollapsingToolbarLayout;
    ...
    iput-object v1, p0, Lcom/sec/android/app/camera/setting/LogActivity;->mToolbar:Landroidx/appcompat/widget/Toolbar;

    invoke-direct {p0}, Lcom/sec/android/app/camera/setting/LogActivity;->setupFloatingToolbar()V

    invoke-direct {p0}, Lcom/sec/android/app/camera/setting/LogActivity;->initMainSwitchLayout()V

    invoke-direct {p0}, Lcom/sec/android/app/camera/setting/LogActivity;->initRoundedCorners()V

    invoke-direct {p0}, Lcom/sec/android/app/camera/setting/LogActivity;->initDescription()V

    iget-object v1, p0, Lcom/sec/android/app/camera/setting/LogActivity;->mFragment:Landroidx/preference/PreferenceFragmentCompat;

    if-nez v1, :cond_1

    invoke-static {v0}, Lcom/sec/android/app/camera/setting/LogFragment;->newInstance(Landroid/os/Bundle;)Lcom/sec/android/app/camera/setting/LogFragment;

    move-result-object v1

    iput-object v1, p0, Lcom/sec/android/app/camera/setting/LogActivity;->mFragment:Landroidx/preference/PreferenceFragmentCompat;
    ...
    invoke-direct {p0, v1, v0}, Lcom/sec/android/app/camera/setting/LogActivity;->showFragment(Landroidx/preference/PreferenceFragmentCompat;Ljava/lang/String;)V

    :cond_2
    sget-object p0, Lcom/sec/android/app/camera/interfaces/SaLogScreenId;->SETTING_LOG_VIDEO:Lcom/sec/android/app/camera/interfaces/SaLogScreenId;
...
.method public static synthetic k(Lcom/sec/android/app/camera/setting/LogActivity;Landroid/view/View;)V
    .locals 0

    invoke-direct {p0, p1}, Lcom/sec/android/app/camera/setting/LogActivity;->lambda$initMainSwitchLayout$0(Landroid/view/View;)V

    return-void
.end method

.method public static synthetic l(Lcom/sec/android/app/camera/setting/LogActivity;Landroid/view/View;Landroidx/core/view/WindowInsetsCompat;)Landroidx/core/view/WindowInsetsCompat;
    .locals 0

    invoke-direct {p0, p1, p2}, Lcom/sec/android/app/camera/setting/LogActivity;->lambda$updateLayout$2(Landroid/view/View;Landroidx/core/view/WindowInsetsCompat;)Landroidx/core/view/WindowInsetsCompat;
...
.method private synthetic lambda$initMainSwitchLayout$0(Landroid/view/View;)V
    ...
    iget-object p1, p0, Lcom/sec/android/app/camera/setting/LogActivity;->mLogSwitch:Landroidx/appcompat/widget/SeslSwitchBar;
    ...
    invoke-direct {p0, p1}, Lcom/sec/android/app/camera/setting/LogActivity;->setMainSwitchButtonChecked(Z)V
...
.method private synthetic lambda$initMainSwitchLayout$1(Landroidx/appcompat/widget/SwitchCompat;Z)V
    ...
    invoke-direct {p0, p2}, Lcom/sec/android/app/camera/setting/LogActivity;->setMainSwitchButtonChecked(Z)V
...
.method public static synthetic m(Lcom/sec/android/app/camera/setting/LogActivity;Landroidx/appcompat/widget/SwitchCompat;Z)V
    .locals 0

    invoke-direct {p0, p1, p2}, Lcom/sec/android/app/camera/setting/LogActivity;->lambda$initMainSwitchLayout$1(Landroidx/appcompat/widget/SwitchCompat;Z)V
...
.method private setMainSwitchButtonChecked(Z)V
    ...
    iget-object v0, p0, Lcom/sec/android/app/camera/setting/LogActivity;->mCameraSettings:Lcom/sec/android/app/camera/interfaces/CameraSettings;
    ...
    iget-object p0, p0, Lcom/sec/android/app/camera/setting/LogActivity;->mFragment:Landroidx/preference/PreferenceFragmentCompat;

    check-cast p0, Lcom/sec/android/app/camera/setting/LogFragment;

    invoke-virtual {p0, p1}, Lcom/sec/android/app/camera/setting/LogFragment;->setEnablePreferences(Z)V
...
.method public getCameraSettings()Lcom/sec/android/app/camera/interfaces/CameraSettings;
    ...
    iget-object p0, p0, Lcom/sec/android/app/camera/setting/LogActivity;->mCameraSettings:Lcom/sec/android/app/camera/interfaces/CameraSettings;
...
.method public onConfigurationChanged(Landroid/content/res/Configuration;)V
    ...
    invoke-direct {p0}, Lcom/sec/android/app/camera/setting/LogActivity;->initScreen()V

    invoke-direct {p0}, Lcom/sec/android/app/camera/setting/LogActivity;->updateLayout()V

    iget-object p1, p0, Lcom/sec/android/app/camera/setting/LogActivity;->mFragment:Landroidx/preference/PreferenceFragmentCompat;
    ...
    iget-object v0, p0, Lcom/sec/android/app/camera/setting/LogActivity;->mFragment:Landroidx/preference/PreferenceFragmentCompat;
...
.method public onCreate(Landroid/os/Bundle;)V
    ...
    iput-object p1, p0, Lcom/sec/android/app/camera/setting/LogActivity;->mCameraSettings:Lcom/sec/android/app/camera/interfaces/CameraSettings;
    ...
    iget-object v1, p0, Lcom/sec/android/app/camera/setting/LogActivity;->mOnBackInvokedCallback:Landroid/window/OnBackInvokedCallback;
    ...
    iget-object p1, p0, Lcom/sec/android/app/camera/setting/LogActivity;->mCameraSettings:Lcom/sec/android/app/camera/interfaces/CameraSettings;
    ...
    iget-object v0, p0, Lcom/sec/android/app/camera/setting/LogActivity;->mGlobalBroadcastReceiver:Landroid/content/BroadcastReceiver;
    ...
    iget-object v1, p0, Lcom/sec/android/app/camera/setting/LogActivity;->mLocalBroadcastReceiver:Landroid/content/BroadcastReceiver;
...
.method public onDestroy()V
    ...
    iget-object v2, p0, Lcom/sec/android/app/camera/setting/LogActivity;->mOnBackInvokedCallback:Landroid/window/OnBackInvokedCallback;
    ...
    iget-object v2, p0, Lcom/sec/android/app/camera/setting/LogActivity;->mLocalBroadcastReceiver:Landroid/content/BroadcastReceiver;
...
.method public setSubCameraSettingTitle(Ljava/lang/String;)V
    ...
    iget-object v0, p0, Lcom/sec/android/app/camera/setting/LogActivity;->mCollapsingToolbarLayout:Lcom/google/android/material/appbar/CollapsingToolbarLayout;

    invoke-virtual {v0, p1}, Lcom/google/android/material/appbar/CollapsingToolbarLayout;->setTitle(Ljava/lang/CharSequence;)V

    iget-object v0, p0, Lcom/sec/android/app/camera/setting/LogActivity;->mToolbar:Landroidx/appcompat/widget/Toolbar;

    invoke-virtual {v0, p1}, Landroidx/appcompat/widget/Toolbar;->setTitle(Ljava/lang/CharSequence;)V

    iget-object p1, p0, Lcom/sec/android/app/camera/setting/LogActivity;->mToolbar:Landroidx/appcompat/widget/Toolbar;
