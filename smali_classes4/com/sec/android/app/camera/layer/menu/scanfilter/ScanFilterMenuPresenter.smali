.class public Lcom/sec/android/app/camera/layer/menu/scanfilter/ScanFilterMenuPresenter;
.super Lcom/sec/android/app/camera/layer/menu/abstraction/AbstractMenuPresenter;
.source "r8-map-id-5474ffd14539c415065aa2a9f295d092949679b6f307d2b053e45bec25b95b73"

# interfaces
.implements Lcom/sec/android/app/camera/engine/interfaces/Engine$PreviewEventListener;
.implements Lcom/sec/android/app/camera/layer/menu/scanfilter/ScanFilterMenuContract$Presenter;
...
# static fields
.field private static final SCAN_FILTER_MENU_ITEMS:Ljava/util/List;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "Ljava/util/List<",
            "Ljava/lang/Integer;",
...
.field private static final TAG:Ljava/lang/String; = "ScanFilterMenuPresenter"
...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lcom/sec/android/app/camera/layer/menu/scanfilter/ScanFilterMenuPresenter;->SCAN_FILTER_MENU_ITEMS:Ljava/util/List;

    return-void
.end method

.method public constructor <init>(Lcom/sec/android/app/camera/interfaces/CameraContext;Lcom/sec/android/app/camera/engine/interfaces/Engine;Lcom/sec/android/app/camera/layer/menu/scanfilter/ScanFilterMenuContract$View;Lcom/sec/android/app/camera/interfaces/MenuLayerManager$MenuId;)V
    .locals 1
    ...
    iput-object p1, p0, Lcom/sec/android/app/camera/layer/menu/scanfilter/ScanFilterMenuPresenter;->mViewVisibilitySet:Ljava/util/EnumSet;

    iput-object p2, p0, Lcom/sec/android/app/camera/layer/menu/scanfilter/ScanFilterMenuPresenter;->mEngine:Lcom/sec/android/app/camera/engine/interfaces/Engine;
...
.method private getItemList()Ljava/util/ArrayList;
    ...
    sget-object v1, Lcom/sec/android/app/camera/layer/menu/scanfilter/ScanFilterMenuPresenter;->SCAN_FILTER_MENU_ITEMS:Ljava/util/List;
    ...
    sget-object v4, Lcom/sec/android/app/camera/interfaces/CameraSettings$Key;->BACK_MULTI_SCAN_FILTER:Lcom/sec/android/app/camera/interfaces/CameraSettings$Key;
    ...
    invoke-direct {p0, v2}, Lcom/sec/android/app/camera/layer/menu/scanfilter/ScanFilterMenuPresenter;->getItemText(I)Ljava/lang/String;

    move-result-object v2

    invoke-direct {v4, v3, v2}, Li3/q;-><init>(ZLjava/lang/String;)V
...
.method private getItemText(I)Ljava/lang/String;
    ...
    sget p1, Lcom/sec/android/app/camera/R$string;->filter_bw:I
    ...
    sget p1, Lcom/sec/android/app/camera/R$string;->filter_grayscale:I
    ...
    sget p1, Lcom/sec/android/app/camera/R$string;->filter_natural:I
    ...
    sget p1, Lcom/sec/android/app/camera/R$string;->filter_clean:I
    ...
    sget p1, Lcom/sec/android/app/camera/R$string;->filter_none:I
...
.method private sendSaLog(Lcom/sec/android/app/camera/interfaces/CommandId;)V
    ...
    const-string p0, "ScanFilterMenuPresenter"
...
.method public onEmptyAreaTouch(ZII)Z
    ...
    check-cast p1, Lcom/sec/android/app/camera/layer/menu/scanfilter/ScanFilterMenuContract$View;

    invoke-interface {p1}, Lcom/sec/android/app/camera/layer/menu/scanfilter/ScanFilterMenuContract$View;->hideMenuWithAnimation()V
...
.method public onInitialized()V
    ...
    new-instance v0, Lcom/sec/android/app/camera/layer/menu/scanfilter/ScanFilterAdapter;

    invoke-direct {p0}, Lcom/sec/android/app/camera/layer/menu/scanfilter/ScanFilterMenuPresenter;->getItemList()Ljava/util/ArrayList;

    move-result-object v1

    invoke-direct {v0, v1}, Lcom/sec/android/app/camera/layer/menu/scanfilter/ScanFilterAdapter;-><init>(Ljava/util/ArrayList;)V
    ...
    check-cast p0, Lcom/sec/android/app/camera/layer/menu/scanfilter/ScanFilterMenuContract$View;

    invoke-interface {p0, v0}, Lcom/sec/android/app/camera/layer/menu/scanfilter/ScanFilterMenuContract$View;->setAdapter(Lcom/sec/android/app/camera/layer/menu/scanfilter/ScanFilterAdapter;)V

    return-void
.end method

.method public onScanFilterItemClicked(IZ)V
    .locals 3
    ...
    invoke-interface {p0, v0, p2}, Lcom/sec/android/app/camera/interfaces/ScanManager;->setDefaultFilterProcessor(Lcom/sec/android/app/camera/scanner/multi/interfaces/e;Z)V
...
.method public onVisibilityChanged(Lcom/sec/android/app/camera/interfaces/ViewVisibilityEventManager$ViewId;Z)V
    ...
    sget-object p2, Lcom/sec/android/app/camera/layer/menu/scanfilter/ScanFilterMenuPresenter$1;->$SwitchMap$com$sec$android$app$camera$interfaces$ViewVisibilityEventManager$ViewId:[I
...
.method public start()V
    ...
    const-string v0, "ScanFilterMenuPresenter"
    ...
    check-cast v0, Lcom/sec/android/app/camera/layer/menu/scanfilter/ScanFilterMenuContract$View;

    const/4 v1, 0x1

    invoke-interface {v0, v1}, Lcom/sec/android/app/camera/layer/menu/scanfilter/ScanFilterMenuContract$View;->showMenu(Z)V
    ...
    iget-object v2, p0, Lcom/sec/android/app/camera/layer/menu/scanfilter/ScanFilterMenuPresenter;->mViewVisibilitySet:Ljava/util/EnumSet;
    ...
    sget-object v2, Lcom/sec/android/app/camera/interfaces/ViewVisibilityEventManager$ViewId;->MENU_SCAN_FILTER:Lcom/sec/android/app/camera/interfaces/ViewVisibilityEventManager$ViewId;
    ...
    iget-object v0, p0, Lcom/sec/android/app/camera/layer/menu/scanfilter/ScanFilterMenuPresenter;->mEngine:Lcom/sec/android/app/camera/engine/interfaces/Engine;
...
.method public stop()V
    ...
    iget-object v1, p0, Lcom/sec/android/app/camera/layer/menu/scanfilter/ScanFilterMenuPresenter;->mViewVisibilitySet:Ljava/util/EnumSet;
